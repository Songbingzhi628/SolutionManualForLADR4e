...
\Or Note that\; $\displaystyle\frac{1}{1}>\frac{1}{2}>\dots>\frac{1}{m},\,\,\,\forall m\in\Nbp.$ Suppose\; $f_m=\left\{\begin{array}{l}
	\hspace{-4pt}x-{\displaystyle\frac{1}{m}},\;\;x\in\XInterval{(}{]}{\;\displaystyle\frac{1}{m},\;1\;}\\
	\hspace{-4pt}0,\hfill x\in\XSbra{\;0,\;\displaystyle\frac{1}{m}\;}\end{array}\right.$\vspace{4pt}\par\quad
Then\; $f_1\XPar{\displaystyle\frac{1}{m}}=\dots=f_m\XPar{\displaystyle\frac{1}{m}}=0\neq f_{m+1}\XPar{\displaystyle\frac{1}{m}}.$ 
...
Note that \vspace{-8pt} \AlignEq{\hspace{-20pt}}{p_k\Par{x}&=x^k\XPar{\textstyle\sum_{i=1}^{m-k}\mathC_{m-k}^i \Par{-1}{^{i}}x^{i}}\\&=\textstyle\sum_{i=1}^{m-k}\mathC_{m-k}^i \Par{-1}{^{i}}x^{i+k}=\Par{-1}{^0}x^{k} +\textstyle\sum_{i=1}^{m-k-1}\mathC_{m-k}^i \Par{-1}{^{i}}x^{i+k}.}\par\quad
