...
\ProblemB[]{
	\TextB{Supp $T\in\Lm{V},\lambda_1,\dots,\lambda_m$ are the disti eigvals corres $v_1,\dots,v_m,$ and $U$ invard $T.$}
}
...
\Anchor{5C4e16}\ProblemN{16}{
	\TextA{Supp $T\in\Lm{V}$ diag. Let $\lambda_1,\dots,\lambda_m$ be the disti eigvals of $T.$}
	\TextA{Prove $U$ invarspd $T\Rightarrow\exists$ subsp $U_k$ of $E\Par{\lambda_k,T}$ suth $U=U_1\oplus\cdots\oplus U_m.$}
...
\Anchor{8BT1}\ProblemN{\BulletPointX B.\TipsN{1}}{
	\TextA{Supp $v_1+\dots+v_m\in U.$ Prove each $v_k\in U.$}
...
\Anchor{8BT2}\ProblemN{\BulletPointX B.\TipsN{2}}{
	\TextA{Supp $\Fbb=\Cbb.$ Prove $\exists$ subsp $U_k$ of $G\Par{\lambda_k,T}$ suth $U=U_1\oplus\cdots\oplus U_m.$}
}Let each $U_k=U\cap G\Par{\lambda_k,T}.$ Becs $\forall u\in U,\exists\,!\,v_k\in G\Par{\lambda_k,T},u=v_1+\dots+v_m.$\parSol{}
Now by \Sbra{B \TIPSN{1}}, each $v_k\in U_k\Rightarrow u\in U_1\oplus\cdots\oplus U_m.$\PfEnd
\SepLine
\pagebreak

\Anchor{Ch8C}
\Anchor{8B4e20}\Anchor{8C20}\ProblemNnoor{C.20}{4E B.20}{
	\TextA{Supp $\Fbb=\Cbb,$ and each $V_k$ non0 invarspd $T\in\Lm{V}$ of $V=V_1\oplus\cdots\oplus V_m.$}
