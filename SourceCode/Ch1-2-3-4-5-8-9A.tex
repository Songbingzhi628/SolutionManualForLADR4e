...
}Becs $p\neq 0.$ By the div algo, immed. \Sbra{$r=0$ if $q=p.$} \;\;\Or By Exe (4E 19).\PfEnd\vspace{2pt}\parSol{}
...
}Becs $\mE=\Span[\BigPar]{I,T,\dots,T^{\dim\Lm[\SmallPar]{V}\,-\,1}}=\Span[\BigPar]{I,T,\dots,T^{\deg p\,-\,1}},$ by Exe (4E 13). Immed.\PfEnd\vspace{2pt}\parSol{}
...
}See [9.8] for a graceful proof.\par\quad
\Or Let each $V_{\!k}$ be an arb vecsp of dim $k$ with an arb $T_{\!k}\in\Lm{V_{\!k}}.$\par\quad
