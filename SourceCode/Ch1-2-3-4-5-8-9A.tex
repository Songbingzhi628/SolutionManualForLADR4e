...
\Blind{${}{^\neg}P\Rightarrow{}{^\neg}Q:$ \;}Now supp $\exists$ only one eigval $\lambda$ for $T\mmid_U$ or $T\mmid_W,$ so for both and for $T,$ by \Sbra{B \TIPSN{3}}.\parSol{}
\Blind{${}{^\neg}P\Rightarrow{}{^\neg}Q:$ \;}Let $p\Par{z}=\Par{z-\lambda}{^m}.$ Let $M=\max\!\Bra{\dim U,\dim W}<\dim V.$ Let $S=\Par{T-\lambda I}{^M}.$\parSol{}
\Blind{${}{^\neg}P\Rightarrow{}{^\neg}Q:$ \;}Then by (L1), $\null S\mmid_U\oplus\null S\mmid_W=\null S,$ 又 $\null S\mmid_U=U,\null S\mmid_W=W\Rightarrow m\leqslant M.$\vspace{2pt}\parSol{}
