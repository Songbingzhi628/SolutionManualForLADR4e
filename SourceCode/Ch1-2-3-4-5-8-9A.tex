...
\ChDecl{Ch3C}{3$\cdot$C}{\quad{\small\textbf{注意\,:}\;这里我将3.D后半节前置。}}
...
\BulletPointX\ANote Let $C=\Mt{T}\in\Fbb^{n,\,p},A=\Mt{S}\in\Fbb^{m,n}$ wrto std bses, where $U=\Fbb^p,V=\Fbb^n,W=\Fbb^m.$\vspace{3pt}\parNot{}\IndentB{}
...
%Hence $\Par{v,Tv}$ is linely dep $\Rightarrow \forall v\in V,\exists\,\lambda_v\in\Fbb,Tv=\lambda_v v.$ \;Simlr to (4E 3.A.11).\PfEnd\vspace{4pt}\quad
...
}By \Sbra{3.A {\NOTEFOR} $\Fbb^S$}, immed. \,\Or Fix one $m\in\Nbp$ and $p\in\PoFx{\,}{[0,1]}.$\parSol{}
