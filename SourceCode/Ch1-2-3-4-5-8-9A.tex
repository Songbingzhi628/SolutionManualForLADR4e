...
我编撰这篇笔记，主要面向3e纸质书的读者。不知为何，也许是字号的原因，我即便拿到4e纸质书也无法像先前用3e纸质书那样投入，于是我只好调换3e的学习顺序来兼顾4e的习题。所以我决定将3e第8章和9.A节提前到第5章后（事实上前章我已经将部分9.A的习题前置了，这是因为4e也将9.A拆分散落到前章中），对应到4e只有第8章前三节。3e第8章和9.A节个别涉及第6、7章的习题，会塞入到第6、7章的笔记中。\par\vspace{8pt}
}
\pagebreak
...
}By \Sbra{5.A \TIPSN{3}}, $\exists\,B_U=\Par{v_1,\dots,v_m}$ consists of eigvecs of $T.$\parSol{}
Extend to eigvecs $B_V=\Par{v_1,\dots,v_m,w_1,\dots,w_p}\Rightarrow B_{V\XSlash U}=\Par{w_1+U,\dots,w_p+U}.$\parSol{}
Becs for each $w_k,\:\exists$ eigval $\lambda$ of $T,\:Tw_k=\lambda w_k\Rightarrow\BigPar{T\XSlash U}\Par{w_k+U}=\lambda w_k+U.$\PfEnd\vspace{3pt}\parSol{}
...
}By \Sbra{5.B(II) \TIPSN{1}}. Note that low-trig and up-trig are equiv to diag.\PfEnd
\SepLine
