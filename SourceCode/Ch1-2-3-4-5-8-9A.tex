...
$p\Par{z}=\underbrace{a_0+a_1 z+\dots+a_{\deg s-1}z^{\deg s-1}}_{r\SmallPar[0.5pt]{z}}{}+s\Par{z}\:\!\!\underbrace{\BigSbra{b_0+b_1 z +\dots+ b_{\deg p-\deg s}\,z^{\deg p-\deg s}}}_{q\SmallPar[0.5pt]{z}}.$\PfEnd[-16pt]
\SepLine
...
\Anchor{4OL2}\ProblemN{L2}{
	\TextB{Supp $\alpha\in\Nbp$ suth $p\Par{z}=\Par{z-\lambda}{^\alpha}q\Par{z}.$ Prove ${p{^{\SmallPar{\alpha-1}}}}\Par{\lambda}=0.$\vspace{2pt}}
}$\Sbra{\Par{z-\lambda}{^\alpha}q\Par{z}}{^{\SmallPar{\alpha-1}}}=\sum_{j=0}^{\alpha-1}\mathC_{\alpha-1}^j\Sbra{\Par{z-\lambda}{^\alpha}}{^{\SmallPar{j}}}\:\!\Sbra{q\Par{z}}{^{\SmallPar{\alpha-1-j}}}.$\vspace{3pt}\parSol{}
