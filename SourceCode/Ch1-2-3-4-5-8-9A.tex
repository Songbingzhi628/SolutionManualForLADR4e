...
\Anchor{8BT4}\ProblemN{\BulletPointX B.\TipsN{4}}{
	\PrePa\TextA{Prove $\nullp p\Par{T}\oplus\nullp q\Par{T}=\Null\Par{pq},\,\rangep p\Par{T}+\rangep q\Par{T}=V.$}
...
By \Sbra{B \TIPSN{3}}, $\nullp p\Par{T_{\!\Cbb}}=G\Par{\alpha_1,T_{\!\Cbb}}\oplus\cdots\oplus G\Par{\alpha_{\!A},T_{\!\Cbb}}.$ \,Simlr for $q.$\vspace{1pt}\parNot{\IndentB}
...
}By \Sbra{8.B \TIPSN{3}}, $\nullp q\Par{T}{^j}=\Null\Par{T-\lambda I}{^j}\oplus\Null\Par{T-\overline{\lambda}I}{^j}.$ \;By [9.17] and [9.4].\PfEnd\vspace{4pt}
