...
\Anchor{8L1}\ProblemN{L1}{
	\TextA{Supp $V=U\oplus W$ and $U,W$ invard $T\in\Lm{V}.$ Prove $\null T\mmid_U\oplus\null T\mmid_W=\null T.$}
}$\forall v=u+w\in\null T, Tv=Tu+Tw=0\Rightarrow Tu,Tw=0\Rightarrow v\in\null T\mmid_U\oplus\null T\mmid_W.$\PfEnd
\SepLine

\ProblemB[]{
	\TextB{Supp $T\in\Lm{V},\lambda_1,\dots,\lambda_m$ are the disti eigvals, and $U$ invard $T.$}
}
\Anchor{8BT1}\ProblemN{\BulletPointX B.\TipsN{1}}{
	\TextA{Supp $v_1+\dots+v_m\in U$ and each $v_k$ is gigvec corres $\lambda_k.$ Prove each $v_k\in U.$}
...
\Anchor{8BT3}\ProblemN{\BulletPointX B.\TipsN{3}}{
	\TextA{Supp $\Fbb=\Cbb,V=U\oplus W,$ and $U,W$ non0 invard $T.$}
	\TextA{Prove $G\Par{\lambda,T}=G\Par{\lambda,T\mmid_U}\oplus G\Par{\lambda,T\mmid_W}.$}
...
}Let $V=G\Par{\lambda_1,T}\oplus\cdots\oplus G\Par{\lambda_n,T}\Rightarrow V_{\!k}=G\Par{\lambda_1,T\mmid_{V_{\!k}}}\oplus\cdots\oplus G\Par{\lambda_m,T\mmid_{V_{\!k}}}.$\parSol{}
By \Sbra{B \TIPSN{3}}, each $G\Par{\lambda_j,T}=G\Par{\lambda_j,T\mmid_{V_{\!1}}}\oplus\cdots\oplus G\Par{\lambda_j,T\mmid_{V_{\!m}}}.$\parSol{}
...
\Anchor{8D6}\ProblemN{D.6}{
	\TextA{Supp $N\in\Lm{V}$ is nilp, and $v_1,\dots,v_n$ and $m_1,\dots,m_n$ are as in [8.55].}
	\TextA{Prove $N^{m_1}v_1,\dots,N^{m_n}v_n$ is a bss of $\null N.$}
}
\SepLine
...
}${}^{\neg}Q\Rightarrow{}{^\neg}P:$ \;Let $N=T-\lambda I\Rightarrow$ the min of $N$ is $z^{\dim V}.$\parSol{}
\Blind{${}^{\neg}Q\Rightarrow{}{^\neg}P:$ \;}Then by Exe (D.3), the line directly above the diag of any Jordan $\Mt{N}$ is all $1.$\parSol{}
$Q\Rightarrow P:$ \;Asum $V=G\Par{\lambda,T}=U\oplus W,$ and $U,W$ non0 invard $T\Rightarrow\exists$ Jordan $\Mt{T\mmid_U},\Mt{T\mmid_W}.$\parSol{}
\Blind{$Q\Rightarrow P:$ \;}Let $\max\!\Bra{\dim U,\dim W}=m<\dim V.$ Then $\Par{T-\lambda}{^m}=0.$\PfEnd
\SepLine
