...
}Asum $\nexists$ common intersec of dim $\Par{k-1}.$ Supp $U,W\in\mC\Rightarrow\Dim\Par{U+W}=k+1.$\parSol{}
Asum $\exists\,\mC\ni X$ not contained in $U+W.$ Then $\Dim\Par{X+U+W}=2k+1-\Dim\BigPar{X\cap\Par{U+W}}.$\parSol{}
Note that $m=\Dim\BigPar{X\cap\Par{U+W}}\leqslant k-1,$ and $n=\Dim\Par{X\cap U\cap W}\leqslant k-1.$\parSol{}
{\FontSmall Becs $m=k\Rightarrow X\cap\Par{U+W}=X\Rightarrow X\subseteq U+W;$\,\,\,and $m=k+1\Rightarrow X\cap\Par{U+W}=U+W\Rightarrow\dim X\geqslant k+1.$}\parSol{}
$X\cap\Par{U+W}\supseteq\Par{X\cap U}+\Par{X\cap W}\Rightarrow m\geqslant2\Par{k-1}-n\geqslant k-1\Rightarrow\Dim\Par{X+U+W}=k+2.$
\SepLine\ChEnd
...
{Define $E_{i,j}\in\Lm{V,W}$ by $E_{i,j}\Par{v_x}=\delta_{i,x} w_j.$ Denote $\Mt{E_{i,j}}$ by $\mEnt{j,i}.$ And $\BigPar{\mEnt{j,i}}{_{l,k}}=\delta_{i,l}\delta_{j,k}.$}\vspace{2pt}\TextB{}
...
\Anchor{3D4e17}\ProblemBnoor{4E 17}{
	\TextB{Supp $V$ is finide and $S\in\Lm{V}$. Define $\mA\in \Lm[\BigPar]{\Lm{V}}$ by $\mA\Par{T} = ST$.}
	\PrePa\TextB{Show $\dim\null \mA = \Par{\!\dim V}\Par{\!\dim \null S}$.}
	\PrePb\TextB{Show $\dim\range \mA = \Par{\!\dim V}\Par{\!\dim \range S}$.}
}(a) %\vspace{3pt}\FontLarge
{$\forall T\in\Lm{V},$ $ST=0\Longleftrightarrow \range T\subseteq\null S.$}\parSol{\Ha}
%\vspace{6pt}\FontLarge
{Thus $\null\mA=\Bra{T\in\Lm{V}:\range T\subseteq\null S}=\Lm{V,\null S}.$}\parSol{\vspace{2pt}}
...
%\FontLarge
{Thus $\range\mA=\Bra{R\in\Lm{V}:\range R\subseteq\range S}=\Lm{V,\range S}.$}\FontNorm\PfEnd\vspace{14pt}\quad
...
$\Longrightarrow\mA\Par{T}=ST=\textstyle\XPar{{\sum_{r=1}^m E_{r,r}}}\XPar{{\textstyle\sum_{i=1}^n\sum_{j=1}^n A_{i,j}R_{j,i}}}=\textstyle\sum_{i=1}^m\sum_{j=1}^n A_{i,j}Q_{j,i}.$\par\hspace{0pt}
\;\;$\hText{\Mt[\BigPar]{S,v\rightarrow w}\Mt[\BigPar]{T,w\rightarrow v}=\Mt[\BigPar]{ST,w}=\\
\Mt[\BigPar]{\mA,R\rightarrow Q}\Mt{T,R}=\Mt[\BigBigPar]{\!\mA\Par{T},Q}=}{\small\begin{pmatrix}
A_{1,1} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{1,m} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{1,n}\\[-2pt]
\vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt]
A_{m,1} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{m,m} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{m,n}\\[-2pt]
\vdots  &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots  &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt]
...
Let $T=I,$ we have $\\$
$\Mt[\BigPar]{\mA,R\rightarrow Q}=\Mt[\BigPar]{S,v\rightarrow w}.}$\par\quad
$\range\mA={}\Spn{\small\begin{Bmatrix} \underset{\;,}{Q_{1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!,}{Q_{n,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt] \overset{\;,}{Q_{1,m}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{Q_{n,m}}\end{Bmatrix}},\;\null \mA=\Spn{\small\begin{Bmatrix} \underset{\;,}{R_{1,m+1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!\!,}{R_{n,m+1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt] \overset{\;,}{R_{1,n}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{R_{n,n}}\end{Bmatrix}}.$
\;\;$\hText{$
(a) $\dim\null \mA=n\times\Par{n-m};\\$
(b) $\dim\range \mA=n\times m.}$\par\PfEnd[-10pt]\vspace{-4pt}
\SepLine

\Anchor{3D4e10}\ProblemBnoor{4E 10}{
	\TextB{Supp $V,W$ are finide, $U$ is a subsp of $V$.\vspace{3pt}}
	\TextB{Let $\mE = \Bra{T\in\Lm{V,W}: U\subseteq\null T}=\Bra{T\in\Lm{V,W}:T\mmid_U=0}$.\vspace{2pt}}
	\PrePa\TextB{Show $\mE$ is a subsp of $\Lm{V,W}$.\vspace{1pt}}
	\PrePb\TextB{Find a formula for $\dim \mE$ in terms of $\dim V$, $\dim W$ and $\dim U$.\vspace{1pt}}\hspace{0.3pt}
...
$\forall \,T\in\mE,k\in\Bra{1,\dots,m},TE_{k,k}=0\Rightarrow{\normalsize\underbrace{\Spn\begin{Bmatrix} \underset{\;,}{E_{1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!,}{E_{m,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \,\vdots\\[-2pt] \overset{\;,}{E_{1,p}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!,}{E_{m,p}}\end{Bmatrix}}_{\text{Denote\,it\,by\,R}}}\,\cap\,\mE=\zeroSubs$.\vspace{-32pt}\par\Hb
\;\;$\hText{$
	又 $W=\Spn${\small$\begin{Bmatrix} \underset{\;,}{E_{m+1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!,}{E_{n,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \,\vdots\\[-2pt] \overset{\;,}{E_{m+1,p}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!,}{E_{n,p}}\end{Bmatrix}$}$\,\subseteq\mE.\\\;\\\;}\hText{\\[4pt]$ Where $\Lm{V,W}=R\oplus W\Rightarrow\Lm{V,W}=R+\mE.\\$
	\hspace{-120pt}Then $\dim\mE=\dim\Lm{V,W}-\dim R-\Dim\Par{R\cap\mE}=\Par{\!\dim V-\dim U}\dim W.}$\PfEnd[-28pt]
\SepLine\pagebreak

\Anchor{3D'3}\ProblemB{
	\TextB{Define $\mB\in\Lm[\BigPar]{\Lm{V}}$ by $\mB\Par{T}=TS.$\vspace{2pt}}
	\PrePa\TextB{Show $\dim\null\mB=\Par{\!\dim V}\Par{\!\dim\null S}.$}
	\PrePb\TextB{Show $\dim\range\mB=\Par{\!\dim V}\Par{\!\dim\range S}.$}
}(a) {$\forall T\in\Lm{V},TS=0\Longleftrightarrow\range S\subseteq\null T.$}\parSol{\Ha}
{Thus $\null\mB=\Bra{T\in\Lm{V}:\range S\subseteq\null T}=\Bra{T\in\Lm{V}:T\mmid_{\range S}=0}.$}\parSol{\vspace{2pt}}
(b) {$\forall R\in\Lm{V},\null S\subseteq\null R\Longleftrightarrow\exists\,T\in\Lm{V},R=TS,$ by (3.B.24).}\parSol{\Hb}
{Thus $\range\mB=\Bra{R\in\Lm{V}:\null S\subseteq\null R}=\Bra{R\in\Lm{V}:R\mmid_{\null S}=0}.$}\FontNorm\parSol{\vspace{2pt}}
Using [3.22] and Exe (4E 10).\PfEnd\vspace{6pt}\quad
\Or Using {\NOTEFOR} [3.60] and nota in Exe (4E 17).\par\vspace{-18pt}\quad
$\mB(T)=TS=\XPar{{\sum_{i=1}^n\sum_{j=1}^n A_{i,j}R_{j,i}}}\XPar{{\sum_{r=1}^m E_{r,r}}}=\sum_{i=1}^n\sum_{j=1}^m A_{i,j}G_{j,i}\Longrightarrow\Mt{TS,v}={\small\begin{pmatrix}
...
$\range\mB=\Spn{\small\begin{Bmatrix} \underset{\;,}{G_{1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!\!,}{G_{m,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt] \overset{\;,}{G_{1,n}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{G_{m,n}}\end{Bmatrix}},\;\null\mB=\Spn{\small\begin{Bmatrix} \underset{\;,}{R_{m+1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!\!,}{R_{n,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt] \overset{\;,}{R_{m+1,n}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{R_{n,n}}\end{Bmatrix}}.$
\;\;$\hText{\\$
	(a) $\dim\null \mB=n\times\Par{n-m};\\$
	(b) $\dim\range \mB=n\times m.}$\par\PfEnd[-12pt]\vspace{-6pt}
\SepLine
...
\Anchor{3D'4}\ProblemB{
	...
	\TextB{Find the dim and a bss of $\range ST.$}
...
\Or Let $\mathcal{V}=U=W=\Fbb^{\infty}=X,\,Y=\Bra{\Par{0,x_1,x_2,\cdots}}.$ Then $U\XSlash W=\zeroSubs,$ while $\dim X\XSlash Y=1.$\PfEnd
\SepLine
...
$\Lm{V,W}\ni T=\sum_{j=1}^n\sum_{k=1}^mA_{k,j}E_{j,k}\Longleftrightarrow\mT=\sum_{j=1}^n\sum_{k=1}^mA_{k,j}\reflectbox{\textit{E}}{_{k,j}}\in\Lm{W\apostrophe,V\apostrophe}.$ Uniqly by Exe (16).
\SepLine
...
\vfill\ChDecl{Ch5BII}{5.B: II}{\qquad{\small\textbf{注意\,:}\;这一节的题号使用第四版5.C节}}
...
}Supp $ST=TS\Rightarrow T\apostrophe S\apostrophe=\Par{ST}\apostrophe=\Par{TS}\apostrophe=S\apostrophe T\apostrophe.$ Convly, supp $\mS,\mT\in\Lm{V\apostrophe}$ commu.\parSol{}
By (3.F.16), $\exists\,!\,S,T\in\Lm{V},\;\mS=S\apostrophe,\,\mT=T\apostrophe.$ Then $\Par{TS}\apostrophe=S\apostrophe T\apostrophe=T\apostrophe S\apostrophe=\Par{ST}\apostrophe.$\PfEnd\vspace{2pt}\parSol{}
...
(b) Given $\mS,\mT\in\Lm{V\apostrophe},$ by (3.F.16), $\exists\,!\,S,T\in\Lm{V},\;\mS=S\apostrophe,\,\mT=T\apostrophe.$ By (a).\PfEnd
\SepLine
...
Supp $S\in\mE.$ Let $V=E\Par{\lambda_1,S}\oplus\cdots\oplus E\Par{\lambda_m,S}$ with $m>1.$\parSol{}
Let each $E_k=E\Par{\lambda_k,S}.$ Becs for all $T\in\mE,$ each $E_k$ invard $T\Rightarrow T\mmid_{E_k}$ diag.\parSol{}
...
Supp $S\in\mE$ and non0 $E=E\Par{\lambda,S}$ \Sbra{${}\neq V$} invard all $T\in\mE.$\parSol{\Ha}
...
Supp $S\in\mE.$ Let $v_1$ be eigvec of all elem of $\mE.$ Let $W\oplus\Span{v_1}=V,P:av_1+w\mapsto w.$\parSol{\Hb}
For each $R\in\Lm{V},$ define $\hat{R}\in\Lm{W}$ by $\hat{R}=PR.$ Becs for all $T\in\mE,$ $\hat{S}\hat{T}=\hat{T}\hat{S}.$\parSol{\Hb}
