...
%\Anchor{3B'2}\ProblemB{
%	\TextB{Supp $\varphi,\beta\in\Lm{V,\Fbb}$ liney indep and $\dim V=n.$ \,Show $V=\null\varphi+\null\beta.$}
%}Let $\varphi\Par{u}=\beta\Par{w}=1.$ Let $B_{\null\varphi}=\Par{e_2,\dots,e_n},B_{\null\beta}=\Par{\,f_2,\dots,\,f_n}.$\parSol{}
%Note that $\Par{u,w}$ liney indep. Supp $\Mt{\varphi,B_1}=\Par{1\;0\;\cdots\;0}$
%\SepLine
\ChEnd\pagebreak
