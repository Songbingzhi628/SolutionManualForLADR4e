...
\ProblemB{
	\TextB{Supp $S,T\in\Lm{V},p\in\PoFi$. Prove $Sp\Par{TS}=p\Par{ST}S.$}
...
\Anchor{8A4}\ProblemN{4}{
	\TextA{Supp $T\in\Lm{V}$ and $\alpha,\beta\in\Fbb$ disti. Prove $G\Par{\alpha,T}\cap G\Par{\beta,T}=\zeroSubs.$}
}
\SepLine
...
\Anchor{8ANE17-18-19}\ProblemBX[]{\NoteForSmall{Exe (17, 18, 19)}}{
	Since $V$ finide. Immed by [3.22] and [8.3, 4], Exe (19) $\Rightarrow$ (18) $\Rightarrow$ (17).\TextA{}
	Which is in opposite order as to the stmts for null sp.\TextA{\vspace{-2pt}}
}\SepLine
