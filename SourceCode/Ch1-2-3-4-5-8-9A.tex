...
\Anchor{5A4e37}\ProblemBnoor{4E 37}{
	...
	\TextA{Prove the set of eigvals of\;$T$ equals the set of eigvals of $\mA$.}
...
\Or $TS-\lambda S=\Par{T-\lambda I}S=0\Rightarrow\zeroSubs\neq\range S\subseteq\Null\Par{T-\lambda I}\Rightarrow\Par{T-\lambda I}$ not inje.\PfEnd\vspace{3pt}
\AComm {If $\mA:S\mapsto ST.$ Then the eigvals of $\mA$ are not the eigvals of $T$ in general.}
%TODO:countexa or explanation
\SepLine
