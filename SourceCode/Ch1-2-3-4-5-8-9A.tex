...
\Anchor{8A4e15}\Anchor{8B5}\ProblemNnoor{B.5}{4E A.15}{
	\TextA{Supp $\Fbb=\Cbb,T\in\Lm{V}.$ Prove non0 $T$ diag $\Rightarrow$ each $G\Par{\lambda,T}=E\Par{\lambda,T}.$}
...
\Anchor{8B7}\ProblemN{B.7}{
	\TextA{Supp $\Fbb=\Cbb.$ Prove every inv $T\in\Lm{V}$ has a cube root.}
}
\SepLine

\Anchor{8B10}\ProblemN{B.10}{
	\TextA{Supp $\Fbb=\Cbb,T\in\Lm{V}.$ Prove $\exists$ commu $D,N\in\Lm{V},T=D+N,\,D$ diag, $N$ nilp.}
}
\SepLine

\Anchor{8B4e8}\ProblemBnoor{4E B.8}{
	\TextA{Supp $\Fbb=\Rbb,$ and $\lambda_1,\dots,\lambda_m$ are disti eigvals of $T\in\Lm{V},$ and $p$ is the min.}
	\TextA{Prove $V=G\Par{\lambda_1,T}\oplus\cdots\oplus G\Par{\lambda_m,T}\Longleftrightarrow p\Par{z}=\Par{z-\lambda_1}{^{k_1}}\cdots\Par{z-\lambda_m}{^{k_m}}.$}
}
\SepLine

\Anchor{Ch8C}
\Anchor{8B4e20}\Anchor{8C20}\ProblemNnoor{C.20}{4E B.20}{
	\TextA{Supp $\Fbb=\Cbb,$ and each $V_k$ non0 invardspd $T\in\Lm{V}$ of $V=V_1\oplus\cdots\oplus V_m.$}
	\TextA{Let $p_k$ be the char of $T\mmid_{V_k}.$ Prove the char of $T$ is $p_1\cdots p_m.$}
}
\SepLine

\Anchor{Ch8D}

\Anchor{8D5}\ProblemN{D.5}{
	\TextA{}
}
\SepLine

\Anchor{8D6}\ProblemN{D.6}{
	\TextA{}
}
\SepLine
...
\Anchor{8C4e7}\ProblemBnoor{4E C.7}{
	\TextA{}
}

\Anchor{8C4e9}\ProblemBnoor{4E C.9}{
	\TextA{}
}

\Anchor{8C4e11}\ProblemBnoor{4E C.11}{
	\TextA{}
}
