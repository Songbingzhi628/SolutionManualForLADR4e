...
\Anchor{8B4e6}\ProblemBnoor{4E B.6}{
	\TextA{Supp $T\in\Lm{V}$ and $\lambda$ is an eigval. Explain why the expo of $z-\lambda$}
...
Let $r\Par{z}=\Par{z-\lambda}{^m}\Par{z-\lambda_2}{^{\alpha_2}}\cdots\Par{z-\lambda_n}{^{\alpha_n}}\Rightarrow r\Par{T}=0.$ Ctradic the min of $m_{T_{\!\Cbb}}.$\PfEnd\vspace{4pt}\parSol{}
...
\Anchor{8N8.55}\ProblemBX[]{\NoteForSmall{[8.55]}}{
	...
	(3) Let $B_{U_0}=\Par{N^{m-1}v_{1,1},\dots,N^{m-1}v_{n_1,1},\dots,Nv_{1,m-1},\dots,Nv_{n_{m-1},m-1},v_{1,m},\dots,v_{n_m,m}}.$ Sum up and done.\PfEnd\TextB{\vspace{-3pt}}
}\SepLine
