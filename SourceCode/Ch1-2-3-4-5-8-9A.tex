...
\Anchor{3CT1}\ProblemBX{\TipsN{1}}{
	\TextA{Supp $p\in\PoFx{\,}{\Fbb^n}.$ Prove $\Mt[\BigPar]{p\Par{T_{\!1},\dots,T_{\!n}}}=p\BigPar{\Mt{T_{\!1}},\dots,\Mt{T_{\!n}}}.$}
...
\Anchor{3DT3}\ProblemBX[]{\TipsN{3}}{
	...
	\IndentNote [3.41]: $C=\Mt[\BigPar]{T,\Par{u_1,\dots,u_p},\Par{v_1,\dots,v_n}}\in\Fbb^{p,n},\,A=\Mt[\BigPar]{S,\Par{v_1,\dots,v_n},\Par{w_1,\dots,w_m}}\in\Fbb^{n,m}.$\TextB{}
...
$\mB\Par{T}=TS=\XPar{{\sum_{j=1}^p\sum_{i=1}^m A_{j,\,i}R_{i,j}}}\XPar{{\sum_{k=1}^r E_{k,k}}}=\sum_{j=1}^p\sum_{i=1}^r A_{j,\,i}Q_{i,j}\Rightarrow\Mt{TS,v}={\small\begin{pmatrix}
