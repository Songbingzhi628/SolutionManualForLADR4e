...
\ACoro Simlr in [5.20], $p\Par{S}\;\!q\Par{T}=q\Par{T}\;\!p\Par{S}.$ Then $q\Par{T}$ invard $p\Par{S}.$\vspace{-2pt}
\SepLine
...
}Let $p\Par{z}=\Par{z-\lambda}{^l}q\Par{z}$ be the min of $T$ with $q\Par{\lambda}\neq0.$ Let $G=G\Par{\lambda,T},N=T-\lambda I.$\parSol{}
Asum $N^{l+1}\mmid_G=0$ while $N^l\mmid_G\neq0.$ Then $p\Par{T}\Big|{_G}=0=q\Par{T}N^l\mmid_G\Rightarrow q\Par{T}\Big|{_G}\neq0.$ ??? Ctradic.\vspace{2pt}\parSol{}
Let $m$ be the smallest suth $N^m\mmid_G=0$ with $N^{m-1}\mmid_G\neq0.$\parSol{}
Asum the min of $T$ is $p\Par{z}=\Par{z-\lambda}{^{m+k}}q\Par{z},k\in\Nbp.$\parSol{}
Then let $s\Par{z}=\Par{z-\lambda}{^m}q\Par{z}\Rightarrow s\Par{T}=0$ while $0<\deg s<\deg p,$ ctradic.\PfEnd
\SepLine
...
Extend to $B_{\null N^2}\Rightarrow\cdots\Rightarrow B_{\null N^m},$ with each time adding at least one bss vec. Thus $m\leqslant d.$\PfEnd\vspace{2pt}\parSol{}
\Or By Exe (4E B.6) and (4E A.4), $\dim\Null\Par{T-\lambda I}{^m}=d\geqslant m.$\PfEnd
\SepLine
