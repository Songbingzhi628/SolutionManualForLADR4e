...
}By \Sbra{3.A {\NOTEFOR} $\FbbP{S}$}, immed. \,\Or Fix one $m\in\Nbp$ and $p\in\PoFx{\,}{[0,1]}.$\parSol{}
...
}Let $\Par{e_1,\dots,e_n}$ be the std bss of $\FbbP{n}.$ The eigvals are $\Bra{1,\dots,n}$ of len $\dim\FbbP{n}.$\parSol{}
...
\Or Becs $\range T=\Bra{\Par{x,\dots,x}\in\FbbP{n}}$ of dim $1.$ By Exe (29). Simlr.\PfEnd\parSol{}
...
Supp non0 $x\in\FbbP{n}$ and $\lambda\in\Fbb$ with $Tx=\lambda x.$ Becs $\range T=\Span[\BigPar]{\Par{1,\dots,1}},\exists\,!\,\alpha\in\range T,$\parSol{}
...
(b) A countexa: Let $T$ be the forwd shift optor on $V=\FbbP{\infty}.$ No eigvals for $T,$ by Exe (18).\parSol{\Hb}
...
\AExa Let $V=\FbbP{\Nbb},U=\Bra{\,x\in\FbbP{\Nbb}:x_1=0},T\in\Lm{V}:e_k=e_{k+1}.$ Then $\Par{T\XSlash U}\Par{e_1+U}=e_2+U=0.$
\SepLine
...
\Anchor{5BI4e16}\Anchor{8C18}\ProblemBnoor{8.C.18 \OR 4E I.16}{
	\TextA{Define $T\in\Lm{\FbbP{n}}:\Par{x_1,\dots,x_n}\mapsto\BigPar{{-a_0\,x_n,\;x_1-a_1\hspace{1pt}x_n,\,\cdots,\;x_{n-1}-a_{n-1}\hspace{1pt}x_n}}.$\vspace{1pt}}
