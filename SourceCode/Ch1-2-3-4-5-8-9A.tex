...
\ProblemB{
	...
	\TextB{Prove $V\apostrophe=V_{\!1}^0\oplus\cdots\oplus V_{\!m}^0$\FontSmall${}=\BigSbra{{\bigcap_{k=1}^n\!\Sbra{{\bigoplus_{i\,\in\,\Gamma_{\!k}}\!U_i}}}}{^0}=\bigoplus_{k=1}^n\!\Sbra{{\bigcap_{i\,\in\,\Gamma_{\!k}}\!U_i^0}}.$ See the {\COROLLARY} after Exe (23).\PfEnd\vspace{2pt}}
...
\ProblemN{\Anchor{3F23}{23}}{
	\TextA{Supp $U$ and $W$ are subsps of $V$. Prove $\BigPar{U\cap W}{^0}=U^0+W^0$.\vspace{-2pt}}
}\vspace{3pt}\par\quad
\!\!\!$\hText{$
...
\BulletPointX\ACoro
%{$\Par{U_1+\cdots+U_m}{^0}=U_1^0\cap\cdots\cap U_m^0,$ \,and\;$\Par{U_1\cap\cdots\cap U_m}{^0}=U_1^0+\cdots+U_m^0.$}\parCor{\IndentB}
{$V=U_1\oplus\cdots\oplus U_m\Longleftrightarrow V\apostrophe=U_1^0\oplus\cdots\oplus U_m^0.$}\vspace{-2pt}
\SepLine
