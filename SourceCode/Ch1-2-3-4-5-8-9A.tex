...
\ACoro (1) $T$ surj $\Rightarrow\dim\null ST=\dim\null S+\dim\null T.$ \, (2) $S$ inje $\Rightarrow\dim\null ST=\dim\null T.$\parCor
(3) $T$ inv $\Rightarrow\dim\null ST=\dim\null S,\;\null ST=\null T.$\vspace{-3pt}
\SepLine\pagebreak
...
}Using [4.17], $\deg p=2M+m\Rightarrow m$ is odd, done. \;\Or Let $p\Par{x}=a_0+a_1 x+\dots+a_m x^m.$\parSol{\vspace{3pt}}
