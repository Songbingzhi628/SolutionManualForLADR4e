...
\ChDecl{Ch8B}{8.B}{\quad{\ANote {\FontSmall $V$ denotes a finide non0 vecsp over $\Fbb.$ An Exe marked by $\blacksquare$ is true if infinide or partially finide.}}}
...
\ChDecl{Ch8C}{8.C}{\quad{\ANote {\FontSmall $V$ denotes a finide non0 vecsp over $\Fbb.$ An Exe marked by $\blacksquare$ is true if infinide or partially finide.}}}

\ChEnd
\pagebreak

\ChDecl{Ch8D}{8.D}{\quad{\ANote {\FontSmall $V$ denotes a finide non0 vecsp over $\Fbb.$ An Exe marked by $\blacksquare$ is true if infinide or partially finide.}}}
...
(b) By (a) and (4E 8.A.11), immed.\PfEnd
\SepLine
