...
\Anchor{5AT2}\ProblemBX{\TipsN{2}}{
	...
	\TextA{Prove $U=\BigPar[0pt]{U\cap E_1}\oplus\cdots\oplus\BigPar[0pt]{U\cap E_m}.$\vspace{0pt}}
...
\Anchor{5AT5}\BulletPointX\TipsN{5}\,\,\,Supp $T\in\Lm{\Rbb^2}$ is the countclockws rotat by $\theta\in\Rbb.$ Define $\mC\Par{a,b}=a+\i b.$\TextB{}
...
\Anchor{5C4e16}\ProblemN{16}{
	\TextA{Supp $V=E\Par{\lambda_1,T}\oplus\cdots\oplus E\Par{\lambda_m,T},$ and $U$ is invarspd $T\in\Lm{V}.$}
	\TextA{Prove $U=E\Par{\lambda_1,T\mmid_U}\oplus\cdots\oplus E\Par{\lambda_m,T\mmid_U}.$}
}Becs $\forall u\in U,\exists\,!\,v_k\in E\Par{\lambda_j,T},\,u=v_1+\dots+v_m.$ 又 By \Sbra{5.A \TIPSN{1}}, each $v_k\in U.$\PfEnd
\SepLine
...
Becs $U$ invard $T\Rightarrow$ invard $R_kS_k=p\Par{T}.$ Thus $w_k\in U\Rightarrow v_k\in U.$\PfEnd
\SepLine

\Anchor{8BT2}\ProblemN{\BulletPointX B.\TipsN{2}}{
	\TextA{Prove $U=G\Par{\lambda_1,T\mmid_U}\oplus\cdots\oplus G\Par{\lambda_m,T\mmid_U}.$}
}Becs $\forall u\in U,\exists\,!\,v_k\in G\Par{\lambda_k,T},u=v_1+\dots+v_m,$ 又 each $v_k\in U.$\PfEnd\vspace{2pt}
...
(2) If $s,q$ are blocks with no common zeros. Then $V=\rangep s\Par{T}+\range q\Par{T}.$
\SepLine

\Anchor{8BT5}\ProblemN{\BulletPointX B.\TipsN{5}}{
	\TextA{Supp $\Fbb=\Cbb.$ Prove $\exists$ invarsp $W$ suth $V=U\oplus W.$}
}Let $V=G\Par{\lambda_1,T}\oplus\cdots\oplus G\Par{\lambda_m,T}\Rightarrow U=G\Par{\lambda_1,T\mmid_U}\oplus\cdots\oplus G\Par{\lambda_m,T\mmid_U}.$\parSol{}
Let each $W_k\oplus G\Par{\lambda_k,T\mmid_U}=G\Par{\lambda_k,T}\Rightarrow W_k=G\Par{\lambda_k,T}\cap W_k=G\Par{\lambda_k,T\mmid_{W_k}}$ invard $T.$\parSol{}
Now $W=W_1\oplus\cdots\oplus W_m$ is invard $T$ and $V=U\oplus W.$\PfEnd\vspace{2pt}
...
suth $\nexists$ invarsp $W$ of dimension $\dim V-\dim U.$ Note that no exas exis if $\dim V\leqslant 5.$
\SepLine
...
}By \Sbra{B \TIPSN{2}}, $V=G\Par{\lambda_1,T}\oplus\cdots\oplus G\Par{\lambda_n,T}\Rightarrow V_{\!k}=G\Par{\lambda_1,T\mmid_{V_{\!k}}}\oplus\cdots\oplus G\Par{\lambda_m,T\mmid_{V_{\!k}}}.$\parSol{}
...
\Blind{${}{^\neg}P\Rightarrow{}{^\neg}Q:$ \;}Let $S=\Par{T-\lambda I}{^M}.$ By \Sbra{5.A \TIPSN{4}}, $\null S\mmid_U\oplus\null S\mmid_W=\null S.$\parSol{}
