...
\Anchor{3D'1}\ProblemB{
	\TextB{Supp $T\in\Lm{V}.$ Prove $\exists$ inv $T_1,T_2\in\Lm{V}$ suth $T=T_1+T_2.$}
...
\AExa Let $V=\Bra{\,f\in\Rbb^{\Rbb}:\exists\,!\,m\in\Nbb,f\in\Span{1,e^x,\dots,e^{mx}}}.$\parExa
Let $U=\Bra{\,f\in\Rbb^{\Rbb}:\exists\,!\,m\in\Nbp,f\in\Span{e^x,\dots,e^{mx}}}.$\parExa
Define $T\in\Lm{V}$ by $Tf=e^x f.$ Then $\Par{T\XSlash U}\Par{1+U}=e^x+U=0$ while $T$ inje.
\SepLine
...
\Anchor{5C4e19}\AComm Exa [5.15] gives a exa of $T\in\Lm{V}$ not diag while $T\mmid_U,T\XSlash U$ diag.\PfEnd
\SepLine
...
Becs $\Par{T-\lambda_jI}{^k}w=0=\sum_{i=1}^m\Par{\lambda_i-\lambda_j}{^k}v_i\Rightarrow w=v_j\in E\Par{\lambda_j,T}.$\PfEnd\vspace{3pt}\parSol{}
...
By \Sbra{5.B(I) \TIPSN{1}}, $m_T$ is a multi of $\Par{z-\lambda_j}{^k}.$ 又 $k\geqslant 2.$\PfEnd
\SepLine
...
Let $B_V=B_{G_1}\cup B_U.$ Define $P_{\!1},P_{\!2}\in\Lm{V}$ by $P_{\!1}\Par{v_1+u}=v_1,P_{\!2}\Par{v_1+u}=u.$\parSol{}
Let $D=D_1P_{\!1}+D_2P_{\!2},N=N_1P_{\!1}+N_2P_{\!2}.$ \:Becs $P_jD_k=\delta_{j,k}D_j,P_jN_k=\delta_{j,k}N_j.$\parSol{}
Thus $D+N=\Par{D_1+N_1}P_{\!1}+\Par{D_2+N_2}P_{\!2}=T,$ and $DN=D_1N_1P_{\!1}+D_2N_2P_{\!2}=NP.$\PfEnd\vspace{3pt}\parSol{}
