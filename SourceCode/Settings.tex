...
\def\XSlash{\hspace{-1.2pt}\text{\forslash/}}
...
\newcommand{\Bra}[2][\envFont]{{\text{\forbra{#1\{}}}#2{\text{\forbra{#1\}}}}}%{\hText[-4pt]{}{}{$\hspace{-1pt}{\envFontB$\hText[#1]{\left\{}{\right\}}{${\envFont$#2$}$}$}$}}
...
\newcommand{\Backslash}[1][\envFontA]{${#1$\backslash$}$}
