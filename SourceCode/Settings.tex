...
\newcommand{\TextLN}[1]{\envFontLarge\Largesl{#1}\envFontDefault\par\IndentLN}
...
\newcommand{\ExampleX}[2][\Solution]{
	\def\Ptarget{{\BulletPoint} \Example \,\,\,}
