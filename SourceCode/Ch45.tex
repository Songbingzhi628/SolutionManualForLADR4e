...
\ProblemBnoor[]{\Tips \,\,\,}[]{
	\TextB{\tgsl\large\envFontDefault Suppose $p\in\PoFi,\deg p\leqslant m$ and $p$ has at least $\Par{m+1}$ distinct zeros.}
...
Because $q\in\PoFi,\exists\,!\,a_i,b_j\in\Fbb,$\TextB{}
...
Suppose a nonconst $p\in\PoCi$ with highest-order nonzero term $c_m z_m.$\vspace{3pt}\TextB{}
...
\ProblemBnoor{\hypertarget{4O4e3}{4E 4.3}}{
	\TextB{Suppose $\Fbb=\Cbb,\varphi\in V\apostrophe.$ Define $σ:V\rightarrow\Rbb$ by $\sigma\Par{v} = \Real\varphi\Par{v}$ for each $v\in V.$\vspace{4pt}}
...
\ProblemN{\hypertarget{4O4}{4}}{
	...
	\TextN{Prove that $\exists\,p\in\PoFi,\deg p = n,$ the zeros of $\,p\,$ are $\lambda_1,\dots,\lambda_m.$\vspace{3pt}}
...
\ProblemN{\hypertarget{4O2}{2}}{
	\TextN{Suppose $m\in\Nbp$. Is the set $U=\zeroSubs\cup\Bra{p\in\PoFi:\deg p = m}$ a subsp of $\PoFi$?}
}$x^m,x^m+x^{m-1}\in U$ \,\,but\,\, $\Deg\Sbra{\Par{x^m+x^{m-1}}-\Par{x^m}}\neq m\Rightarrow \Par{x^m+x^{m-1}}-\Par{x^m}\not\in U.$\PfEnd
\SepLine

\ProblemN{\hypertarget{4O3}{3}}{
	\TextN{Suppose $m\in\Nbp$. Is the set $U=\zeroSubs\cup\Bra{p\in\PoFi:2\;\mmid\,\deg p}$ a subsp of $\PoFi$?}
...
By Pigeon Hole Principle, $\exists\,\lambda_k$ such that $p\Par{z}=\Par{z-\lambda_k}{^{2}}q\Par{z}$ for some $q\in\PoFi.$\vspace{3pt}\par\quad\Hb
...
\ProblemN{\hypertarget{4O7}{7}}{
	\TextN{Prove that every $p\in\PoRi$ of odd degree has a zero.}
}\par\quad
...
\ProblemN{\hypertarget{4O9}{9}}{
	\TextN{Suppose $p\in\PoCi$. Define $q:\Cbb\rightarrow\Cbb\,$ by $q\Par{z} = p\Par{z}\overline{p\Par{\overline z}}$. Prove that $q\in\PoRi$.}
}\par\quad
...
\ProblemN{\hypertarget{4O8}{8}}{
	...
	\TextN{Show that {\tgnr(a)} $Tp\in\PoRi$ for all $p\in\PoRi$ and that {\tgnr(b)} $T:\PoRi\rightarrow\PoRi$ is linear.}
}\vspace{2pt}\par\quad
...
(b) Now we show that $T$ is linear: $\forall p,q\in\PoRi,\lambda\in\Rbb,$\vspace{6pt}\par\quad\Hb
...
\ProblemN{\hypertarget{4O11}{11}}{
	\TextNL{Suppose $p\in\PoFi$ with $p\neq 0$. Let $U=\Bra{pq:q\in\PoFi}$.}
	(a) \TextNL{Show that $\dim\PoFi\XSlash U = \deg p$.}
	(b) \TextNL{Find a basis of $\PoFi\XSlash U$.}
}\NOTICE that $pq\neq p\circ q,$ see (4E 3.A.10).\par\quad
$U$ is a subsp of $\PoFi$ because $\forall s_1,s_2\in\PoFi,\lambda\in\Fbb,ps_1+\lambda ps_2=p\Par{s_1+\lambda s_2}\in U.$\par\vspace{3pt}\quad
If $\deg p=0,$ then $U=\PoFi,\PoFi\XSlash U=\Bra{0},$ with the unique basis $\Par{}.$ Suppose $\deg p\geqslant 1.$\par\vspace{6pt}\quad
...
\Or Define $R:\PoFi\rightarrow\PoF{\deg p-1}$ by $R\Par{s}=r$ for all $s\in\PoF.$ We show that $R$ is linear.\vspace{2pt}\par\quad\Ha
...
Because $Rs=0\Longleftrightarrow s=pq,\exists\,!\,q\in\PoFi\Longleftrightarrow s\in U.$ And $\forall r\in\PoF{\deg p-1},Rr=r.$\vspace{2pt}\par\quad\Ha
...
\ProblemBnoor{\hypertarget{4O4e13}{4E 4 13}}{
	\TextB{Suppose nonconst $p,q\in\PoCi$ have no zeros in common. Let $m = \deg p$, $n = \deg q$.\vspace{3pt}}
...
\XPar{ Because $\forall p,q\in\PoFi,k\in\Nbp,\Par{pq}{^{\SmallPar{k}}}=\mathC_{k}^k p{^{\SmallPar{k}}}q{^{\SmallPar{0}}}+\dots+\mathC_{k}^j p{^{\SmallPar{j}}}q{^{\SmallPar{k-j}}}+\dots+\mathC_{k}^0 p{^{\SmallPar{0}}}q{^{\SmallPar{k}}}.$ }\hfill{$\Par{\Delta}$}\vspace{4pt}\par\quad\Hii
...
\ProblemN{L1:}{
	\TextB{Prove that $\forall p,q\in\PoFi,k\in\Nbp,\Par{pq}{^{\SmallPar{k}}}=\mathC_{k}^k p{^{\SmallPar{k}}}q{^{\SmallPar{0}}}+\dots+\mathC_{k}^j p{^{\SmallPar{j}}}q{^{\SmallPar{k-j}}}+\dots+\mathC_{k}^0 p{^{\SmallPar{0}}}q{^{\SmallPar{k}}}.$}
}\par\quad
...
Suppose $p\in\PoFi.$ Write $p\Par{z}=\Par{z-\lambda}{^A}q\Par{z},$ where $A\in\Nbp,q\Par{\lambda}\neq 0.$\vspace{2pt}\par\quad
...
By \TIPSN{2}, $U=\Par{U\cap E_1}\oplus\cdots\oplus\Par{U\cap E_m}.$ Because each $\dim E_k=1,$ $U\cap E_k=\zeroSubs$ or $E_k.$\par\quad
...
\ProblemB[]{
	\TextB{Suppose $T\in\Lm{V}$ and $V_{\!1},\dots,V_{\!m}$ are invar subsps of $V$ under $T$.}
}
...
\ProblemN[]{\hypertarget{5A5}{5}}{
	...
	Thus $\bigcap\limits_{i=1}^m V_{\!i}$ is invar under $T.$\PfEnd\TextN{}
}
\SepLine
...
}If $V=\zeroSubs.$ Then we are done. Suppose $V\neq\zeroSubs.$ We show the contrapositive:\parSol{}
{\tgsl Suppose $U\neq\zeroSubs$ and $U\neq V.$ Prove that $\exists\,T\in\Lm{V}$ such that $U$ is not invar under $T$.}\parSol{}
Let $W$ be such that $V=U\oplus W.$ Define $T\in\Lm{V}$ by $T\Par{u+w}=w.$\PfEnd
\SepLine
...
}Suppose $\lambda$ is an eigval with an eigvec $\Par{w,z}.$ Then $z=\lambda w$ \,{\small and}\, $ w=\lambda z.$\parSol{}
...
}Suppose $\lambda$ is an eigval with an eigvec $\Par{z_1,z_2,z_3}.$\parSol{}
Then $\Par{2z_2, 0,5z_3}=\lambda\Par{z_1,z_2,z_3}.$ We discuss in two cases:\parSol{}
For $\lambda=0,$\, $z_2=z_3=0$ and $z_1$ can be arbitrary \Par{ $z_1\neq 0$ }.\parSol{}
...
(b) Let $\Par{e_1,\dots,e_n}$ be the std basis of $\Fbb^n.$ Let $V_{\!k}=\Span{e_k}.$ Then $V_{\!1},\dots,V_{\!n}$ are invar under $T.$\par\quad\Hb
Hence by \TIPSN{3}, every sum of $V_{\!1},\dots,V_{\!n}$ is a invar subsp of $V$ under $T.$\PfEnd
\SepLine
...
}Suppose $\lambda$ is an eigval of $T$ with an eigvec $\Par{z_1,z_2,\dots}.$\parSol{}
...
\ProblemN{\hypertarget{5A19}{19}}{
	...
	\TextNL{In other words, the entries of $\Mt{T}$ with resp to the std basis are all \,$1$'s.}
...
Note that $\forall p\in\PoRi\nonzero,\deg p\apostrophe<\deg p.$ And $\deg 0=-\infty.$ Suppose $\lambda$ is an eigval with an eigvec $p.$\par\quad
...
}Suppose $\lambda$ is an eigval of $ST$ with an eigvec $v.$ Then $T\Par{STv}=\lambda Tv=TS\Par{Tv}.$\parSol{}
...
Then $B_V=\Par{v_1,\dots,v_n}.$ Because $\Par{ST}v_j=\alpha_j\lambda_j v_j=\Par{TS}v_j$ for each $j.$ Hence $ST=TS.$\PfEnd
\SepLine
...
}Suppose $\lambda_1,\lambda_2,\lambda_0$ are eigvals of $T$ with eigvecs to $u,w,u+w$ respectively.\parSol{}
...
}Suppose $\Par{v_1,\dots,v_m}$ is linely inde. Let $B_V=\Par{v_1,\dots,v_m,\dots,v_n}.$\parSol{}
...
\ProblemN{\hypertarget{5A33}{33}}{
	\TextNL{Suppose $T\in\Lm{V}.$ Prove that $T\XSlash \Par{\range T}=0.$\vspace{2pt}}
...
\ProblemB{
	...
	(a) \TextB{Show that $T\XSlash U$ is well-defined and is linear. {\large Requires that $U$ is invar under $T.$}}
	(b) \Sbra{{\normalsize\OR \Onumber{\hypertarget{5A35}{35}}\,}} \TextB{Show that each eigval of $T\XSlash U$ is an eigval of $T$.}
}\par\quad
(a) $v+U=w+U\Longleftrightarrow v-w\in U\Longrightarrow T\Par{v-w}\in U\Longleftrightarrow Tv+U=Tw+U.$\par\quad\Ha
Hence $T\XSlash U$ is well-defined. Now we show that $T\XSlash U$ is linear.\par\quad\Ha
...
(b) Suppose $\lambda$ is an eigval of $T\XSlash U$ with an eigvec $v+U.$ Then $Tv+U=\lambda v+U\Rightarrow \Par{T-\lambda I}v=u\in U.$\par\quad\Hb
...
\Sbra{ $\null T=\zeroSubs,$ for if not, $\exists\,f\in V\nonzero,\Par{Tf}\Par{x}=e^{x}f\Par{x}=0,\forall x\in\Rbb\Rightarrow f=0,$ contradicts. }\PfEnd
\SepLine
...
$\underbrace{\Span{v_1,w_1,\dots,w_{m-1}}}_{\dim m}$ and $\underbrace{\Span{\alpha_{m-1,m},\dots,\alpha_{m-1,n}}}_{\dim \SmallPar{n-m}}$ are invar under $T.$\par\quad\Ha
...
{\tgsl If $T\mmid_U$ is inv, then by the similar algorithm, we can extend $U$ to an invar subsp.}\par\vspace{6pt}\quad\Ha
...
\Or Consider $T\XSlash U\in\Lm{V\XSlash U}.$ Because $\dim V\XSlash U=1.$ $\exists\,\lambda\in\Fbb,T\XSlash U=\lambda I.$ By Problem (35).\PfEnd
\SepLine
\ChEnd\pagebreak
...
Because $\exists\,\lambda \in \Cbb$ such that $p\Par{\lambda} = 0\Rightarrow\exists\,q \in\PoCi,p\Par{z} = \Par{z-\lambda}q\Par{z},\forall z \in\Cbb.$\TextB{}
...
Suppose $p\in\PoCi$ is a nonzero poly. Then $\deg Tp=\deg p+1,$ and thus $Tp\neq\lambda p,\,\forall\lambda\in\Cbb.$\TextB{}
...
\ProblemBnoor{4E 5.31, \hypertarget{5BI4e25}{4E 5.B.25} and \hypertarget{5BI4e26}{26}}{
	...
	(b) \TextB{Prove that $\,p\,$ is a poly multi of the mini poly of $T\XSlash U$.}
	(c) \TextB{Prove that
 ( mini poly of $T\mmid_U$ ) $\times$ ( mini poly of $T\XSlash U$ ) is a poly multi of $\,p\,$.}
...
(c) Suppose $r$ is the mini poly of $T\mmid_U,s$ is the mini poly of $T\XSlash U.$\par\quad\Hc
Because $\forall v\in V,s\Par{T\XSlash U}\Par{v+U}=s\Par{T}v+U=0.$
...
\ProblemN{\hypertarget{5BI6}{6}}{
	...
	\TextN{Prove that $U$ is invar under $p\Par{T}$ for every poly $p\in\PoFi$.}
}\par\quad
...
Let $W=\range q\Par{T}=\range T.$ $\exists$ monic $s\in\PoFi$ of smallest degree ( $\deg s\leqslant\dim W$ ), $s\Par{T\mmid_W}=0.$\par\quad
...
\ProblemN{\hypertarget{5BI19}{19}}{
	\TextNL{Suppose $V$ is finite-dim, $\dim V>1,T\in\Lm{V}.$ Prove that $\Bra{\,p\Par{T}:p\in\PoFi}\neq\Lm{V}.$\vspace{2pt}}
...
\ProblemB{
	\hypertarget{5BI4e19}{}\TextB{Suppose $V$ is finite-dim and $T\in \Lm{V}$. Let $\mathcal{E} =\Bra{q\Par{T}: q \in \PoFi}$.}
...
\ProblemBnoor{\hypertarget{5BI4e13}{4E 5.B.13}}{
	\TextB{Suppose $T\in \Lm{V}$ and $q \in \PoFi$ is defined by}
	...
	\TextB{Prove that $\exists\,!\,r \in \PoFi$ such that $q\Par{T} = r\Par{T},\deg r<\deg p.$}
}\par\quad
...
Suppose $f\in\PoFi$ such that $f\Par{z}=b_0 +b_1 z+\dots+b_n z^n+b_{n+1}z^{n+1}.$\par\quad\Hii
...
\ProblemN{\hypertarget{5BI10}{10}}{
	...
	\TextNL{Prove that for any $p\in\PoFi,p\Par{T}v=p\Par{\lambda}v.$}
}\par\quad
...
\Comment\,\,\, For any $p\in\PoFi$ such that $p\Par{z}=\Par{z-\lambda_1}^{\alpha_1}\cdots\Par{z-\lambda_m}^{\alpha_m},$ the result is true as well.\par\quad
...
Suppose $v$ is an eigvec correspd to $\lambda.$ Then for any $p\in\PoFi,p\Par{T}v=p\Par{\lambda}v.$\par\quad
...
\ProblemB{
	\TextB{Suppose $S,T\in\Lm{V},S$ is inv, and $p\in\PoFi$. Prove that $Sp\Par{TS}=p\Par{ST}S.$}
}\par\quad
...
\ProblemN{\hypertarget{5BI11}{11}}{
	\TextNL{Suppose $\Fbb = \Cbb,$ $T\in\Lm{V}, p\in\PoCi$, and $\alpha\in\Cbb.$}
...
\ProblemBnoor{\hypertarget{5BI4e18}{4E 5.B.18}}{
	\TextB{Suppose $V$ is finite-dim, $T\in \Lm{V},\lambda\in\nonzeroFbb$, and $\,p\,$ is the mini poly of $T$.}
...
\ProblemBnoor{\hypertarget{5BI4e9}{4E 5.B.9}}{
	...
	\TextB{Explain why all coeffs of the mini poly of $T$ are rational numbers.}
}\par\quad
...
Then $\exists\,q\in\PoRi$ such that $p\Par{x} = q\Par{x}\Par{x^2 + bx + c}$ for all $x\in\Rbb.$\par\quad\Hii
...
\ProblemBnoor{\hypertarget{5BII4e8}{4E 5.C.8}}{
	\TextB{Suppose $V$ is finite-dim, $T\in \Lm{V}$, and $\exists\,v \in V\nonzero$ such that $T^2 v + 2Tv = -2v$.}
...
\ProblemBnoor{\hypertarget{5BII4e12}{4E 5.C.12}}{
	...
	(b) \TextB{Prove that $T\XSlash U$ has an upper-trig matrix with resp to some basis of $V\XSlash U$.}
}\par
...
\ProblemBnoor{\hypertarget{5BII4e13}{4E 5.C.13}}{
	...
	\TextB{such that $T\mmid_U$ has an upper-trig matrix and also $T\XSlash U$ has an upper-trig matrix.}
...
\ProblemN{3}{
	\TextN{Suppose $S, T\in\Lm{V}$ are such that $ST = TS$. Suppose $p\in\PoFi$.}
