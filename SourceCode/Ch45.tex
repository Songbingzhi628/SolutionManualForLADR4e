...
\ProblemBnoor[]{\Tips \,\,\,}[]{
	\TextB{\tgsl\large\envFontDefault Sups $p\in\PoFi,\deg p\leqslant m$ and $p$ has at least $\Par{m+1}$ disti zeros.}
...
\ProblemBnoor[]{\Comment\,\,\,}[]{
	\TextB{\large\envFontDefault\NOTICE that by [4.17], some term of the poly factoriz might not be in the form $\Par{x-\lambda_k}{^{\alpha_k}}.$\vspace{-6pt}}
}\SepLine
...
\vspace{-130pt}\hspace{200pt}$\hMath{l}{\left|}{\right.}{$\;\Or \!\!$\MathRightBrace{l}{
	...
	\;\text{\tgsl\normalsize is greater than or equal to the diffce of the lens of the two other sides.}\\\;}$\PfEnd[7pt]\vspace{-2pt}
\SepLine

\ProblemBnoor{\hypertarget{4O4e3}{4E 4.3}}{
	\TextB{Sups $\Fbb=\Cbb,\varphi\in V\apostrophe.$ Define $σ:V\rightarrow\Rbb$ by $\sigma\Par{v} = \Real\varphi\Par{v}$ for each $v\in V.$\vspace{4pt}}
	\TextB{Show $\varphi\Par{v}=\sigma\Par{v}-\i\sigma\Par{\i v}$ for all $v\in V.$\vspace{2pt}}
}Notice that \,$\varphi\Par{v}=\Real\varphi\Par{v}+\i\,\IMAGINARY\,\varphi\Par{v}=\sigma\Par{v}+\i\,\IMAGINARY\,\varphi\Par{v}.$\parSol{}
又 $\Real\varphi\Par{\i\, v}=\REAL\BigPar{\i\,\varphi\Par{v}}=-\IMAGINARY\,\varphi\Par{v}=\sigma\Par{\i\,v}.$ Hence $\varphi\Par{v}=\sigma\Par{v}-\i\,\sigma\Par{\i\,v}.$\PfEnd
\SepLine

\ProblemN{\hypertarget{4O4}{4}}{
	\TextN{Sups $m,n\in\Nbp$ with $m\leqslant n,\;\lambda_1,\dots,\lambda_m\in\Fbb.$}
	\TextN{Prove $\exists\,p\in\PoFi,\deg p = n,$ the zeros of $\,p\,$ are $\lambda_1,\dots,\lambda_m.$\vspace{3pt}}
...
\ProblemN{\hypertarget{4O5}{5}}{
	\TextN{Sups $m\in\Nbb,$ and $z_1,\dots,z_{m+1}$ are disti in $\Fbb,$ and $w_1,\dots,w_{m+1}\in\Fbb.$}
...
\ProblemN{\hypertarget{4O9}{9}}{
	\TextN{Sups $p\in\PoCi$. Define $q:\Cbb\rightarrow\Cbb\,$ by $q\Par{z} = p\Par{z}\overline{p\Par{\overline z}}$. Prove $q\in\PoRi$.}
}\par\quad
...
\ProblemN{\hypertarget{4O8}{8}}{
	...
	\TextN{Show {\tgnr\large(a)} $Tp\in\PoRi$ for all $p\in\PoRi;$ \;\; {\tgnr\large(b)} $T:\PoRi\rightarrow\PoRi$ is liney.}
}\vspace{2pt}\par\quad
...
\ProblemN{\hypertarget{4O11}{11}}{
	\TextNL{Sups $p\in\PoFi$ with $p\neq 0$. Let $U=\Bra{pq:q\in\PoFi}$.}
	(a) \TextNL{Show $\dim\PoFi\XSlash U = \deg p$.}
	(b) \TextNL{Find a bss of $\PoFi\XSlash U$.}
...
\ProblemN{\hypertarget{4O10}{10}}{
	\TextNL{Sups $m\in\Nbb,p\in\PoC{m}$ is suth $p\Par{x_k}\in\Rbb$ for each of disti $x_0,x_1,\dots,x_m\in\Rbb.$}
	\TextNL{Prove $p\in\PoRi$.}
}\par\quad
...
\ProblemBnoor{\hypertarget{4O4e13}{4E 4 13}}{
	\TextB{Sups nonconst $p,q\in\PoCi$ have no common zeros. Let $m = \deg p$, $n = \deg q$.\vspace{3pt}}
	\TextB{Define $T:\PoC{n-1}\times\PoC{m-1}\rightarrow\PoC{m+n-1}$ by $T\Par{r, s} = rp + sq.$ Prove $T$ is iso.\vspace{3pt}}
...
\ProblemN{L2:}{
	\TextB{Sups $p\Par{z}=\Par{z-\lambda}{^\alpha}q\Par{z}$ and $\alpha\in\Nbp.$ Prove ${p{^{\SmallPar{\alpha-1}}}}\Par{\lambda}=0.$}
}\par\quad
...
%\TextB{Sups $T\in\Lm{V}.$ Prove every list of eigvecs of $T$ corres to disti eigvals is liney indep.}
%\Solution \Or Another Proof.\TextB{}
%Sups the desired result is false. Then ( $m\neq 1$ becs eigvecs are nonzero )\TextB{}
...
%Sups $a_1 v_1+\dots+a_{m-1}v_{m-1}+a_m v_m=0.$ Then $a_j\neq 0$ for each $j$. ( becs the min of $m$) \TextB{}
...
\ProblemB{
	\TextB{Sups $V$ is finide, $T\in\Lm{V},$ and $U$ is invarsp of $\,V$ under $T.$}
...
\ProblemB[]{
	\TextB{Sups $T\in\Lm{V}$ and $U$ is invarsp of $V$ under $T.$}
	\TextB{Sups $\lambda_1,\dots,\lambda_m$ are the disti eigvals of $T$ corres eigvecs $v_1,\dots,v_m.$}
}
\ProblemB{
...
\ProblemB{
	\TipsN{3}\,\,\TextB{Sups $W$ is a nonzero invarsp of $V$ under $T.$ If $\dim V=m\geqslant 1.$}
...
\ProblemN[]{\hypertarget{5A1}{1}}{
	\TextN{Sups $T\in\Lm{V}$ and $U$ is a subsp of $V$.}
...
\ProblemB{
	\TextB{Sups $S,T\in\Lm{V}$ are suth $ST=TS.$ }
...
\ProblemB[]{
	\TextB{Sups $S,T\in\Lm{V}$ are suth $ST=TS.$\vspace{4pt}}
}
\ProblemN[]{2}{
...
\ProblemB[]{
	\TextB{Sups $T\in\Lm{V}$ and $V_{\!1},\dots,V_{\!m}$ are invarsps of $V$ under $T$.}
}
...
\ProblemN{\hypertarget{5A6}{6}}{
	\TextN{Sups $U$ is invarsp of $V$ under each $T\in\Lm{V}.$ Show $U = \zeroSubs$ or $U = V$.\vspace{4pt}}
}If $V=\zeroSubs.$ Then done. Sups $V\neq\zeroSubs.$ We show the ctrapos:\parSol{}
{\tgsl Sups $U\neq\zeroSubs$ and $U\neq V.$ Prove $\exists\,T\in\Lm{V}$ suth $U$ is not invard $T$.}\parSol{}
Let $W$ be suth $V=U\oplus W.$ Define $T\in\Lm{V}$ by $T\Par{u+w}=w.$\PfEnd
\SepLine

\BulletPointX\Tips\,\,\, {Sups $T\in\Lm{\Rbb^2}$ is the counterclockwise rotation by the angle $\theta\in\Rbb.$}\par\quad
...
{Hence $T\Par{a,b}=\BigPar{a\cos\theta-b\sin\theta,a\sin\theta+b\cos\theta}.$ Now $\Mt{T}=\;${\normalsize$\begin{pmatrix}
		...
		\end{pmatrix}$}.}\vspace{6pt}\par\quad
\Example \,\,\,\OR\ProblemN[]{\hypertarget{5A7}{7}}{ Sups $T\in\Lm{\Rbb^2}$ is defined by $T\Par{x, y} = \Par{-3y, x}.$ Find all eigvals of $T$.\TextN{\vspace{4pt}}}\quad
\NOTICE that $\Mt{T}=\;${\normalsize$\begin{pmatrix}
...
}Sups $\lambda$ is an eigval with an eigvec $\Par{z_1,z_2,z_3}.$\parSol{}
...
\ProblemN{\hypertarget{5A19}{19}}{
	\TextNL{Sups $n\in\Nbp$. Define $T\in\Lm{\Fbb^n}$ by $T\Par{x_1,\dots,x_n}=\Par{x_1+\dots+x_n,\dots,x_1+\dots+x_n}.$}
...
\ProblemN{\hypertarget{5A20}{20}}{
	...
	(a) \TextNL{Show every ele of $\Fbb$ is an eigval of $S;\;\;$ {\tgnr\large(b)} Find all eigvecs of $S$.}
}\par\quad
...
\ProblemB[]{
	\TextB{Sups $V$ is finide, $T\in\Lm{V},\lambda\in\Fbb.$}
}
...
\ProblemBnoor{\hypertarget{5A4e8}{}{5.B.4} \,\OR\, 4E 3.B.27}{
	\TextB{Sups $\lambda$ is an eigval of $P\in\Lm{V},P^2 = P.$ Prove $\lambda = 0$ or $\lambda = 1$.}
}Sups $\lambda$ is an eigval with an eigvec $v.$ Then $P\Par{Pv}=Pv\Rightarrow\lambda^2 v=\lambda v.$ Thus $\lambda=1$ or $0.$\PfEnd
\SepLine

\ProblemN{\hypertarget{5A14}{14}}{
	\TextNL{Sups $V = U\oplus W$, where $U$ and $W$ are nonzero subsps of $V$.}
...
\ProblemN{\hypertarget{5A15}{15}}{
	\TextNL{Sups $T\in\Lm{V}$. Sups $S\in\Lm{V}$ is inv.\vspace{4pt}}
...
Sups $\lambda$ is an eigval of $T$ with an eigvec $\Par{x,y,z,w}.$ Then we get \;{\normalsize$\MathLeftBrace{l}{
...
\ProblemBnoor{\hypertarget{5A4e16}{4E 5.A.16}}{
	\TextB{Sups $B_V=\Par{v_1,\dots,v_n},T\in\Lm{V},\Mt[\BigPar]{T,\Par{v_1,\dots,v_n}}=A.$}
...
\ProblemBnoor{\hypertarget{5A4e15}{4E 5.A.15}}{
	\TextB{Sups $T\in\Lm{V}$, and $\lambda\in\Fbb.$}
...
\ProblemN{\hypertarget{5A24}{24}}{
	\TextNL{Sups $A\in\Fbb^{n,n}.$ Define $T\in\Lm{\Fbb^{n,1}}$ by $Tx = Ax$.}
	(a) \TextNL{Sups the sum of the ent in each row of $A$ equals $1$. Prove $1$ is an eigval of $T$.}
	(b) \TextNL{Sups the sum of the ent in each col of $A$ equals $1$. Prove $1$ is an eigval of $T$.}
}\vspace{-8pt}\par\quad
...
\ProblemB{
	\TextB{Sups $A\in\Fbb^{n,n}.$ Define $T\in\Lm{\Fbb^{1,n}}$ by $Tx = xA.$}
	(a) \TextB{Sups the sum of the ent in each col of $A$ equals $1$. Prove $1$ is an eigval of $T$.}
	(b) \TextB{Sups the sum of the ent in each row of $A$ equals $1$. Prove $1$ is an eigval of $T$.}
}\par\quad
...
\ProblemN{\hypertarget{5A22}{22}}{
	\TextNL{Sups $T\in\Lm{V}$ and $\exists$ nonzero vecs $u,w$ in $V$ suth $Tu = 3w,\;Tw = 3u$.}
...
\ProblemN{\hypertarget{5A23}{23}}{
	\TextNL{Sups $S, T\in\Lm{V}$. Prove $ST$ and $TS$\, have the same eigvals.\vspace{2pt}}
...
\ProblemBnoor{\hypertarget{5A2e20}{2E 20}}{
	\TextB{Sups $T\in\Lm{V}$ has $\dim V$ disti eigvals and $S\in\Lm{V}$ has the same eigvecs}
...
\ProblemN{\hypertarget{5A25}{25}}{
	\TextNL{Sups $T\in\Lm{V}$ and $u, w$ are eigvecs of $T$ suth $u + w$ is also an eigvec of $T$.}
	\TextNL{Prove $u$ and $w$ corres to the same eigval.}
}Sups $\lambda_1,\lambda_2,\lambda_0$ are eigvals of $T$ with eigvecs to $u,w,u+w$ respectly.\parSol{}
...
\ProblemN{\hypertarget{5A26}{26}}{
	\TextNL{Sups $T\in\Lm{V}$ is suth every nonzero vec in $V$ is an eigvec of \,$T$.}
	\TextNL{Prove $T$ is a scalar multi of the id optor.}
}If $\dim V=0,1$ then done. Sups $\dim V\geqslant 2.$\par\quad
...
\ProblemN{\hypertarget{5A27}{27}, \hypertarget{5A28}{28}}{
	\TextNL{Sups $V$ is finide and $k\in\Bra{1, \dots , \dim V - 1}$.}\qquad
	\TextNL{Sups $T\in\Lm{V}$ is suth every subsp of $V$ of dim $k$ is invard $T$.}\qquad
	\TextNL{Prove $T$ is a scalar multi of the id optor.}
}If $\dim V\leqslant 1$ then done. Sups $\dim V\geqslant 2.$\par\quad
...
\ProblemN{\hypertarget{5A29}{29}}{
	\TextNL{Sups $T\in\Lm{V}$ and $\range T$ is finide.}
...
\ProblemN{\hypertarget{5A30}{30}}{
	\TextNL{Sups $T\in\Lm{\Rbb^3}$ and $-4,5,\sqrt{7}$ are eigvals. Prove $\exists\,x,Tx - 9x = \Par{-4, 5, \sqrt{7}}$.}
...
\ProblemN{\hypertarget{5A31}{31}}{
	\TextNL{Sups $V$ is finide, and $v_1,\dots,v_m \in V$. Prove}
...
\ProblemB{
	\TextB{Sups $\lambda_1,\dots,\lambda_n\in\Rbb$ are disti.}
...
\ProblemN{\hypertarget{5A33}{33}}{
	\TextNL{Sups $T\in\Lm{V}.$ Prove $T\XSlash \Par{\range T}=0.$\vspace{2pt}}
...
\ProblemB{
	\hypertarget{5A4e38}{}\TextB{Sups $V$ is finide, $T\in\Lm{V}$, and $U$ is invarsp of $V$ under $T$.}
...
(a) Sups $\lambda$ is an eigval of $T$ with an eigvec $v.$ \Par{ If $\dim V=1,$ then $U=\zeroSubs$ and done. }\par\quad\Ha
...
(b) Sups $U$ is invarsp under $T$ of dim $m=\dim V-1.$ \Par{ If $m=0,$ then done. }\par\quad\Hb
...
\ProblemBnoor{\hypertarget{5A4e33}{4E 5.A.33}}{
	\TextB{Sups $T\in\Lm{V}$ and $\,m\,$ is a positive integer.}
...
\ProblemN{\hypertarget{5BI13}{13}}{
	\TextNL{Sups $V$ is a complex vecsp and $T\in\Lm{V}$ has no eigvals.}
	\TextNL{Prove every subsp of $V$ invard $T$ is either $\zeroSubs$ or infinide.}
}Sups $U$ is a finide nonzero invarsp on $\Cbb.$ Then by [5.21], $T\mmid_U$ has an eigval.\PfEnd
\SepLine
...
\TextB{Sups $V$ is finide and $T\in\Lm{V}$.}
\TextB{Sups $M_T^0=\Bra{p_j}{_{j\in\Gamma}}$ is the set of all monic poly that give 0 whenever $T$ is applied.}
\TextB{Prove $\exists\,!\,p_k\in M_T^0,\deg p_k=\min\!${\large\envFontDefault$\Bra{\deg p_j}{_{j\in\Gamma}}$}$\leqslant\dim V$.}
...
(c) Sups $r$ is the min poly of $T\mmid_U,s$ is the min poly of $T\XSlash U.$\par\quad\Hc
...
\ProblemBnoor{\hypertarget{5BI4e27}{4E 5.B.27}}{
	\TextB{Sups $\Fbb=\Rbb,$ $V$ is finide, and $T\in \Lm{V}$.}
...
\ProblemBnoor{4E 5.32}{
	\TextB{Sups $T\in\Lm{V}$ and $\,p\,$ is the min poly.}
...
\ProblemBnoor{\hypertarget{5BI4e22}{4E 5.B.22}}{
	\TextB{}
	\TextB{Sups $V$ is finide, $T\in \Lm{V}$. Prove $T$ is inv $\Longleftrightarrow I\in\Span{T, T^2, \dots , T^{\dim V}}.$}
...
\ProblemN{\hypertarget{5BI6}{6}}{
	\TextN{Sups $T\in\Lm{V}$ and $U$ is a subsp of $V$ invard $T$.}
...
\ProblemBnoor{\hypertarget{5BI4e10}{4E 5.B.10}, \hypertarget{5BI4e23}{23}}{
	\TextB{Sups $V$ is finide, $T\in \Lm{V}$ and $\,p\,$ is the min poly with deg $\,m.$ Sups $v\in V.$}
...
\ProblemN{\hypertarget{5BI19}{19}}{
	\TextNL{Sups $V$ is finide, $\dim V>1,T\in\Lm{V}.$ Prove $\Bra{\,p\Par{T}:p\in\PoFi}\neq\Lm{V}.$\vspace{2pt}}
...
\ProblemB{
	\hypertarget{5BI4e19}{}\TextB{Sups $V$ is finide and $T\in \Lm{V}$. Let $\mathcal{E} =\Bra{q\Par{T}: q \in \PoFi}$.}
...
\ProblemBnoor{\hypertarget{5BI4e13}{4E 5.B.13}}{
	\TextB{Sups $T\in \Lm{V}$ and $q \in \PoFi$ is defined by}
...
\ProblemBnoor{\hypertarget{5BI4e14}{4E 5.B.14}}{
	\TextB{Sups $V$ is finide, $T\in \Lm{V}$ has min poly $\,p\,$}
...
\TextB{Sups $V$ is a finide complex vecsp and $T\in\Lm{V}.$}
...
\ProblemB[]{
	...
	\TextB{\tgnr Sups $\alpha_1,\dots,\alpha_n$ are all the disti eigvals of $T,$\vspace{2pt}}
...
\ProblemN{\hypertarget{5BI10}{10}}{
	\TextNL{Sups $T\in\Lm{V},\lambda$ is an eigval of $T$ with an eigvec $v.$}
...
\ProblemN{\hypertarget{5BI1}{1}}{
	\TextN{Sups $T\in\Lm{V}$ and $\exists\,n\in\Nbp$ suth $T^n=0.$}
...
\ProblemN{\hypertarget{5BI2}{2}}{
	\TextN{Sups $T\in\Lm{V}$ and $\Par{T - 2I}\Par{T - 3I}\Par{T - 4I} = 0$.}
	\TextN{Sups $\lambda$ is an eigval of $T$. Prove $\lambda = 2$ or $\lambda = 3$ or $\lambda = 4$.}
}\par\quad
...
\ProblemNnoor{\hypertarget{5BI7}{7}}{See \hLk{5A22}{5.A.22}}{
	\TextN{Sups $T\in\Lm{V}$. Prove $9$ is an eigval of $T^2$ $\Longleftrightarrow$ $3$ or $-3$ is an eigval of $T$.}
}\par\quad
(a) Sups $\lambda$ is an eigval of $T$ with an eigvec $v.$\par\quad\Ha
...
\ProblemN{\hypertarget{5BI3}{3}}{
	\TextN{Sups $T\in\Lm{V},T^2=I$ and $-1$ is not an eigval of $T.$ Prove $T=I.$}
}\par\quad
...
\ProblemBnoor{\hypertarget{5A4e32}{4E 5.A.32}}{
	\TextB{Sups $T\in\Lm{V}$ has no eigvals and $T^4 = I$. Prove $T^2=-I$.}
}\par\quad
...
\ProblemBnoor{\hypertarget{5BI4e11}{4E 5.B.11}}{
	\TextB{Sups $V$ is a two-dim vecsp, $T\in\Lm{V}$, and the matrix of $T$}
...
\ProblemB{
	\TextB{Sups $S,T\in\Lm{V},S$ is inv, and $p\in\PoFi$. Prove $Sp\Par{TS}=p\Par{ST}S.$}
}\par\quad
...
\ProblemBnoor{\hypertarget{5BI4e7}{4E 5.B.7}}{
	\TextB{Sups $S, T\in\Lm{V}.$ Let $p,q$ be the min polys of $ST,TS$ respectly.}
...
\ProblemN{\hypertarget{5BI11}{11}}{
	\TextNL{Sups $\Fbb = \Cbb,$ $T\in\Lm{V}, p\in\PoCi$, and $\alpha\in\Cbb.$}
...
\ProblemBnoor{\hypertarget{5BI4e17}{4E 5.B.17}}{
	\TextB{Sups $V$ is finide, $T\in \Lm{V},\lambda\in\Fbb$, and $\,p\,$ is the min poly of $T$.}
...
\ProblemBnoor{\hypertarget{5BI4e18}{4E 5.B.18}}{
	\TextB{Sups $V$ is finide, $T\in \Lm{V},\lambda\in\nonzeroFbb$, and $\,p\,$ is the min poly of $T$.}
...
\ProblemNor{\hypertarget{5BI18}{18}}{\hypertarget{5BI4e15}{4E 5.B.15}}{
	\TextNL{Sups $V$ is a finide complex vecsp with $\dim V > 0$ and $T\in\Lm{V}$.}
...
\ProblemBnoor{\hypertarget{5BI4e9}{4E 5.B.9}}{
	\TextB{Sups $T\in\Lm{V}$ is suth wrto some bss of $V$,}
...
\ProblemBnoor{\OR (\hypertarget{5BI4e16}{4E 5.B.16}), \OR (8.C.18)}[\Sbra]{
	\TextB{Sups $a_0 ,\dots, a_{n-1}\in\Fbb.$ Let $T$ be the optor on $\Fbb^n$ suth\vspace{2pt}}
	\TextB{$\Mt{T}=\,${\normalsize$\begin{pmatrix}
	0 &   &        &  &   & -a_0     \\
	1 & 0 &        &  &   & -a_1     \\
	  & 1 & \ddots &  &   & \vdots   \\
...
\ProblemB{
	...
	\TextB{Sups $\Fbb=\Rbb,$ $V$ is finide, $T\in\Lm{V}$ and $b, c\in\Rbb$ with $b^2 < 4c$.}
...
\ProblemB{
	...
	(a) \TextB{Sups $\Fbb=\Cbb.$ \tgnr\large Then by [5.21], done.}
	(b) \TextB{Sups $\Fbb=\Rbb,$ $V$ is finide, and $\dim V=n$ is an odd number.}
...
\ProblemBnoor{\hypertarget{5BI2e24}{2E Ch5.24}}{
	\TextB{Sups $\Fbb=\Rbb,T\in\Lm{V}$ has no eigvals.} \TextB{Prove every invarsp of $V$ under $T$ is even-dim.}
}\par\quad
...
Sups $p$ is the min poly of deg $m$ and $p\Par{z}=\Par{z-\lambda_1}\cdots\Par{z-\lambda_m}.$\par\quad\Hii
...
\ProblemBnoor{\hypertarget{5BII4e2}{4E 5.C.2}}{
	\TextB{Sups $A$ and $B$ are upper-trig matrices of the same size,}
...
\ProblemBnoor{\hypertarget{5BII4e3}{4E 5.C.3}}{
	\TextB{}
	\TextB{Sups $T\in \Lm{V}$ is inv and $B=\Par{v_1 , \dots , v_n}$ is a bss of $V$ suth}
...
\ProblemNnoor{\hypertarget{5BII9}{9}}{\hypertarget{5BII4e7}{4E 5.C.7}}{
	\TextN{Sups $V$ is finide, $T\in \Lm{V}$, and $v \in V$.}
...
\ProblemBnoor{\hypertarget{5BII4e9}{4E 5.C.9}}{
	\TextB{Sups $B\in\Fbb^{n,n}$ with complex ent.}
...
\ProblemBnoor{\hypertarget{5BII4e10}{4E 5.C.10}}{
	\TextB{Sups $T\in \Lm{V}$ and $\Par{v_1,\dots,v_n}$ is a bss of $V$.}
...
\ProblemBnoor{\hypertarget{5BII4e11}{4E 5.C.11}}{
	\TextB{Sups $\Fbb=\Cbb$ and $V$ is finide.}
...
\ProblemBnoor{\hypertarget{5BII4e12}{4E 5.C.12}}{
	\TextB{}
	\TextB{Sups $V$ is finide, $T\in \Lm{V}$ has an upper-trig matrix wrto some bss,}
...
\ProblemBnoor{\hypertarget{5BII4e13}{4E 5.C.13}}{
	\TextB{Sups $V$ is finide, $T\in \Lm{V}$. Sups $U$ is invarsp of $V$ under $T$}
...
\ProblemN{2}{
	\TextN{Sups $\mathcal{E}$ is a subset of $\Lm{V}$ and every ele of $\mathcal{E}$ is diag.}
...
\ProblemN{3}{
	\TextN{Sups $S, T\in\Lm{V}$ are suth $ST = TS$. Sups $p\in\PoFi$.}
...
\ProblemN{6}{
	\TextN{Sups $V$ is a finide complex vecsp and $S, T\in\Lm{V}$ commu.}
	\TextN{Prove $\exists\,\alpha,\lambda\in\Cbb$ suth $\range\Par{S -\alpha I} + \range\Par{T -\lambda I}\neq V$.}
}\par
\SepLine

\ProblemN{7}{
	\TextN{Sups $V$ is a complex vecsp, $S\in\Lm{V}$ is diag, and $T$ commu with $S$.}
...
\ProblemN{8}{
	\TextN{Sups $m = 3$ in [5.72] and $D_x , D_y$ are the commu partial diff optors on $\Po_3\Par{\Rbb^2}$ from [5.72].}
	\TextN{Find a bss of $\Po_3\Par{\Rbb^2}$ wrto which $D_x$ and $D_y$ each have upper-trig matrix.}
}\par
\SepLine

\ProblemN{9}{
	\TextN{Sups $V$ is a finide nonzero complex vecsp.}
	\TextN{Sups that $\mathcal{E}\subseteq\Lm{V}$ is suth $S$ and $T$ commu for all $S, T\in\mathcal{E}$.}
	(a) \TextN{Prove $\exists$ eigvec $v\in V$ for every ele of $\mathcal{E}$.}
	(b) \TextN{Prove $\exists$ a bss of $V$ wrto which every ele of $\mathcal{E}$ has upper-trig matrix.}
}\par
\SepLine
