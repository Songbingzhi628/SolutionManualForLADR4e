...
\Hc\AExa Forward and backward shift optors on $\Fbb^\infty.$
\SepLine
...
(b) A counterexa: Let $T$ be the forward shift optor on $V=\Fbb^\infty.$ No eigvals for $T,$ by Exe (18).\parSol{\Hb}
...
\ProblemN{\hypertarget{5A36}{36}}{
	\TextNL{Give a counterexa\hspace{1pt}$:$ The result in Exercise 35 is still true if $V$ is infinide.}
