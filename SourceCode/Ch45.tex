...
}Becs $\lambda_k$ on diag on $A$ $\Longleftrightarrow\lambda_k$ eigval of $T$ $\Longleftrightarrow\lambda_k^{-1}$ eigval of $T^{-1}$ $\Longleftrightarrow\lambda_k^{-1}$ on diag of $A^{-1}.$\PfEnd\vspace{2pt}\par\quad
...
(b) Let $p_vs+r=p$ with $\deg r<\deg p_v.$ Becs $p_v\BigPar{T\mmid_{\nullp p_v\SmallPar{T}}}=0=p\BigPar{T\mmid_{\nullp p_v\SmallPar{T}}}=r\BigPar{T\mmid_{\nullp p_v\SmallPar{T}}}.$\parSol{\Hb}
By (a), $p_v$ is the min of $T\mmid_{\nullp p_v\SmallPar{T}}.$ Then $r=0,$ by the min of $\deg p_v.$\PfEnd
\SepLine
...
\Anchor{5BII4e8}\ProblemN{8}{
	\TextA{Supp $V$ is finide, and $v\in V$ is non0 suth $T^2 v + 2Tv = -2v$.}
...
}%Asum $A=\Mt{T,B_V}$ up-trig.\parSol{}
%If $Tv=\lambda v.$ Then $\Par{\lambda^2+2\lambda+2}v=0\Rightarrow\lambda=-1+\i$ or $-1-\i$ on $\Fbb.$\parSol{}
%Othws, the monic $p_v\Par{z}=z^2+2z+2$ is of smallest deg suth $p_v\Par{T}v=0.$\parSol{}
%Then the min of $T$ is a multi of $p_v,$ which has two zeros $-1\pm\i$ on $\Fbb.$\parSol{}
%Thus (b) holds, and the ctrapos of (a) holds.\PfEnd\vspace{2pt}\parSol{}
\SepLine
