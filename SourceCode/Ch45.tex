...
\vfill\ChDecl{Ch5E}{5.E [4E]}{}%\orMode{\hLk{5E1}{1}\;\;\hLk{5E2}{2}\;\;\hLk{5E3}{3}\;\;\hLk{5E4}{4}\;\;\hLk{5E5}{5}\;\;\hLk{5E6}{6}\;\;\hLk{5E7}{7}\;\;\hLk{5E8}{8}\;\;\hLk{5E9}{9}\;\;\hLk{5E10}{10}}{}
\vspace{4pt}
...
}Supp $A,B\in\Fbb^{n,n}$ are matrices of $S,T$ wrto same $B_V=\Par{v_1,\dots,v_n}$ suth $A,B$ commu.\parSol{}
Let $\alpha=A_{n,n},\,\lambda=B_{n,n}.$ Then $\Range\Par{S-\alpha I},\Range\Par{T-\lambda I}\subseteq\Span{v_1,\dots,v_{n-1}}.$\PfEnd
\SepLine
