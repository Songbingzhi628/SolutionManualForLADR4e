...
\Anchor{5BI4e17}\ProblemBnoor{{4E 17}}{
	...
	\TextA{Show $q\Par{z}=p\Par{z+\lambda}$ is min of $\Par{T-\lambda I}.$}
}Let $s$ be min of $\Par{T-\lambda I}.$ Becs $q\Par{T-\lambda I}=p\Par{T}=0\Rightarrow q$ is multi of $s\Rightarrow\deg q=\deg p\geqslant\deg s.$\parSol{}
Becs $\deg s=n$ is the smallest suth $\Par{T-\lambda I}{^n}\in\Span{I,\Par{T-\lambda I},\dots,\Par{T-\lambda I}{^{n-1}}};$\parSol{}
