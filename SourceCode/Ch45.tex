...
\ProblemN{\hypertarget{4O8}{8}}{
	...
	\TextN{Show {\tgnr(a)} $Tp\in\PoRi$ for all $p\in\PoRi$ and that {\tgnr(b)} $T:\PoRi\rightarrow\PoRi$ is liney.}
}\vspace{2pt}\par\quad
...
\ProblemBnoor{\hypertarget{5BI4e7}{4E 5.B.7}}{
	\TextB{Sups $S, T\in\Lm{V}.$ Let $p,q$ be the min polys of $ST,TS$ respectively.}
