...
$c_1\Ang{v_1,u}+\dots+c_{n-1}\Ang{v_{n-1},u}>0,$ while $\Ang{v_n,v_n}=c_1\Ang{v_1,v_n}+\dots+c_{n-1}\Ang{v_{n-1},v_n}\geqslant0.$\parSol{\Hii}
Which means at least one $c_j>0,$ while at least one $c_k<0.$\PfEnd
\SepLine
