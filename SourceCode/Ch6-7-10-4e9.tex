...
Let $M=\sum_{j=1}^n\sum_{k=1}^n\aMidsq{N_{j,k}}.$ We show $\Dvert{N^mx}\leqslant M^m\Dvert{x}$ by induc. (i) $m=1.$ By \Sbra{6.A \TIPS}.\vspace{1pt}\parSol{}
