...
}By Exe (E.16). $T=T^*\Longleftrightarrow T^\dagger=\Par{T^*}{^\dagger}=\Par{T^\dagger}{^*}.$\PfEnd\vspace{2pt}\par\quad
...
Let $v\in V$ suth $\BigDvertsq{\sqrt{S}\,v}=\BigDvertsq{\sqrt{S}\;\!}=\Dvert{S}\Rightarrow\Dvert{S+T}\geqslant\Dvert{S}.$ \;Simlr, $\Dvert{S+T}\geqslant\Dvert{T}.$\vspace{1pt}\parSol{}
...
\Anchor{7F19}\ProblemN{F.19}{
	\TextA{Prove $\Dvert{T^*T}=\Dvertsq{T}$ for $T\in\Lm{V,W}.$\hfill\FontNorm\tgnr By Exe (2), $\Dvert{T^*T}=s_1^2.$}
...
Let $T=S\sqrt{T^*T}\Rightarrow\Dvert{T}\leqslant\Dvert{S}\,\BigDvert{\sqrt{T^*T}\;\!}=\BigDvert{\sqrt{T^*T}\;\!}.$\PfEnd
\SepLine
