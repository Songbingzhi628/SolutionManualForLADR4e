...
By (5.C.5). If $\Fbb=\Rbb.$ Then apply to $T_{\!\Cbb}.$ \;\Or By Exe (17), \Sbra{8.B \TIPSN{4}}.\PfEnd\vspace{3pt}\parSol{}
\Or Supp the min of $T$ is $p\Par{z}=\Par{z-\lambda}{^k}q\Par{z}$ with $k\geqslant1$ and $q\Par{\lambda}\neq0.$\parSol{}
Then $p\Par{T}v=0\Rightarrow q\Par{T}\in\Null\Par{T-\lambda I}{^k}=\Null\Par{T-\lambda}.$\PfEnd
\SepLine
