...
%}$\forall v\in V,\:\BigDvertsq{\sqrt{T^*T}v}=\Ang{T^*Tv,v}=\Dvertsq{Tv}\leqslant\Dvertsq{T}\,\Dvertsq{v}\Rightarrow\BigDvert{\sqrt{T^*T}\;\!}\leqslant\Dvert{T}.$\parSol{}
...
Note that $T^*e_k=\overline{\lambda_k}e_k\Rightarrow T^*Te_k=\aMidsq{\lambda_k}e_k.$ \;Define $S\in\Lm{V}$ by $Se_k=\aMid{\lambda_k}{^{-1}}\lambda_k\:\!e_k.$\PfEnd\vspace{3pt}\parSol{}
