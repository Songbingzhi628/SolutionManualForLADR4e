...
Then $\sum_{j\,\in\,P}c_jv_j=\sum_{k\,\in\,N}-c_kv_k\Longrightarrow 0\leqslant\BigAng{{\sum_{j\,\in\,P}c_jv_j,\:\sum_{k\,\in\,N}-c_kv_k}}=\sum\sum-c_j\:\!c_k\!\:\Ang{v_j,v_k}\leqslant0.$\vspace{3pt}\parSol{}
...
\Anchor{7C20}\ProblemN{20}{
	...
	\TextA{Supp $v_1,\dots,v_n\in V$ and each $\Ang{Te_k,\:\!e_j}=\Ang{v_k,v_j}.$ Prove $T$ posi.\vspace{2pt}}
...
$\forall u=\sum_{i=1}^nx_ie_i,\:v=\sum_{i=1}y_ie_i,\;\Ang{u,v}{_2}=x_1\overline{y_1}+\dots+x_n\overline{y_n}=\Ang{Ru,Rv}{_1}=\Ang{R^*Ru,v}{_1}.$\PfEnd
\SepLine
