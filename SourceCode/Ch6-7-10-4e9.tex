...
\Anchor{4e9DNE6}\ProblemBX[]{\NoteForSmall{Exe (D.6)}}{
	...
	Let $V=\FbbP{m},W=\FbbP{n}.$ We show $R_r$ can be id with $M_r=\Bra{A\in\FbbP{m,n}:\rank A\leqslant r}.$ Id $v\otimes w$ with $vw^t.$\TextB{}
