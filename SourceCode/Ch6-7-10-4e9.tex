...
\ProblemB[]{
	...
	Now $\Dvertsq{v}={}${\Large$\frac{\:\SmallinnerAsq{v,\:e_1}\:}{\SmallDvertsq{e_1}}$}${}+\dots+{}${\Large$\frac{\:\SmallinnerAsq{v,\:e_m}\:}{\SmallDvertsq{e_m}}$}$.$ Replace each $e_k$ with $\Dvert{e_k}{^{\,-1}}e_k,$ now $\Par{e_1,\dots,e_m}$ is a orthon list.\TextB{\vspace{6pt}}
...
\Blind{\Or}(b) $T=\Par{P_U\mmid_U}{^{-1}}TP_U\Rightarrow\range T\mmid_{U^\perp}=\range\Par{P_U\mmid_U}{^{-1}}TP_U\mmid_{U^\perp}=\zeroSubs.$\PfEnd
\SepLine
