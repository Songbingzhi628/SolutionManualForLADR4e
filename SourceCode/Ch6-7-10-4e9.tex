...
\ProblemBnoor{4E 9}{
	\TextA{Supp $\Fbb=\Cbb,T\in\Lm{V}$ is normal. Prove $T^*=p\Par{T}.$\vspace{2pt}}
...
Where $\lambda_1,\dots,\lambda_m$ are disti eigvals of $T\Rightarrow\forall v_k\in E\Par{\lambda_k,T},\,p\Par{T}v_k=p\Par{\lambda_k}v_k=\overline{\lambda_k}v_k=T^*v_k.$\PfEnd
\SepLine
...
Becs each $E\Par{\lambda_k,T}=E\Par{\overline{\lambda_k},T^*}$ invard $S\Rightarrow ST^*e_k=\overline{\lambda_k}Se_k=T^*Se_k.$\PfEnd
\SepLine
