...
\Anchor{7C23}\ProblemN{23}{
	\TextA{Define $\Ang{\cdot,\cdot}{_T}$ by $\Ang{u,v}{_T}=\Ang{Tu,v}$ for $T\in\Lm{V}$ and $u,v\in V.$}
	\TextA{Prove every inner prod on $V$ is of the form $\Ang{\cdot,\cdot}{_T}$ for some posi inv $T.$}
}
\SepLine
