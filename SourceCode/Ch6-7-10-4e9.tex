...
\Anchor{7BNQuo}\ProblemBX[]{\NoteForSmall{[7.28], a quot version}}{
	Supp $V$ finide and self-adj $T\in\Lm{V}$ with $U$ invard $T,$ so is $U^\perp.$\TextB{}
	Define inner prod on $V\XSlash U$ by $\BigAng{v+U, w+U}{_{V\XSlash U}}=\Ang{P_{\!\!\!\:U^\perp}v,P_{\!\!\!\:U^\perp}w}.$\TextB{\vspace{1pt}}
	We show $LHS=\Ang{Tv+U,w+U}{_{V\XSlash U}}=\Ang{v+U,T^*w+U}{_{V\XSlash U}}=RHS,$\TextB{\vspace{1pt}}
	so that $\BigAng{v+U,\BigPar{T\XSlash U}{^*}\Par{w+U}}{_{V\XSlash U}}=LHS=RHS=\BigAng{v+U,\BigPar{T^*\XSlash U}\Par{w+U}}{_{V\XSlash U}}.$\TextB{\vspace{1pt}}
	By (6.C.10), $LHS=\Ang{P_{\!\!\!\:U^\perp}Tv,P_{\!\!\!\:U^\perp}w}=\Ang{TP_{\!\!\!\:U^\perp}v,P_{\!\!\!\:U^\perp}w}=\Ang{P_{\!\!\!\:U^\perp}v,T^*P_{\!\!\!\:U^\perp}w}=\Ang{P_{\!\!\!\:U^\perp}v,P_{\!\!\!\:U^\perp}T^*w}=RHS.$\PfEnd\TextB{}
}\BulletPointX\AComm This avails another approach to [7.29].\vspace{-2pt}\SepLine
...
%\ChDecl{ChExt}{Extra Exes
%}{\quad{\ANote {\FontSmall 以下是来自bilibili的题目。}}}
%
%\vspace{6pt}
%
%\ProblemBnoor{BV1nGJAz6Eju}{
%	\TextB{Supp $V$ finide and $S,T\in\Lm{V}.$ Prove $ST-TS$ nilp.}
%}Let $N=ST-TS\Rightarrow\tr N=\tr N^k=\Tr\Par{STN^{k-1}-TSN^{k-1}}=0$ for each $k\in\Nbp.$\parSol{}
%Let $\lambda_1,\dots,\lambda_n$ be disti eigvals of $N_{\Cbb}.$ Then $\forall k\in\Nbp,\:\!\lambda_1^k+\dots+\lambda_n^k=0.$\,\,由牛顿公式与韦达定理.\PfEnd
%\SepLine
%
%\ProblemBnoor{BV1y3nizVEpL}{
%	\TextB{Supp $V$ finide inner prodsp, and $S,T\in\Lm{V}$ posi. Prove $ST$ diag.}
%}
%\SepLine
%
%
%\ProblemBnoor{BV1y3nizVEBs}{
%	\TextA{Supp $V$ finide inner prodsp, and $S,T\in\Lm{V}$ posi.}
%	\TextA{Prove $\exists$ inv $E\in\Lm{V}$ suth $E^{-1}SE$ and $E^{-1}TE$ diag.}
%}
%\SepLine
...
\Anchor{4e9DNE6}\ProblemBX[]{\NoteForSmall{Exe (D.6)}}{
	...
	Immed by using a bss of the smaller vecsp, $R_N=M_N$ via $v\otimes w=v\:\!w^t.$\par\vspace{3pt}
