...
\ProblemN{\Anchor{1B6}{6}}{
	\TextA{Let $\infty$ and $-\infty$ denote two disti objects, neither of which is in $\Rbb$.}
	\TextA{Define an add and scalar multi on $\Rbb\cup\Bra{\infty, -\infty}$ as you could guess.}
	\TextA{The operations of real numbers is as usual. While for $t\in\Rbb$  define\vspace{6pt}}\hspace{-80pt}
	\TextA{\FontNorm\centerline{
...
\quad\TextA{\FontNorm\tgnr(I) $t + \infty = \infty + t = \infty + \infty = \infty,$}
\quad\TextA{\FontNorm\EndI\tgnr(II) $t + \Par{{-\infty}} = \Par{{-\infty}} + t = \Par{{-\infty}} + \Par{{-\infty}} = -\infty,$}
\quad\TextA{\FontNorm\EndII\tgnr(III) $\infty + \Par{{-\infty}} = \Par{{-\infty}} + \infty = 0$.\vspace{8pt}}
\TextA{With these operations of add and scalar multi, is $\Rbb\cup\Bra{\infty, -\infty}$ a vecsp over $\Rbb$? Explain.}
...
\vfill\ChDecl{Ch1C}{1$\cdot$C}{}%\orMode{\hLk{1C7}{7}\;\;\hLk{1C8}{8}\;\;\hLk{1C9}{9}\;\;\hLk{1C11}{11}\;\;\hLk{1C12}{12}\;\;\hLk{1C13}{13}\;\;\hLk{1C15}{15}\;\;\hLk{1C16}{16}\;\;\hLk{1C17}{17}\;\;\hLk{1C18}{18}\;\;\hLk{1C21}{21}\;\;\hLk{1C23}{23}\;\;\hLk{1C24}{24}}{[2]: 7, 8, 9, 24, 15, 16, 17, 18; [3]: 11, 12, 13; [4]: 21, 23.}
...
\ProblemN{\Anchor{1C7}{7}}{
	\TextA{Give a nonempty $U\subseteq\Rbb^2,$ $U$ is closd taking add invs and add, but is not a subsp of $\Rbb^2.$}
}\BigPar{ $0\in U;\;v\in U\Rightarrow -v\in U.$ And operations on $U$ are the same as $\Rbb^2$. }
Let $U=\Zbb^2$ or $\Qbb^2.$\vspace{-4pt}
\SepLine

\ProblemN{\Anchor{1C8}{8}}{
	\TextA{Give a nonempty $U\subseteq\Rbb^2,$ $U$ is closd scalar multi, but is not a subsp of $\Rbb^2$.}
...
\BulletPointX{ \quad}$\Par{U\cap W}{_\Cbb}\ni u_1+\i u_2=w_1+\i w_2\in U_\Cbb\cap W_\Cbb.$
\SepLine
...
We show $\bigcap_{\alpha\in\Gamma}U_\alpha,$ which equals the set of vecs in each $U_\alpha,$ is a subsp of $V$.\par\vspace{4pt}\,
$\begin{array}{l}$
...
\Anchor{1CN1.45}\BulletPointX\NoteForSmall{[1.45]}\;\;If $\Fbb=\Bra{0,1}.$ Prove if $U+W$ is a direct sum, then $U\cap W=\zeroSubs.$\TextB{}
...
To fix this, {\FontLarge denote the set $\Bra{W_{\hspace{-1pt}1},W_{\hspace{-1pt}2},\cdots}$ by $\mathcal{S}_{\!V} U$,} {\small where each $W_{\!i}\oplus U=V.$} {\normalsize See also in (1.C.23).}
\SepLine
...
\ProblemN{\Anchor{1C13}{13}}{
	\TextA{Prove the union of three subsps of $V$ is a subsp of $V$}
	\TextA{if and only if one of the subsps contains the other two.}
...
(a) Supp one of the subsps contains the other two. Then $\mathcal{U}=U_1,U_2$ or $U_3$ is a subsp of $V.$\par\quad
(b) Supp $U_1\cup U_2\cup U_3$ is a subsp of $V$. \NOTICE that, $U\cup W=V$ is vecsp $\Rightarrow U,W$ are subsps of $V.$\par\quad\Hb
Thus the literal trick is invalid: $\Par{A\cup B}\cup\Par{B\cup C}=\Par{A\cup C}\cup\Par{B\cup C}=\Par{A\cup B}\cup\Par{A\cup C}.$\vspace{2pt}\par\quad\Hb
(I) If any $U_j$ is contained in the union of the other two, say $U_1\subseteq U_2\cup U_3,$ then $\mathcal{U}=U_2\cup U_3.$\par\quad\Hb\HI
By applying Exe (12) we conclude that one $U_j$ contains the other two. Thus done.\vspace{4pt}\par\quad\Hb\EndI
(II) \envFontLarge{Asum no one is contained in the union of other two, and no one contains the other two.}\par\quad\Hb\HII
{\vspace{4pt}Say $U_1\not\subseteq U_2\cup U_3$ and $U_1\not\supseteq U_2\cup U_3.$}\par\quad\Hb
{\Large\vspace{4pt}$\exists\,u\in U_1\wedge u\not\in U_2\cup U_3;\;v\in U_2\cup U_3\wedge v\not\in U_1.$ Let $W=\Bra{v+\lambda u:\lambda\in\Fbb}\,\subseteq\mathcal{U}.$}\par\quad\Hb
{\Large\vspace{4pt}Note that $W\cap U_1=\emptySet,$ for if any $v+\lambda u\in W\cap U_1$ then $v+\lambda u-\lambda u=v\in U_1$.}\par\quad\Hb
{\Large\vspace{4pt}Now $W\subseteq U_1\cup U_2\cup U_3\Rightarrow W\subseteq U_2\cup U_3.$ $\forall v+\lambda u\in W,v+\lambda u\in U_i,i=2,3.$}\par\quad\Hb
{\Large\vspace{4pt}If $U_2\subseteq U_3$ or $U_2\supseteq U_3,$ then $\mathcal{U}=U_1\cup U_i,i=2,3.$} {By Exe (12) done.}\par\quad\Hb
{\Large\vspace{4pt}Othws, {\FontNorm both $U_2,U_3\neq\zeroSubs.$} Becs \tgsl$W\subseteq U_2\cup U_3$ has at least three disti elems.}\par\quad\Hb
{\Large\vspace{4pt}There must be some $U_i$ that contains at least two disti elems of $W.$}\par\quad\Hb
{\Large$\exists\,\lambda_1\neq\lambda_2,\;v+\lambda_1 u$ \,and \,$v+\lambda_2 u$ \,both in $U_2$ or $U_3\Rightarrow u\in U_2\cap U_3,$ ctradic.}\FontNorm\PfEnd\vspace{8pt}\quad
...
\vfill\ChDecl{Ch2B}{2$\cdot$B}{}%\orMode{\hLk{2B1}{1}\;\;\hLk{2B8}{8}\;\;|\;\;\hLk{2B4e5}{4E:\;\;5}\;\;\hLk{2B4e9}{9}\;\;\hLk{2B4e11}{11}}{[1]: 7, 1, (4E 9); [2]: (4E 5), 8, (4E 11).}
...
\ChDecl{Ch2C}{2$\cdot$C}{}%\orMode{\hLk{2C1}{1}\;\;\hLk{2C7}{7}\;\;\hLk{2C9}{9}\;\;\hLk{2C10}{10}\;\;\hLk{2C14}{14,16}\;\;\hLk{2C15}{15}\;\;\hLk{2C17}{17}\;\;|\;\;\hLk{2C4e10}{4E:\;\;10}\;\;\hLk{2C4e14}{14,15}\;\;\hLk{2C4e16}{16}}{[1]: 15; [2]: 1, 7, 9, (4E 16); [3]: 10; [4]: (4E 10), 14, 16; [5]: 17, (4E 14, 15).}
...
Now $\dim\!\Par{V_{\!1}+\dots+V_{\!m}}=\dim\Span[\BigPar]{\mathcal{E}_1\cup\cdots\cup \mathcal{E}_m}\leqslant\Card\BigPar{\mathcal{E}_1\cup\cdots\cup \mathcal{E}_m}\leqslant\card \mathcal{E}_1+\cdots+\card \mathcal{E}_m.$\par\vspace{2pt}\Anchor{2C16}
...
$\Longleftrightarrow\dim\Span[\BigPar]{\mathcal{E}_1\cup\dots\cup\mathcal{E}_m}=\Card\BigPar{\mathcal{E}_1\cup\dots\cup\mathcal{E}_m}=\card\mathcal{E}_1+\dots+\card\mathcal{E}_m$\parCor
$\Longleftrightarrow \dim\!\Par{V_{\!1}\oplus\dots\oplus V_{\!m}}=\dim V_{\!1}+\dots+\dim V_{\!m}.$\PfEnd
\SepLine\pagebreak

\ProblemN{\Anchor{2C17}{17}}{
	\TextA{Supp $V_{\!1},V_{\!2},V_{\!3}$ are subsps of a finide vecsp, then}
	\TextA{{\FontNorm$\Dim\Par{V_{\!1}+V_{\!2}+V_{\!3}}=\dim V_{\!1}+\dim V_{\!2}+\dim V_{\!3}$\par\rightline{${}-\Dim\Par{V_{\!1}\cap V_{\!2}}-\Dim\Par{V_{\!1}\cap V_{\!3}}-\Dim\Par{V_{\!2}\cap V_{\!3}}+\Dim\Par{V_{\!1}\cap V_{\!2}\cap V_{\!3}}$.\qquad}}}
	\TextA{Explain why you might think and prove the formula above or give a countexa.}
}\par\quad
...
\ChDecl{Ch3A}{3$\cdot$A}{}%\orMode{\hLk{3A3}{3}\;\;\hLk{3A4}{4}\;\;\hLk{3A5}{5}\;\;\hLk{3A7}{7}\;\;\hLk{3A8}{8}\;\;\hLk{3A10}{10}\;\;\hLk{3A11}{11}\;\;\hLk{3A12}{12}\;\;\hLk{3A13}{13}\;\;|\;\;\hLk{3A4e10}{4E:\;\;10}\;\;\hLk{3A4e11}{11}\;\;\hLk{3A4e17}{17}}{[1]: \BigPar{4E 3.B.33(a)}, (4E 1.B.7); [2]: 5, 3, 4, 7, 8, 9, (4E 10), 10; [3]: 11, 12, 13, (4E 17); [4]: (4E 3.B.32), (4E 11).}
...
\Anchor{3ANR}\ProblemB[]{
	...
	\PrePa\TextB{$\forall S,T\in\Lm{V,W},\lambda\in\Fbb,\left.\Par{T+\lambda S}\right|{_U}=T\mmid_U+\lambda S\mmid_U.$\vspace{2pt}}
	\PrePb\TextB{$\forall S\in\Lm{W,X},T\in\Lm{V,W},\left.\Par{ST}\right|{_U}=ST\mmid_U.$\vspace{-2pt}}
}\SepLine

\ProblemN{\Anchor{3A3}{3}}{
	\TextA{Supp $T\in\Lm{\Fbb^n,\Fbb^m}$. Prove $\exists\,A_{j,k}\in\Fbb\,$suth for any $\Par{x_1,\dots,x_n}\in\Fbb^n,$}\hspace{-40pt}
	\TextA{\centerline{ $T\Par{x_1,\dots,x_n}={}$\large$\MathLeftrightPare{l}{\!\!
	A_{1,1}x_1+\dots+A_{1,n}x_n,\\[-4pt]
	\!\!\Blind{A}\!\vdots\Blind{_{1}x_1+}\,\ddots\Blind{+A}\vdots\\[-6pt]
	\!\!A_{m,1}x_1+\dots+A_{m,n}x_n\!\!\!}$}\vspace{-6pt}}
}\par\quad
...
}Let $u$ be a non0 vec in $V\Rightarrow V=\Span{u}$. Becs $Tu\in V\Rightarrow Tu=\lambda u$ for some $\lambda$.\parSol{}
...
}{If $\mathcal{E}=\zeroSubs$, then done. Supp $0\neq S\in\mathcal{E},$ a two-sided ideal of $\Lm{V}$. Let $B_V=\Par{v_1,\dots,v_n}.$}\par\quad
Define $R_{x,y}\in\Lm{V}:\,v_x\mapsto v_y,\;v_z\mapsto 0\,\Par{z\neq x}$. \Or {$R_{x,y}v_z=\delta_{z,x}v_y$}. Asum each $R_{x,y}\in\mathcal{E}$.\par\quad
Then $\BigPar{R_{1,1}+\dots+R_{n,n}}v_j=v_j\Rightarrow\sum_{r=1}^n R_{r,r}=I\Rightarrow\Lm{V}\ni T=I\circ T=T\circ I\in\mathcal{E}.$\par\quad
\Or Let each $Tv_j=w_j=A_{1,j}v_1+\dots+A_{n,j}v_n\Rightarrow T=\sum_{x=1}^n\sum_{y=1}^nA_{y,x}R_{x,y}\in\mathcal{E}.$  Now we prove the asum.\vspace{2pt}\par\quad
...
Thus \,$R_{k,y}SR_{x,i}=a_k R_{x,y}$. \,Now $S\in\mathcal{E}\Rightarrow R_{k,y}S\in\mathcal{E}\Rightarrow R_{x,y}\in\mathcal{E}.$\PfEnd\vspace{3pt}
...
}Using notas in (4E 17). Using the result in {\NOTEFOR} [3.60].\parSol{\vspace{2pt}}
...
\vfill\Anchor{3A4e11}\ProblemB{
	\TextB{Supp $V$ is finide, $T\in\Lm{V}$ is suth $\forall S\in\Lm{V},ST=TS$. Prove $\exists\,\lambda\in\Fbb,T=\lambda I$.}
...
\Or \;{\vspace{6pt}Define {\Large$S_k\BigBigPar{{\sum_{i=1}^n a_i v_i}}=a_k v_k$}. Then {\Large$S_kv=v\Longleftrightarrow\exists\,!\,a_k\in\Fbb,v=a_kv_k$}.}\par\quad
...
\Anchor{3AT3}\ProblemBX[]{\TipsN{3}}{
	$T\in\Lm{V,W}\Longleftrightarrow T\in\Lm{V,\range T}\Longleftrightarrow T\in\Lm{V,U},$ if $\range T$ is a subsp of $U.$\TextA{}
	\ACoro $\Bra{T\in\Lm{V,W}:\range T\subseteq U}=\Bra{T\in\Lm{V,U}}=\Lm{V,U},$ a subsp of $\Lm{V,W}.$\TextA{\vspace{-2pt}}
}\SepLine
...
}$S_1S_2\cdots S_nv=0\Rightarrow S_1S_2\cdots S_{n-1}v=0\Rightarrow\cdots\Rightarrow S_1v=0\Rightarrow v=0.$\PfEnd
\SepLine
...
\Or Becs $\dim V=\dim\null P+\dim\range P=\Dim\BigPar{\null P\oplus\range P}.$\PfEnd{\vspace{3pt}}\quad
...
\Anchor{3BT5}\ProblemBX[]{\TipsN{5}}{
	Supp $S\in\Lm{U,V}$ is surj. Define $\mathcal{B}\in\Lm[\BigPar]{\Lm{V,W},\Lm{U,W}}$ by $\mathcal{B}\Par{T}=TS.$\TextA{}
	Then $\mathcal{B}$ is inje. Becs {$\mathcal{B}\Par{T}=TS=0\Longleftrightarrow T\mmid_{\range S}=0.$ \;\Or $\range TS=\range T=\zeroSubs.$}\TextA{\vspace{-3pt}}
}
...
\Anchor{3CNCRFact}\ProblemB{
	...
	\PrePa\TextB{Supp $S_c=\Span[\BigPar]{A_{\cdot,1},\cdots,A_{\cdot,n}}\subseteq\Fbb^{m,1},\dim S_c=c,\text{ the col rank}.$ Let $p=c.$\vspace{3pt}}
	\PrePb\TextB{Supp $S_r=\Span[\BigPar]{A_{1,\cdot},\cdots,A_{m,\cdot}}\subseteq\Fbb^{1,n},\dim S_r=r,\text{ the row rank}.$ Let $p=r.$\vspace{3pt}}
...
\Anchor{3CNCrankEqRrank}\BulletPointX\textsc{Column Rank Equals Row Rank}\quad Using nota and result above.\TextB{}
...
\Anchor{3CT1}\ProblemBX{\TipsN{1}}{
	...
	{\tgsl Let $L=\BigPar{Tv_{\alpha_1},\dots,Tv_{\alpha_k}},\;L_{\mathcal{M}}=\BigPar{A_{\cdot,\alpha_1},\cdots,A_{\cdot,\alpha_k}},$ where each $\alpha_i\in\Bra{1,\dots,n}.$}\TextA{\vspace{1pt}}
	\PrePa\TextA{Show [P] $L$ is liney indep $\Longleftrightarrow L_{\mathcal{M}}$ is liney indep. [Q]\vspace{2pt}}
	\PrePb\TextA{Show [P] $\spn L=W\Longleftrightarrow\spn L_{\mathcal{M}}=\Fbb^{m,1}.$ [Q]\hfill\FontNorm\Sbra{ Let $A=\Mt{T,B_V,B_W}.$\hspace{1pt}}\vspace{3pt}}
...
\ANote Let $L=\BigPar{Tv_1,\dots,Tv_n},\;L_{\mathcal{M}}=\BigPar{A_{\cdot,1},\cdots,A_{\cdot,n}}.$\parNot
Then (a*) By \Sbra{3.B.9, \TIPSN{4}}, $T$ is inje $\Longleftrightarrow L$ is liney indep, so is $L_{\mathcal{M}}$.\parNot
And (b*) $T$ is surj $\Longleftrightarrow\spn L=W\Longleftrightarrow\spn L_{\mathcal{M}}=\Fbb^{m,1}.$\Anchor{3C4e17}\parNot
...
(b) By Exe (9), if all $V_k$ finide and iso to each other, then $S_m\circ\cdots\circ S_1$ inje $\Rightarrow$ inv, so are all $S_k.$\TextB{}
...
Supp each $W_k=V_{\!k+1},$ for if $W_k\subsetneq V_{\!k+1},$ then $S_1,S_2$ surj $\notRightarrow S_2\circ S_1\in\Lm{V_1,W_2}$ surj.\TextB{}
(d) Each $S_k$ surj $\Rightarrow S_m\circ\cdots\circ S_1$ surj. Convly not true unless all $V_k$ finide and iso to each other.\TextB{}
...
\Anchor{3DT3}\ProblemBX[]{\Tips}{
	...
	That is, to declare $B_U,B_V,B_W,\;\mathcal{M}\!:\Lm{V,W}\mapsto\Fbb^{m,n},$ or $\mathcal{M}\!:v\mapsto\Fbb^{n,1}.$\TextA{}
...
$\Mt{T,\alpha\rightarrow\alpha}=\Mt{I,\alpha\rightarrow\beta}{^{-1}}\XPar{\underbrace{\Mt{T,\beta\rightarrow\beta}\Mt{ I,\alpha\rightarrow\beta}}_{\envFontSmall[\footnotesize]=\;\Mt{T,\,\alpha\rightarrow\beta}}}=\Mt{I,\beta\rightarrow\alpha}.$\PfEnd\vspace{-4pt}\quad
\AComm Let $A\apostrophe=\Mt{T,\beta\rightarrow\beta}.$\par\quad
...
{Define $E_{i,j}\in\Lm{V,W}$ by $E_{i,j}\Par{v_x}=\delta_{i,x} w_j.$} \quad\ACoro {$E_{l,k}E_{i,j}=\delta_{j,l}E_{i,k}.$}\TextB{}
Denote $\Mt{E_{i,j}}$ by $\mathcal{E}^{\SmallPar[1pt]{j,i}}.$ And $\BigPar{\mathcal{E}^{\SmallPar[1pt]{j,i}}}{_{l,k}}=\MathLeftBrace{l}{1,\;\;\text{if }\Par{i,j}=\Par{l,k};\\0,\hfill\text{othws.}}$\TextB{\vspace{0pt}}
\hspace{-5pt}$\hText{$
Becs $\mathcal{M}\!:\Lm{V,W}\rightarrow\Fbb^{m,n}$ is iso.$\\$
$E_{i,j}=\Mneg\mathcal{E}^{\SmallPar[1pt]{j,i}}.$ \,By [2.42] and [3.61],$\\[2pt]\,}$\quad
...
$B_{\Lm[\SmallPar]{V,W}}={}${\normalsize${\begin{pmatrix} \underset{\;,}{E_{1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!,}{E_{n,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt] \overset{\;,}{E_{1,m}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{E_{n,m}}\end{pmatrix}}$}$;\quad B_{\,\Fbb^{m,n}}={}${\normalsize$\envFontSmall[\scriptsize]{\begin{pmatrix} \underset{\;,}{\mathcal{E}^{\Par{1,1}}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!\!,}{\mathcal{E}^{\Par{1,n}}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt]\overset{\;,}{\mathcal{E}^{\Par{m,1}}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{\mathcal{E}^{\Par{m,n}}}\end{pmatrix}}$}.\par\vspace{4pt}
...
Extend to $B_W=\BigPar{w_1,\dots,w_p,\dots,w_m}.$ Then $T=E_{1,1}+\dots+E_{p,p},\;\Mt{T}=\mathcal{E}^{\SmallPar[1pt]{1,1}}+\dots+\mathcal{E}^{\SmallPar[1pt]{p,p}}.$\vspace{-4pt}
\SepLine

\ProblemN{\Anchor{3D17}{17}}{
	\TextA{Supp $V$ is finide. Show the only two-sided ideals of $\Lm{V}$ are $\zeroSubs$ and $\Lm{V}$.}
}If $\mathcal{E}=\zeroSubs,$ then done. Supp $0\neq T\in\mathcal{E},$ a two-sided ideal of $\Lm{V}.$ Let $w=Tv\neq 0.$\parSol{}
Extend $v=v_1$ to $B_V=\Par{v_1,\dots,v_n}\Rightarrow Tv_1=a_1v_1+\dots+a_nv_n.$ Supp $a_k\neq 0.$\parSol{}
Then each $E_{k,y}TE_{x,1}=E_{k,y}\Sbra{a_1E_{x,1}+\dots+a_kE_{x,k}+\dots+a_nE_{k,n}}=a_kE_{x,y}\in\mathcal{E}.$\PfEnd
\SepLine

\pagebreak

\Anchor{3D4e17}\ProblemBnoor{4E 17}{
	\TextB{Supp $V$ is finide and $S\in\Lm{V}$. Define $\mathcal{A}\in \Lm[\BigPar]{\Lm{V}}$ by $\mathcal{A}\Par{T} = ST$.}
	\PrePa\TextB{Show $\dim\null \mathcal{A} = \Par{\!\dim V}\Par{\!\dim \null S}$.}
	\PrePb\TextB{Show $\dim\range \mathcal{A} = \Par{\!\dim V}\Par{\!\dim \range S}$.}
...
\Mt[\BigPar]{\mathcal{A},R\rightarrow Q}\Mt{T,R}=\Mt[\BigBigPar]{\!\mathcal{A}\Par{T},Q}=}{\small\begin{pmatrix}
A_{1,1} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{1,m} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{1,n}\\[-2pt]
\vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt]
A_{m,1} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{m,m} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{m,n}\\[-2pt]
\vdots  &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots  &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt]
...
\Anchor{3D4e10}\ProblemBnoor{4E 10}{
	\TextB{Supp $V,W$ are finide, $U$ is a subsp of $V$.\vspace{3pt}}
	\TextB{Let $\mathcal{E} = \Bra{T\in\Lm{V,W}: U\subseteq\null T}=\Bra{T\in\Lm{V,W}:T\mmid_U=0}$.\vspace{2pt}}
	\PrePa\TextB{Show $\mathcal{E}$ is a subsp of $\Lm{V,W}$.\vspace{1pt}}
	\PrePb\TextB{Find a formula for $\dim \mathcal{E}$ in terms of $\dim V$, $\dim W$ and $\dim U$.\vspace{1pt}}\hspace{0.3pt}
...
\Anchor{3D'3}\ProblemB{
	\TextB{Define $\mathcal{B}\in\Lm[\BigPar]{\Lm{V}}$ by $\mathcal{B}\Par{T}=TS.$\vspace{2pt}}
	\PrePa\TextB{Show $\dim\null\mathcal{B}=\Par{\!\dim V}\Par{\!\dim\null S}.$}
	\PrePb\TextB{Show $\dim\range\mathcal{B}=\Par{\!\dim V}\Par{\!\dim\range S}.$}
}(a) {$\forall T\in\Lm{V},TS=0\Longleftrightarrow\range S\subseteq\null T.$}\parSol{\Ha}
...
\Anchor{3EN3.88}\BulletPointX\NoteForSmall{[3.88]}\;\;If $U,V$ are subsp of some vecsp $\mathcal{V}$. Define the quot map $\pi\in\Lm{V,V\XSlash U}.$\TextB{}
...
\ProblemN{\Anchor{3E18}{18}}{
	\TextA{Supp $T\in\Lm{V,W}$ and $U,V$ are subsps of $\mathcal{V}.$ Let $\pi:V\rightarrow V\XSlash U$ be the quot map.}
...
}A countexa: Let $\mathcal{V}=\mathcal{W}=\Fbb^2.$ Let $U=X=Y=\Span{e_1},W=\Span{e_2}.$\parSol{}
...
%{\FontSmall Let $B_{\range\mathcal{T}}=\Par{\varphi_1,\dots,\varphi_p}$ with each $\varphi_k=\mathcal{T}\psi_k. $ Let $B_{V\apostrophe}=\Par{\varphi_1,\dots,\varphi_p,\gamma_1,\dots,\gamma_q}\Rightarrow B_V=\Par{v_1,\dots,v_p,u_1,\dots,u_q}.$}\vspace{-3pt}\TextB{}
%{\FontSmall Let $B_{\null\mathcal{T}}=\Par{\beta_1,\dots,\beta_l}\Rightarrow B_{W\apostrophe}=\Par{\psi_1,\dots,\psi_p,\beta_1,\dots,\beta_r}\Rightarrow B_W=\Par{w_1,\dots,w_p,x_1,\dots,x_r}.$}\TextB{}
%Let $A^t=\Mt[\BigPar]{\mathcal{T},B_{W\apostrophe},B_{V\apostrophe}}.$ Then $A^t_{i,j}=0,A^t_{k,k}=1$ for all $i\neq j$ and each $1\leqslant k\leqslant p.$\TextB{}
%Define $T$ with each $Tv_i=w_i$ and each $Tu_j=0.$ Then each $T\apostrophe\Par{\beta_k}=0=\mathcal{T}\beta_k.$\TextB{}
%And each $\Sbra{T\apostrophe\Par{\psi_j}}\Par{v}=\psi_j\Par{a_1w_1+\dots+a_pw_p}=a_j=\varphi_j\Par{v}={\mathcal{T}\psi_j}\Par{v}.$ \;Now by Exe (16).\vspace{4pt}\TextB{}
...
$\Lm{V,W}\ni T=\sum_{j=1}^n\sum_{k=1}^mA_{k,j}E_{j,k}\Longleftrightarrow\mathcal{T}=\sum_{j=1}^n\sum_{k=1}^mA_{k,j}\reflectbox{\textit{E}}{_{k,j}}\in\Lm{W\apostrophe,V\apostrophe}.$ Uniqly by Exe (16).
\SepLine
...
\Anchor{3F13}\ProblemN[]{13}{
	...
	\PrePb\TextA{Write $T\apostrophe\Par{\varphi_1}$ and $T\apostrophe\Par{\varphi_2}$ as liney combinations of $\psi_1,\psi_2,\psi_3$.}
...
\Anchor{2A16}\ProblemBnoor{2.A.16}{
	\TextA{Prove the vecsp of all continuous functions in $\Rbb^{[0,1]}$ is infinide.}
...
Then $\Mt[\BigBigPar]{\xi_k,\Par{1,z,\dots,z^m},\Par{1}}=\mathcal{E}^{\SmallPar[1pt]{1,k}}\in\Fbb^{1,m+1}.$\vspace{-2pt}
\SepLine\pagebreak
...
\Anchor{3E'2}\ProblemB{
	...
	\TextB{Prove if $W\in\mathcal{S}_V U,$ then $\dim W=m.$\hfill{\large\tgsc Hint$:$ }{\FontNorm Find an iso from $V\XSlash U$ onto $\Rbb^m.$}}
...
\AExa By [2.C.10], $B_m=\BigPar{1,7x-5,\dots,\Par{7x-5}{^m}}$ is a bss of $\PoR{m}$. Let each $\varphi_k={}${\Large\envFontSmall[\footnotesize]$\frac{p^{\SmallPar{k}}\Par{5\text{\large/}\hspace{0.5pt}7}}{7\hspace{1pt}\cdot\,k!}$}.\par\vspace{2pt}
\SepLine
\ChEnd
...
%\NOTICE that if $\dim V<5,$ then no countexa exists.\parSol{}
%Let $T\in\Lm{\Rbb^6}$ with no eigvals will do. By (4E 5.B.29), $T$ has invarsp of dim $2,$ not of dim $4.$\PfEnd
\SepLine
...
}Becs $V=E_1\oplus\cdots\oplus E_m\Rightarrow\forall v\in U,v=c_1v_1+\dots+c_mv_m,$ uniqly.\parSol{}
$c_j\neq 0\Rightarrow c_jv_j$ eigvec corres $\lambda_j.$ Or \,$c_k=0\Rightarrow c_kv_k=0\in U.$\parSol{}
By \TIPSN{1}, each $c_jv_j\in U.$ Thus $v\in\Par{U\cap E_1}\oplus\dots\oplus\Par{U\cap E_m}\supseteq U.$\PfEnd\vspace{2pt}
...
\ANote $U$ might not be in $\mathcal{S}_V\Span{v}.$\vspace{3pt}\parSol{}
...
}Define $q\Par{z}=z^m+{}${\Large$\frac{a_1}{a_0}$}$\,z^{m-1}+\dots+{}${\Large$\frac{a_{m-1}}{a_0}$}$\,z+{}${\Large$\frac{1}{a_0}$}$\Rightarrow q\Par{T^{-1}}=T^{-m}p\Par{T}=0.$\parSol{}
Becs $\deg s\leqslant\deg q,$ while $\Par{T^{-1}}{^{-1}}=T\Rightarrow\deg q\leqslant\deg s.$\PfEnd\vspace{2pt}\parSol{}
...
$\Rightarrow$ each $T^{m+k}=T^k\Par{T^m}\in U\Rightarrow\mathcal{E}=\Span[\BigPar]{I,T,\dots,T^{\dim\Lm[\SmallPar]{V}-1}}=\Span[\BigPar]{I,T,\dots,T^{m-1}}=U.$\PfEnd\vspace{2pt}\parSol{}
...
\vfill\ChDecl{Ch5BII}{5.B: II}{\qquad{\small\textbf{注意\,:}\;这一节的题号使用第四版5.C节}}%\orMode{\hLk{5BII9}{9}\;\;\hLk{5BII14}{14}\;\;\hLk{5BII15}{15}\;\;\hLk{5BII20}{20}\;\;|\;\;\hLk{5BII4e1}{4E: 1,}\;\;\hLk{5BII4e2}{2,}\;\;\hLk{5BII4e3}{3,}\;\;\hLk{5BII4e4}{4,}\;\;\hLk{5BII4e5}{5,}\;\;\hLk{5BII4e6}{6,}\;\;\hLk{5BII4e7}{7,}\;\;\hLk{5BII4e8}{8,}\;\;\hLk{5BII4e9}{9,}\;\;\hLk{5BII4e10}{10}\;\;\hLk{5BII4e11}{11,}\;\;\hLk{5BII4e12}{12,}\;\;\hLk{5BII4e13}{13,}\;\;\hLk{5BII4e14}{14}}{[1]: ; [2]: ; [3]: .}
...
}(i) $\dim V=1.$ Immed. (ii) $\dim V>1.$ Asum the result holds for vecsp of smaller dim.\parSol{}
...
\Anchor{5C4e15}\ProblemN[]{15}{
	\TextA{Supp $\Fbb=\Cbb,$ $V$ is finide, $T\in\Lm{V}$ with the min $p.$ Then\hfill\tgnr\FontSmall Using Exe (4.6).}
	\TextA{$T$ diag $\Longleftrightarrow\nexists\,\Par{z-\lambda}{^2}$ in $p\Longleftrightarrow p,p\apostrophe$ have no common zeros $\Longleftrightarrow\gcd\Par{p,p\apostrophe}=1.$\vspace{-3pt}}
}\SepLine

\Anchor{5C4e16}\ProblemN{16}{
	\TextB{Supp $T\in\Lm{V}$ diag. Let $\lambda_1,\dots,\lambda_m$ be the disti eigvals of $T.$}
	\TextB{Prove $U$ invarspd $T\Rightarrow\exists$ subsp $U_k\subseteq E\Par{\lambda_k,T}$ suth $U=U_1\oplus\cdots U_m.$}
}Let each $U_k=U\cap E\Par{\lambda_k,T}.$ Becs $\forall u\in U,\exists\,!\,v_k\in E\Par{\lambda_j,T},\,u=v_1+\dots+v_m.$\parSol{}
Now by \Sbra{5.A \TIPSN{1}}, each $v_k\in U_j\Rightarrow u\in U_1\oplus\cdots\oplus U_m.$\PfEnd
\SepLine
...
By \Sbra{5.A \TIPSN{3}}, $B_U=\Par{v_{k_1},\dots,v_{k_m}}.$ Let $\Par{v_{k_1},\dots,v_{k_m},w_{j_1},\dots,w_{j_p}}=\Par{v_1,\dots,v_n}.$\parSol{}
Let $B_{V\XSlash U}=\Par{w_{j_1}+U,\dots,w_{j_p}+U}.$ Becs each $\BigPar{T\XSlash U}\Par{w_{j_i}+U}=\lambda_{j_i}\Par{w_{j_i}+U}.$\PfEnd\vspace{3pt}\parSol{}
\Or Becs the min of $T$ is multi of that of $T\XSlash U.$ By [4E 5.62].\PfEnd
\SepLine

\Anchor{5C4e19}\ProblemN{19}{
...
}Supp $A,C\in\Fbb^{n,n}$ are matrices of $S,T$ wrto same $B_V=\Par{v_1,\dots,v_n}$ suth $A,C$ commu.\parSol{}
...
Hence each $B_{E_k}$ consists of eigvecs of all $T.$ Forming $B_V.$\PfEnd\vspace{6pt}\parSol{}
\parSol{}
\SepLine\pagebreak
