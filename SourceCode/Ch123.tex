...
(b) $Tv=\sum_{i=1}^n a_i Tv_i\Longleftrightarrow v-\sum_{i=1}^n a_i v_i\in\null T\Longleftrightarrow v=\BigBigPar{v-\sum_{i=1}^n a_i v_i}+\BigBigPar{\sum_{i=1}^n a_i v_i}.$\par\vspace{2pt}\IndentB{}\Hb{}
...
Now $p\Par{T_1,\dots,T_n}=p\Par{T_{\alpha_1},\dots,T_{\alpha_n}}\Longleftrightarrow p\BigBigPar{{\Mt{T_1},\dots,\Mt{T_n}}}=p\BigBigPar{{\Mt{T_{\alpha_1}},\dots,\Mt{T_{\alpha_n}}}}.$\SepLine
...
\ProblemBnoor{\hypertarget{5A33}{5.A.33}}{
	\TextB{Supp $T\in\Lm{V}.$ Prove $T\XSlash{\range T}=0.$}
}$v+\range T\in V\XSlash \range T\Rightarrow v+\range T\in\null\Par{T\XSlash{\range T}}.$ Thus $T\XSlash{\range T}=0.$\PfEnd
\SepLine
