...
\vfill\ChDecl{Ch3A}{3$\cdot$A}{}\orMode{\hLk{3A3}{3}\;\;\hLk{3A4}{4}\;\;\hLk{3A5}{5}\;\;\hLk{3A7}{7}\;\;\hLk{3A8}{8}\;\;\hLk{3A10}{10}\;\;\hLk{3A11}{11}\;\;\hLk{3A12}{12}\;\;\hLk{3A13}{13}\;\;|\;\;\hLk{3A4e10}{4E:\;\;10}\;\;\hLk{3A4e11}{11}\;\;\hLk{3A4e17}{17}}{[1]: (4E 1.B.7), 5; [2]: 3, 4, 7, 8, 9, (4E 10), 10, 11, 12; [3]: 13, (4E 17), (4E 3.B.32); [4]: (4E 11).}
...
\ProblemBnoor{9.A.2, \OR 4E 3.B.33(a)}{
	\TextB{Suppose $V,W$ are on $\Rbb,$ and $T\in\Lm{V,W}.$ Prove that $T_\Cbb\in\Lm{V_\Cbb,W_\Cbb}.$}
}$T_\Cbb\BigPar{\Par{u_1+\i v_1}+\Par{x+\i y}\Par{u_2+\i v_2}}=T\Par{u_1+xu_2-yv_2}+\i T\Par{v_1+xv_2+yu_2}$\parSol{}
$=T_\Cbb\Par{u_1+\i v_1}+\Par{x+\i y}T_\Cbb\Par{u_2+\i v_2}.$\PfEnd
\SepLine
...
\ProblemN[]{\hypertarget{3B11}{11}}{
	...
	(a) \TextNL{$\range S_1\supseteq\range\Par{S_1S_2}\supseteq\cdots\supseteq\range\Par{S};$\vspace{2pt}}
	(b) \TextNL{$\null S_n\subseteq \null\Par{S_{n-1}S_n}\subseteq\cdots\subseteq\null\Par{S}.$\vspace{2pt}}
...
}Let $B_V=\Par{v_1,v_2,v_3}.$ Counterexamples:\par\quad
\!$\hMath{l}{\left.}{\right.}{$(a) Let $\\\,}\hMath{l}{\left.}{\right.}{S:v_1\mapsto 0;\;\;v_2\mapsto 0;\;\;v_3\mapsto v_2.\\T:v_1\mapsto 0;\;\;v_2\mapsto 0;\;\;v_3\mapsto v_3.}\hMath{l}{\left.}{\right.}{$
	\,\;\;Then $\null S=\null T,$ but$\\$
	$\,\;\;\range T=\Span{v_3}\nsubseteq\Span{v_2}=\null T.}$\par\quad
\!$\hMath{l}{\left.}{\right.}{$(b) Let $\\\,}\hMath{l}{\left.}{\right.}{S:v_1\mapsto v_2;\;\;v_2\mapsto v_2;\;\;v_3\mapsto v_2.\\T:v_1\mapsto 0;\;\;v_2\mapsto 0;\;\;v_3\mapsto v_2.}\hMath{l}{\left.}{\right.}{$
...
(b) \Sbra[3pt]{{\tgsl Req $\range T$ \OR $V$ Finite-dim}} \;Let $B_{\range T}=\Par{Tv_1,\dots,Tv_n}.$\par\quad\Hb
...
(c) \Sbra[3pt]{{\tgsl Req $V$ Finite-dim}} \;Let $B_{\range S}=B_{V}=\Par{Sw_1,\dots,Sw_n}.$ Then $\Span{w_1,\dots,w_n}\oplus\null S=W.$\par\quad\Hc
...
\ProblemB{
	...
	%\vspace{4pt}(c) \TextB{Give an example of $S, T\in\Lm{\Fbb^5}$ with $ST = 0$ and $\dim\range TS = 2$.}
}\par\vspace{-4pt}\quad
...
\AlignEq{}{\text{And\,}ST=0&\Rightarrow \dim\range TS\leqslant\dim\range T\leqslant\dim\null S\leqslant n-\dim\range TS\hspace{70pt}\\[-4pt]&\Longrightarrow 2\dim\range TS\leqslant n.\text{ Thus }\dim\range TS\leqslant\Frac{n}{2}\Rightarrow\dim\range TS\leqslant\left\lfloor\Frac{n}{2}\right\rfloor.}\PfEnd
%\vspace{6pt}\quad
...
\ProblemBnoor{\hypertarget{3B4e33}{9.A.6, \OR 4E 3.B.33}}{
	\TextB{Suppose that $V,W$ are on $\Rbb,$ and $T\in\Lm{V,W}.$ Show that}
	{\tgnr\large(a)} $\null\Par{T_\Cbb}=\BigPar{\null T}{_\Cbb}.$ \; {\tgnr\large(b)} $\range\Par{T_\Cbb}=\BigPar{\range T}{_\Cbb}.$ \; {\tgnr\large(c)} $T_{\Cbb}$ is inv $\Longleftrightarrow T$ is inv.\TextB{}
}{\normalsize\envFontSmall(a) $u+\i v\in\null\Par{T_\Cbb}\Longleftrightarrow u,v\in\null T\Longleftrightarrow u+\i v\in\BigPar{\null T}{_\Cbb}.$\parSol{}
(b) $w+\i x\in\range\Par{T_\Cbb}\Longleftrightarrow w,x\in\range T\Longleftrightarrow w+\i x\in\BigPar{\range T}{_\Cbb}.$\parSol{}
(c) $\forall w,x\in W,\exists\,!\,u,v\in V,T_\Cbb\Par{u+\i v}=w+\i x\Longleftrightarrow Tu=w,Tv=x.$ \Or By (a) and (b).}\large\PfEnd
\SepLine
\ChEnd

\ChDecl{Ch3C}{3$\cdot$C}{}\orMode{\hLk{3C1}{1}\;\;\hLk{3C3}{3}\;\;\hLk{3C4}{4}\;\;\hLk{3C5}{5}\;\;\hLk{3C6}{6}\;\;\hLk{3C9}{9}\;\;\hLk{3C10}{10}\;\;\hLk{3C11}{11}\;\;\hLk{3C12}{12}\;\;\hLk{3C13}{13}\;\;\hLk{3C14}{14}\;\;\hLk{3C15}{15}\;\;|\;\;\hLk{3C4e16}{4E:\;\;16}\;\;\hLk{3C4e17}{17}}{[1]: 10, 9, 11; [2]: (4E 16); [3]: (4E 17), 1, 3, 4; [4]: 5, 6, 13; [5]: 14, 15, 12.}
\vspace{8pt}
...
\ProblemN{\hypertarget{3D3}{3}}{
	...
	\TextN{Prove that $\exists$ inv $T\in\Lm{V},Tu = Su,\forall u\in U$ $\Longleftrightarrow$ $S$ is inje. {\large\Sbra{ Compare this with (3.A.11). }}}\vspace{2pt}
...
(b) Let $\Par{u_1,\dots,u_m}$ be a basis of $U.$ Then $S$ inje $\Longrightarrow\Par{Su_1,\dots,Su_m}$ linely inde.\parSol{\Hb}
...
\ProblemB[]{
	\TextB{Suppose $S,T\in\Lm{V,W}.$ \envFontDefault\large\hfill \Sbra{ For Problem (4) and (5), see the \COROLLARY in (3.B.24, 25). }}
}
...
\ProblemN{\hypertarget{3D8}{8}}{
	\TextN{Suppose $V$ is finite-dim and $T\in\Lm{V,W}$ is {\tgsc surj}.}
...
$ST$ is inv $\Longleftrightarrow$ $S$ and $T$ are inv.\vspace{2pt}}
}Suppose $S,T$ are inv. Then $\Par{ST}\Par{T^{-1}S^{-1}}=\Par{T^{-1}S^{-1}}\Par{ST}=I.$ Hence $ST$ is inv.\parSol{}
Suppose $ST$ is inv. Let $R=\Par{ST}{^{-1}}\Rightarrow R\Par{ST}=\Par{ST}R=I$.\parSol{\vspace{4pt}}
$\MathRightBrace{l}{$
$Tv=0\Rightarrow v=R\Par{ST}v=RS\Par{Tv}=0\\ $
$\forall v\in V,v=\Par{ST}Rv=S\Par{TRv}\in\range S}\Rightarrow T$ is inje, $S$ is surj. While $V$ is finite-dim.\parSol{\vspace{6pt}}
\Or By (3.B.23), $\dim V=\dim\range ST\leqslant\min\!\Bra{\range T,\range S}.$\PfEnd
\SepLine
...
$\Par{ST}U=U\Par{ST}=\Par{US}T=I\Rightarrow T^{-1}=US.$\par\quad
...
Let $B_1=\Par{E_1,\dots,E_n},B_2=\Par{R_1,\dots,R_m}$ be the std bases of $\Fbb^{n,1}$ and $\Fbb^{m,1}$.\vspace{-12pt}\par\quad
$\forall k=1,\dots,n,$ suppose $T\Par{E_{k}}=A_{1,k}R_1+\dots+A_{m,k}R_m,\exists\,A_{j,k}\in\Fbb$, forming $A\,=\,${\normalsize$\begin{pmatrix} A_{1,1} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{1,n}\\[-4pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt] A_{m,1} &\hspace{-6pt} \cdots &\hspace{-6pt} A_{m,n}\end{pmatrix}.$}\par{\vspace{-6pt}}\quad
...
\;\;$\hMath{l}{\left.}{\right.}{$
又 $W=\Spn${\small$\begin{Bmatrix} \underset{\;,}{E_{m+1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!,}{E_{n,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \,\vdots\\[-2pt] \overset{\;,}{E_{m+1,p}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!,}{E_{n,p}}\end{Bmatrix}$}$\,\subseteq\mathcal{E}.\\\;\\\;}\hMath{l}{\left.}{\right.}{\\[4pt]$ Where $\Lm{V,W}=R\oplus W\Rightarrow\Lm{V,W}=R+\mathcal{E}.\\$
...
Let $\Par{w_1,\dots,w_n},\Par{v_1,\dots,v_n}$ be bases of $V.$ Then $\Mt[\BigPar]{S,\Par{v_1,\dots,v_n},\Par{w_1,\dots,w_n}}\,=\,${\small$\begin{pmatrix} \mathbb{1} &\hspace{-6pt} \cdots &\hspace{-6pt} 0 &\hspace{-6pt} \cdots &\hspace{-6pt} 0\\[-6pt]
% 0 &\hspace{-6pt} \mathbb{1} &\hspace{-6pt} \cdots &\hspace{-6pt} 0 &\hspace{-6pt} 0 &\hspace{-6pt} \cdots &\hspace{-6pt} 0\\[-6pt]
...
%0 &\hspace{-6pt} \cdots &\hspace{-6pt} 0 &\hspace{-6pt} 0 &\hspace{-6pt} \cdots &\hspace{-6pt} 0\\[-6pt]
\vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-6pt]
...
Define $E_{j,k}R_{i,j}=Q_{i,k}$ by $Q_{i,k}:w_x\mapsto\delta_{i,x}w_k.$\par\quad
Define $R_{j,k}E_{i,j}=G_{i,k}$ by $G_{i,k}:v_x\mapsto\delta_{i,x}v_k.$\par\vspace{-36pt}\quad
{\AlignEq{}{\text{Because for each }T\in\Lm{V},\;\,\exists\;!\;A_{i,j}\in{}\Fbb,\;\;\;T\,=\,{\small\begin{pmatrix}
A_{1,1}R_{1,1}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{1,m}R_{m,1}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{1,n}R_{n,1}\\[-2pt]
...
A_{m,1}R_{1,m}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{m,m}R_{m,m}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{m,n}R_{n,m}\\[-2pt]
+&\hspace{-6pt}\cdots &\hspace{-6pt}+&\hspace{-6pt}\cdots &\hspace{-6pt}+\\[-4pt]
\vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt]
+\;\;&\hspace{-6pt}\cdots &\hspace{-6pt}+&\hspace{-6pt}\cdots &\hspace{-6pt}+\\[-2pt]
A_{n,1}R_{1,n}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{n,m}R_{m,n}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{n,n}R_{n,n}
\end{pmatrix}}.\hspace{26pt}}}\vspace{-36pt}\par\quad
\!$\hMath{l}{\left.}{\right.}{\mathcal{A}\Par{T}=\textstyle\XPar{\sum_{r=1}^m E_{r,r}}\XPar{\textstyle\sum_{i=1}^n\sum_{j=1}^n A_{i,j}R_{j,i}}\\[6pt]{\normalsize\begin{pmatrix}
...
\ProblemB{
	\NoteForSmall{Problem (4E 17)} \,\,\,\TextB{Define $\mathcal{B}\in\Lm[\BigPar]{\Lm{V}}$ by $\mathcal{B}\Par{T}=TS.$}
...
{\Large\AlignEq{}{\textstyle\mathcal{B}(T)=TS=\XPar{\sum_{i=1}^n\sum_{j=1}^n A_{i,j}R_{j,i}}\XPar{&\textstyle\sum_{r=1}^m E_{r,r}}\hspace{-100pt}\\[-50pt]=&\textstyle\sum_{i=1}^n\sum_{j=1}^m A_{i,j}G_{j,i}\,=\,{\normalsize\begin{pmatrix}
A_{1,1}G_{1,1}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{1,m}G_{m,1}\\[-2pt]
+&\hspace{-6pt}\cdots &\hspace{-6pt}+\\[-4pt]
\vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt]
+&\hspace{-6pt}\cdots &\hspace{-6pt}+\\[-2pt]
A_{m,1}G_{1,m}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{m,m}G_{m,m}\\[-2pt]
+&\hspace{-6pt}\cdots &\hspace{-6pt}+\\[-4pt]
\vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-4pt]
+&\hspace{-6pt}\cdots &\hspace{-6pt} +\\[-2pt]
A_{n,1}G_{1,n}\;\;+&\hspace{-6pt}\cdots &\hspace{-6pt}+\;\;A_{n,m}G_{m,n}
\end{pmatrix}}.}}\vspace{-70pt}\par\quad
$\null\mathcal{B}\,=\,\Spn${\normalsize$\begin{pmatrix} \underset{\;,}{R_{m+1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!\!,}{R_{n,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt] \overset{\;,}{R_{m+1,n}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{R_{n,n}}\end{pmatrix}$},\par\vspace{-8pt}\quad
$\range\mathcal{B}\,=\,\Spn${\normalsize$\begin{pmatrix} \underset{\;,}{G_{1,1}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\underset{\!\!,}{G_{m,1}},\\[-2pt] \vdots &\hspace{-6pt} \ddots &\hspace{-6pt} \vdots\\[-2pt] \overset{\;,}{G_{1,n}}, &\hspace{-6pt} \cdots &\hspace{-6pt} ,\overset{\!\!\!,}{G_{m,n}}\end{pmatrix}$}. \;$\hMath{l}{\left.}{\right.}{$(a) $\dim\null\mathcal{B}=n\times\Par{n-m};\\$(b) $\dim\range\mathcal{B}=n\times m.\\\,\\\,}$\PfEnd\vspace{-8pt}
\SepLine\pagebreak
...
{\vspace{4pt}Let {\Large$S=E_{1,1}+\dots+E_{m,m}\Rightarrow \Mt{S,B_U}=\Mt{I,B_{\range S},B_U}$}.}\par\quad
...
Define $T_n:\PoR{n}\rightarrow\PoR{n}$ by $T_n\Par{p}=\Par{x^2 + x}p\apostrophe\apostrophe\Par{x} + 2xp\apostrophe\Par{x} + p\Par{3}.$ Then $T_n$ is linear.\parSol{}
And note that $T_n\Par{p}=0\Rightarrow\Deg\Par{T_n p}=-\infty=\deg p\Rightarrow p=0.$ Thus $T_n$ is inv.\parSol{}
$\forall q\in\PoR{},$ if $q=0,$ let $m=0;$ if $q\neq 0,$ let $m=\deg q,$ we have $q\in\PoR{m}.$\parSol{}
...
}(a) $T$ is inje $\Longleftrightarrow$ $\forall n\in\Nbp,T\mmid_{\Po_n\Par{\Rbb}}\in\Lm[\BigPar]{\PoR{n}}$ is inje, so is inv $\Longleftrightarrow T$ is surj.\parSol{}
