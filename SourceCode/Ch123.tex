...
\Blind{Surj:} $\forall p,q\in\PoFi{},$ supp $\deg p=m\geqslant n=\deg q,$ \Sbra{{\tgsl which is why we do not write $p+\lambda q.$}}\parSol{}
...
$\varphi_k\BigPar{x^j}={}${\Large\envFontSmall[\footnotesize]$\frac{\Par[0pt]{x^j}{^{\SmallPar[0pt]{k}}}\Par[0pt]{0}}{k!}$}${}={}${\Large$\frac{\;0\;}{k!}$}${}=0;\;\varphi_k\BigPar{x^k}={}${\Large\envFontSmall[\footnotesize]$\frac{\Par[0pt]{x^k}{^{\SmallPar[0pt]{k}}}\Par[0pt]{0}}{k!}$}${}=1.$\par\quad
Thus {\Large$\envFontSmall[\footnotesize]\frac{p^{\SmallPar[0pt]{k}}\Par[0pt]{0}}{k!}$} act exactly the same as $\varphi_k$ on the same bss $\Par{1,\dots,x^m},$ hence is just another def of $\varphi_k$.\PfEnd\vspace{8pt}
