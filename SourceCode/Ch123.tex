...
\ProblemB[]{
	\Tips \,\,\,\TextB{Supp $V$ is finide with $\dim V=n$ and $U$ is a subsp of $V$ with $U\neq V.$}
...
\ProblemN{\hypertarget{2C15}{15}}{
	\TextNL{Supp $V$ is finide and $\dim V=n\geqslant 1.$}
...
\Comment \,\,\,Let $B_V=\Par{v_1,\dots,v_n}$ and supp $v=u_1+\dots+u_n,$ where each $u_i=a_i v_i\in V_{\!i}.$\parCom
...
\ProblemN{\hypertarget{2C10}{10}}{
	\TextNL{Supp $m\in\Nbp,\;p_0,p_1,\dots,p_m\in\PoFi$ are suth each $p_k$ has deg $k.$}
...
\BulletPointX\Corollary \,\,\,\Largesl{Supp $V_{\!1},V_{\!2},V_{\!3}$ are finide, then}\vspace{-2pt}\TextB{}
...
\ProblemBnoor{\hypertarget{3B4e32}{4E 3.B.32}}{
	\TextB{Supp $V$ is finide with $n=\dim V > 1$.}
...
\ProblemB{
	\hypertarget{3A4e11}{}\TextB{Supp $V$ is finide. $T\in\Lm{V}$ is suth $\forall S\in\Lm{V},ST=TS$.}
...
\ProblemN{\hypertarget{3B7}{7}}{
	\TextN{Supp $V$ is finide with $2\leqslant\dim V.$ And $\dim V\leqslant\dim W=m$, if $W$ is finide.}
...
\ProblemN{\hypertarget{3B8}{8}}{
	\TextN{Supp $W$ is finide with $\dim W\geqslant 2.$ And $n=\dim V\geqslant\dim W$, if $V$ is finide.}
...
\Corollary \,\,\,{\FontLarge\tgsl[P] \quad{$T\mmid_U:U\rightarrow\range T$ is iso $\Longleftrightarrow U\oplus\null T=V.$}\quad [Q]}\vspace{2pt}\parCor
...
\ProblemB{
	\hspace{0pt}\textsc{\Large Column-Row Factorization}\;\;\BigPar{CR Factorization}\;\;\vspace{3pt}\TextB{Supp $A\in\Fbb^{m,n},A\neq 0.$}
...
\BulletPointX\Corollary \,\,\,Supp $\tau$ is an algebraic property. Then $\tau$ holds for liney maps $\Longleftrightarrow \tau$ holds for matrices.\parCor{\IndentB}
...
\ProblemN{\hypertarget{3D2}{2}}{
	\TextN{Supp $V$ is finide and $\dim V > 1$.}
...
\ProblemB{
	\Tips \,\,\,\TextB{Supp $U\oplus X=W\oplus Y,$ and $X,Y$ are iso. Prove $U,W$ are iso.}
...
Now supp $u_1,u_2\in U,$ then each $u_i=w_i+\xi\Par{x_i},\exists\,!\,w_i\in W,x_i\in X.$\parSol{}
...
\ProblemNnoor{\hypertarget{3D9}{9}}{\OR \hypertarget{3D1}{1}}{
	...
	%\Corollary \,\,\,Supp $T$ is inv. Let $S=T^{-1}\Rightarrow ST=I_U.$ Then $I_U$ inv $\Rightarrow T^{-1}$ inv.
...
{\FontSmall$\MathRightMid{l}{\!\!\!$\BulletPointX\hypertarget{3D4e3}{\Par{4E 3}} $T\in\Lm{V}\\$\quad\;$V$ is finide$}\MathRightBrace{l}{$
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Supp $U,W$ are subsps of $V.$ Let $I=U\cap W.$ Prove $V=U+W\Longleftrightarrow V\XSlash I=U\XSlash I\oplus W\XSlash I.$}
...
\ProblemN{\hypertarget{3F37}{37}}{
	...
	(c) \TextNL{Conclude that $\pi\apostrophe$ is iso from $\Par{V\XSlash U}\apostrophe$ onto $U^0$\hspace{1pt}$:${\tgnr\FontNorm\;\;Immediately.}}
