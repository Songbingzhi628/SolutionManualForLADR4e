...
%		\TextNL{\envFontDefault\large\tgnr\Or $U^0=V\apostrophe\Longleftrightarrow\dim U^0=\dim V\Longleftrightarrow\dim U=0.$}\vspace{5pt}
	...
	\ProblemN[]{\hypertarget{3F19}{19}}{
		\TextNL{\tgnr $U^0_V=\zeroSubs=V^0_V\Longleftrightarrow U=V$. {\normalsize\tgnr By the inverse and contrapositive of Problem (4).}}}
	\TextB{\vspace{-4pt}}
}\SepLine
...
\ProblemN{\hypertarget{3F20}{20}}{
	\TextNL{Suppose $U,W$ are nonempty subsets of $V$. Prove that $U\subseteq W\Rightarrow W^0\subseteq U^0.$}
...
\ProblemN{\hypertarget{3F21}{21}}{
	\TextNL{Suppose $U,W$ are subsps of $V$. Prove that $W^0\subseteq U^0\Rightarrow U\subseteq W.$}
}Using Problem (25). Now $v\in U\Rightarrow\forall\varphi\in W^0\subseteq U^0,\varphi\Par{v}=0\Rightarrow v\in W.$\PfEnd\vspace{2pt}
...
(2) If $W$ is merely a subset and $U$ is a subsp. Promote $W$ as $Y,$ let $U=X.$ For example,\parCom
...
%Now we show that $X\cap Y=I.$ So that $\BigPar{U\cap W}{^0}=I^0=\BigPar{X\cap Y}{^0}=X^0+Y^0=U^0+W^0.$\parCom
