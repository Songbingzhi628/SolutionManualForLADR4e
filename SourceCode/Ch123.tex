...
\ProblemN{\hypertarget{2A17}{17}}{
	\TextNL{Supp $p_0,p_1,\dots,p_m\in\PoF{m}$ suth each $p_k\Par{2}=0.$}
...
%	\TextN{Prove or give a countexa\hspace{1pt}$:$ If $\Par{v_1,v_2,v_3,v_4}$ is a bss of $V$ and $U$ is a subsp of $V$}
...
Now $\dim\!\Par{V_{\!1}+\dots+V_{\!m}}=\dim\Span[\BigPar]{\mathcal{E}_1\cup\cdots\cup \mathcal{E}_m}\leqslant\Card\BigPar{\mathcal{E}_1\cup\cdots\cup \mathcal{E}_m}\leqslant\card \mathcal{E}_1+\cdots+\card \mathcal{E}_m.$\par\vspace{2pt}
...
\ProblemN{\hypertarget{2C17}{17}}{
	...
	\TextNL{Explain why you might think and prove the formula above or give a countexa.}
}\par\quad
...
\ProblemN[]{\hypertarget{3B11}{11}}{
	...
	(a) $\range S_1\supseteq\Range\Par{S_1S_2}\supseteq\cdots\supseteq\Range\Par{S};$ \; {\tgnr\large(b)} $\null S_n\subseteq \Null\Par{S_{n-1}S_n}\subseteq\cdots\subseteq\Null\Par{S}.$\par\vspace{2pt}
...
\ProblemBnoor{\hypertarget{3B4e27}{4E 27}}[\Sbra]{
...
\BulletPointX\NoteForSmall{[3.49]} ${\BigSbra{\BigPar{AC}_{\cdot,k}}}_{j,1}=\BigPar{AC}_{j,k}=\sum_{r=1}^n A_{j,r}C_{r,k}=\sum_{r=1}^n A_{j,r}\BigPar{C_{\cdot,k}}_{r,1}=\BigPar{AC_{\cdot,k}}_{j,1}$\PfEnd\vspace{6pt}
\BulletPointX\Exercise{\hypertarget{3C10}{10}}\qquad\hspace{5pt}${\BigSbra{\BigPar{AC}_{j,\cdot}}}_{1,k}=\BigPar{AC}_{j,k}=\sum_{r=1}^n A_{j,r}C_{r,k}=\sum_{r=1}^n \BigPar{A_{j,\cdot}}_{1,r}C_{r,k}=\BigPar{A_{j,\cdot}C}_{1,k}$\PfEnd\vspace{6pt}
...
If $\mathcal{E}=\zeroSubs,$ then done. Supp $0\neq T\in\mathcal{E},$ a two-sided ideal of $\Lm{V}.$\par\quad
Let $w=Tv\neq 0.$ Extend $v=v_1$ to $B_V=\Par{v_1,\dots,v_n}\Rightarrow Tv_1=a_1v_1+\dots+a_nv_n.$ Supp $a_k\neq 0.$\par\quad
...
\ProblemBnoor{\hypertarget{5A33}{5.A.33}}{
...
\ProblemBnoor{\hypertarget{5A34}{5.A.34}}{
...
\ProblemN{\hypertarget{3F36}{36}}{
	...
	(b) \TextNL{Prove $\rangep i\apostrophe=U\apostrophe$\hspace{1pt}$:${\tgnr\FontNorm\;\;$\rangep i\apostrophe=\Par{\nullp i}{_U^0}={\zeroSubs}{_U^0}=U\apostrophe$.}\vspace{2pt}}
