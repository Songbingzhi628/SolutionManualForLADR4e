...
$\Longleftrightarrow$ For each $k,$ $\BigPar{V_{\!1}\oplus\dots\oplus V_{\!k}}\cap V_{k+1}=\zeroSubs,\BigPar{\mathcal{E}_1\cap\dots\cap\mathcal{E}_{k-1}}\cap\mathcal{E}_k=\emptySet$\parCor
...
and the wrong formual above holds. Similar for $Y\subseteq Z,X\subseteq Z,$ and $X,Y\subseteq Z.$\par\vspace{8pt}
\BulletPointX\Corollary \,\,\,\Largesl{Suppose $V_{\!1},V_{\!2}$ and $V_{\!3}$ are finite-dim vecsps, then} {\small $\Frac{\Par{1}+\Par{2}+\Par{3}}{3}:$
}\vspace{-6pt}\par
