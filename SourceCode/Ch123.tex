...
$}\Longleftrightarrow T\Par{v+\lambda u}=Tv+\lambda Tu.$\vspace{5pt}\TextB{}
\ANote Supp $V$ is a vecsp. For $U\subseteq V,$ $U$ is a subsp of $V\Longleftrightarrow\forall u_1,u_2\in U,\lambda\in\Fbb,u_1+\lambda u_2\in U.$\par\vspace{3pt}
...
\Anchor{3ANR}\ProblemB[]{
	...
	\PrePb\TextB{$\forall S\in\Lm{W,X},T\in\Lm{V,W},\left.\Par{ST}\right|{_U}=ST\mmid_U.$\vspace{-4pt}}
}\SepLine
...
\ProblemN{\Anchor{3A3}{3}}{
	...
	\!\!A_{m,1}x_1+\dots+A_{m,n}x_n\!\!\!}$}\vspace{-10pt}}
}\par\quad
...
}$\Par{S+\lambda T}{_\Cbb}\Par{u+\i v}=\Par{S+\lambda T}\Par{u}+\i\Par{S+\lambda T}\Par{v}\Par{S_\Cbb+\lambda T_{\!\Cbb}}\Par{u+\i v}.$\vspace{-3pt}\PfEnd
\SepLine
