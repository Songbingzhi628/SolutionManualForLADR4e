...
To fix this, we must have a bss of $V\apostrophe$ as precond, which we'll see in the {\NOTE} for Exa (31).\par\vspace{3pt}
...
(1) If $\Omega$ is infinide. Then $\bigcap_{\varphi\,\in\,\Omega}\null\varphi=\null_C.$ \;(2) If $\Omega=\Span{\varphi_1,\dots,\varphi_m}.$ Then $\null_I=\null_C.$\TextB{}
(1) By def. \;(2) Becs $v\in\null_I\Longleftrightarrow$ each $\varphi_k\Par{v}=0\Longleftrightarrow\forall\varphi=\sum_{i=1}^na_i\varphi_i\in\Omega,\varphi\Par{v}=0\Longleftrightarrow v\in\null_C.$
\SepLine\pagebreak
...
\BulletPointX\NoteForSmall{Exe (26)}\;\;Supp $V$ is finide. For every subsp $\Omega$ of $V\apostrophe,\;\exists\,!\,$subsp $U$ of $V$ suth $\Omega=U^0.$
\SepLine
