...
\ProblemN{1}{
	\vspace{2pt}\TextN{Provt $\forall v\in V,-\Par{-v} = v$.}
...
\ProblemN{2}{
	\TextN{Sup $a\in\Fbb,v\in V$, and $av = 0$. Provt $a = 0$ or $v = 0$.}
...
\ProblemN[]{5}{
	\TextN{Shat in the def of a vecsp, the add inv condition can be replaced by [1.29].}
	\TextN{\large{\tgsc Hint\tgbf:} Sup $V$ satisfies all conds in the def, except we've replaced the add inv cond with [1.29].}
	\TextN{\large\Blind{{\tgsc Hint\tgbf:}} Provt the add inv is true.}
...
\BulletPointX\NoteForSmall{[1.45]}\;\;If $\Fbb=\Bra{0,1}.$ Provt if $U+W$ is a direct sum, then $U\cap W=\zeroSubs.$\TextB{}
...
Asm $\exists\,p\in\Nbp$ suth $h\Par{x}=h\Par{x+p},\forall x\in\Rbb.$ Let $x=0\Rightarrow h\Par{0}=h\Par{\pm p}=1$.\par\quad
...
\ProblemN{\hypertarget{1C24}{24}}{
	\TextNL{Let $V_{\!E}=\Bra{\,f\in\Rbb^{\Rbb}:\text{f is even}},V_{\!O}=\Bra{\,f\in\Rbb^{\Rbb}:\text{f is odd}}.$ Shat $V_{\!E}\oplus V_{\!O}=\Rbb^{\Rbb}.$\vspace{4pt}}
...
\ProblemN{\hypertarget{1C11}{11}}{
	\TextNL{Provt the intersec of every collec of subsps of $V$ is a subsp of $V$.}
}Sup $\Bra{U_{\alpha}}{_{\alpha\in\Gamma}}$ is a collec of subsps of $V$; here $\Gamma$ is an index set.\vspace{2pt}\par\quad
We shat $\bigcap_{\alpha\in\Gamma}U_\alpha,$ which equals the set of vecs that are in $U_\alpha$ for each $\alpha\in\Gamma$, is a subsp of $V$.\par\vspace{4pt}\,
$\begin{array}{l}$
...
\ProblemN{\hypertarget{1C12}{12}}{
	\TextNL{Sup $U,W$ are subsps of $V.$ Provt $U\cup W$ is a subsp of $V\Longleftrightarrow U\subseteq W$ or $W\subseteq U$.}
...
\ProblemN{\hypertarget{1C13}{13}}{
	\TextNL{Provt the union of three subsps of $V$ is a subsp of $V$}
...
\ProblemB{
	\TextB{Sup $U=\Bra{\Par{x,x,y,y}},W=\Bra{\Par{x,x,x,y}}\subseteq\Fbb^4.$ Provt $U+W=\Bra{\Par{x,x,y,z}}.$\vspace{2pt}}
...
\ProblemN{\hypertarget{1C21}{21}}{
	\TextNL{Sup $U=\Bra{\Par{x,y,x+y,x-y,2x}}$. Find a $W$ suth $\Fbb^5=U\oplus W$.}
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Sup $V_{\!1}\subseteq V_{\!2}$ in Exe {\tgnr(23)}. Provt $V_{\!1}=V_{\!2}.$}
}\par\quad
Becs the subset $V_{\!1}$ of vecsp $V_{\!2}$ is closd add and scalar multi, $V_{\!1}$ is a subspace of $V_{\!2}.$\par\quad
Sup $W$ is suth $V_{\!2}=V_{\!1}\oplus W.$ Now $V_{\!2}\oplus U=\Par{V_{\!1}\oplus W}\oplus U=\Par{V_{\!1}\oplus U}\oplus W=V_{\!1}\oplus U.$\par\quad
...
\ProblemB{
	\TipsN{4}\,\,\,\TextB{Let $V=U+W,\;I=U\cap W,\,U=I\oplus X,\,W=I\oplus Y.$ Provt $V=I\oplus\Par{X\oplus Y}.$}
}We shat $X\cap Y=U\cap Y=W\cap X=\zeroSubs$ by ctradic.\parSol{}
...
Now we shat $V=I+\Par{X+Y}.$ \;$\forall v\in V,v=u+w,\exists\,\Par{u,w}\in U\times W$\parSol{}
$\Rightarrow\exists\,\Par{i_u,x_u}\in I\times X,\,\Par{i_w,y_w}\in I\times Y,\;v=\Par{i_u+i_w}+x_u+y_w\in I+\Par{X+Y}.$\PfEnd
\SepLine

%\ProblemB{
%	\TipsN{3}\,\,\,\TextB{Let $V=U+W,\,I=U\cap W,\,U=I\oplus X,W=I\oplus Y.$ Provt $V=I\oplus\Par{X\oplus Y}.$}
...
\ProblemN{\hypertarget{2A1}{1}}{
	\TextN{Provt [P] $\Par{v_1,v_2,v_3,v_4}$ spans $V\Longleftrightarrow\BigPar{v_1-v_2,v_2-v_3,v_3-v_4,v_4}$ also spans V [Q].}
...
\ProblemB{
	...
	(a) \TextB{Shat $\Span{v_1,\dots,v_m}=\Span{w_1,\dots,w_m}.$}
	(b) \TextB{Shat [P] $\Par{v_1,\dots,v_m}$ is linely inde $\Longleftrightarrow$ $\Par{w_1,\dots,w_m}$ is linely inde [Q].}
}\par\quad
...
\ProblemN{\hypertarget{2A10}{10}}{
	...
	\TextNL{Provt if $\BigPar{v_1+w,\dots,v_m+w}$ is linely depe, then $w\in\Span{v_1,\dots,v_m}$.}
}\par\quad
...
\ProblemN{\hypertarget{2A11}{11}}{
	\TextNL{Sup $\Par{v_1,\dots,v_m}$ is linely inde in $V$ and $w\in V$.}
	\TextNL{Shat [P] $\Par{v_1,\dots,v_m,w}$ is linely inde $\Longleftrightarrow w\not\in\Span{v_1,\dots,v_m}$ [Q].\vspace{8pt}}
...
\ProblemN{\hypertarget{2A14}{14}}{
	\TextNL{Provt [P] $V$ is infinide $\Longleftrightarrow[Q]\left|\hspace{-6pt}\begin{array}{l}$ there is a sequence $\Par{v_1,v_2,\dots}$ in $V$ suth$\\[-8pt]$ $\Par{v_1,\dots,v_m}$ is linely inde for each $m\in\Nbp.\end{array}\right.$}
}\par\quad
$P\Rightarrow Q:\;$ Sup $V$ is infinide, so that no list spans $V$.\par\quad
...
${}^\neg P\Rightarrow{}^\neg Q:\;$ Sup $V$ is finide and $V=\Span{w_1 , ..., w_m}$.\par\quad
...
\ProblemN{\hypertarget{2A16}{16}}{
	\TextNL{Provt the vecsp of all continuous functions in $\Rbb^{[0,1]}$ is infinide.}
}Denote the vecsp by $U$.\par\quad
Choose one $m\in\Nbp.$ Sup $a_0,\dots,a_m\in\Rbb$ are suth $p\Par{x}=a_0+a_1 x+\dots+a_m x^m=0,\,\forall x\in\Sbra{0,1}.$\par\quad
Then $p$ has infily many roots and hence each $a_k=0,$ othws $\deg p\geqslant 0,$ ctradic [4.12].\par\quad
Thus $\Par{1,x,\dots,x^m}$ is linely inde in $\Rbb^{[0,1]}.$ Simlr to [2.16], $U$ is infinide.\PfEnd\vspace{8pt}\quad
...
\ProblemN{\hypertarget{2A17}{17}}{
	\TextNL{Sup $p_0,p_1,\dots,p_m\in\PoF{m}$ suth $p_k\Par{2}=0$ for each $k\in\Bra{0,\dots,m}$.}
	\TextNL{Provt $\Par{p_0,p_1,\dots,p_m}$ is not linely inde in $\PoF{m}$.}
}\par\quad
...
\BulletPointX\NoteForSmall{\Large $“\complement_V U \cup \zeroSubs”$}\;\;$“\complement_V U \cup \zeroSubs”$ is supd to be a subsp $W$ suth $V=U\oplus W$.\TextB{\vspace{4pt}}
...
\ProblemB[]{
	\Tips \,\,\,\TextB{Sup $V$ is finide with $\dim V=n$ and $U$ is a subsp of $V$ with $U\neq V.$}
	\IndentTips\TextB{Provt $\exists\,B_V=\Par{v_1,\dots,v_n}$ suth each $v_k\not\in U.$}
}\TextB{\vspace{0pt}}
...
\ProblemBnoor{\hypertarget{2B4e9}{4E 9}}{
	...
	\TextB{Shat [P] $B_V=\Par{v_1,\dots,v_m}\Longleftrightarrow B_W=\Par{w_1,\dots,w_m}.$ [Q]}
...
\ProblemBnoor{\hypertarget{2B4e5}{4E 5}}{
	\TextB{Sup $U,W$ are finide, $V=U+W,\;B_U=\Par{u_1,\dots,u_m},\;B_W=\Par{w_1,\dots,w_n}.$}
	\TextB{Provt $\exists\,B_V$ consisting of vecs in $U\cup W$.\vspace{-4pt}}
...
\ProblemN{\hypertarget{2B8}{8}}{
	...
	\TextN{Provt $B_V=\BigPar{u_1,\dots,u_m,w_1,\dots,w_n}$.}
...
\ProblemBnoor[]{\hypertarget{2B4e}{9.A.3,4 \OR 4E 11}}{
	...
	(a) \TextB{Shat [P] $B$ is linely inde in $V$ $\Longleftrightarrow B$ is linely inde in $V_{\!\Cbb}.$ [Q]}
	(b) \TextB{Shat [P] $B$ spans $V$ $\Longleftrightarrow B$ spans $V_{\!\Cbb}.$ [Q]\vspace{2pt}}
}{\envFontSmall\normalsize\par\quad
...
we can provt $\exists\,!\,T\in\Lm{V,W}$ with each $Tv_k=w_k,$ which has less restr than [3.5].\TextB{}
...
\ProblemN{\hypertarget{2C15}{15}}{
	\TextNL{Sup $V$ is finide and $\dim V=n\geqslant 1.$}
	\TextNL{Provt $\exists$ one-dim subsps $V_{\!1},\dots,V_{\!n}$ of $V$ suth $V=V_{\!1}\oplus \dots\oplus V_{\!n}.$}
...
\ProblemBnoor{\NoteForSmall{Exe (15)}}[]{
	\TextB{}
	\TextB{Sup $v\in V\nonzero,$ and $\dim V=n\geqslant 1.$ Provt $\exists\,B_V=\Par{v_1,\dots,v_n},v=v_1+\dots+v_n.$}
...
But $\Par{u_1,\dots,u_n}$ might not be a basis, becs there might be some $u_i=0.$\vspace{-2pt}
\SepLine\pagebreak

\ProblemNnoor[]{\hypertarget{2C1}{1}}{{\COROLLARY} for [2.38,39]}{
	\TextN{Sup $U$ is a subsp of $V$ suth $\dim V=\dim U$. Then $V=U.$}
...
%Sup $p\Par{z}=az^4+bz^3+cz^2+dz+e$ suth $p\Par{2}=p\Par{5}=p\Par{6}$.\vspace{4pt}\par\quad
...
\ProblemN{\hypertarget{2C9}{9}}{
	\TextN{Sup $\Par{v_1,\dots,v_m}$ is linely inde in $V$ and $w\in V$. Provt $\dim\Span[\BigPar]{v_1+w,\dots,v_m+w}\geq m-1$.}
...
\ProblemBnoor{\hypertarget{2C4e16}{4E 16}}{
	\TextB{Sup $V$ is finide, $U$ is a subsp of $V$ with $U\neq V$. Let $n=\dim V,m=\dim U$.}
	\TextB{Provt $\exists\,\Par{n-m}$ subsps  $U_1,\dots,U_{n-m}$, each of dim $\Par{n-1}$, suth $\bigcap\limits_{i=1}^{n-m}U_i=U$.}
...
\ProblemN{\hypertarget{2C10}{10}}{
	\TextNL{Sup $m\in\Nbp,\;p_0,p_1,\dots,p_m\in\PoFi$ are suth each $p_k$ has deg $k.$}
	\TextNL{Provt $\Par{p_0,p_1,\dots,p_m}$ is a basis of $\PoF{m}$.}
...
{We shat $a_m=\dots=a_0=0$ via the following process. So that $\Par{p_0,p_1,\dots,p_m}$ is linely inde.}\vspace{2pt}\par\quad
...
\Blind{{\tgbfx Step k.}} {Now if $k=0,$ then we are done. Othws, we have $L=a_{k-1}p_{k-1}\Par{x}+\dots+a_0p_0\Par{x}.$}\PfEnd
\SepLine

\ProblemBnoor{\Tips}[]{
	\TextB{Sup $m\in\Nbp,\;p_0,p_1,\dots,p_m\in\PoF{m}$ are suth the lowest term of each $p_k$ is of deg $k.$}
	\Blind{\Tips} \TextB{Provt $\Par{p_0,p_1,\dots,p_m}$ is a basis of $\PoF{m}.$}
}{Using mathematical induction on $m.$\par}\quad
...
\Blind{{\tgbfx Step k.}} {Now $\xi_{k}\Par{L}=a_{k}\xi_{k}\Par{p_k}=\xi_{k}\Par{R}=0$ 又 $\deg p_k=k,\;\xi_{k}\Par{p_k}\neq 0\Rightarrow a_k=0.$}\par\quad
\Blind{{\tgbfx Step k.}} {Now if $k=m,$ then we are done. Othws, we have $L=a_{k+1}p_{k+1}\Par{x}+\dots+a_mp_m\Par{x}.$}\PfEnd
\SepLine
...
For conveni, we asm $z^0=1$ in formula deduction and poly def. Absolutely without $0^0.$
\SepLine
...
\ProblemBnoor{\hypertarget{2C4e10}4E 10}{
	...
	\TextB{Shat $\Par{p_0,\dots,p_m}$ is a basis of $\PoF{m}$.\vspace{0pt}}
	%\TextB{{\large The basis in this exe leads to what are called Bernstein polys. You can do a web search to learn how}}
...
\Or Simlr to the {\TIPS} above. We will recursively provt each $x^{m-k}\in\Span{p_m,\dots,p_{m-k}}.$\par\quad
...
We use induction on to shat $S\Par{m}$ holds for all $m\in\Nbp.$\vspace{2pt}\par\quad
...
(ii) $1\leqslant m.$ \;Asm $S\Par{m}$ and $S\Par{m-1}$ holds. Now we shat $S\Par{m+1}$ holds.\vspace{2pt}\par\quad\Hii
...
\ProblemN{\hypertarget{2C14}{14}}{
	\TextNL{Sup $V_{\!1},\dots,V_{\!m}$ are finide. Provt $\dim\!\Par{V_{\!1}+\dots+V_{\!m}}\leqslant\dim V_{\!1}+\dots+\dim V_{\!m}$.}
...
\ProblemN{\hypertarget{2C17}{17}}{
	\TextNL{Sup $V_{\!1},V_{\!2},V_{\!3}$ are subsps of a finide vecsp, then}
...
\BulletPointX\Corollary \,\,\,\Largesl{Sup $V_{\!1},V_{\!2},V_{\!3}$ are finide, then} {\small $\Frac{\Par{1}+\Par{2}+\Par{3}}{3}$}:\vspace{-4pt}\par
...
\ProblemB[]{
	...
	\hypertarget{2C4e14}{}(a) \TextB{$\dim V=10,\;\dim V_{\!1} = \dim V_{\!2} = \dim V_{\!3} = 7$. Provt $V_{\!1}\cap V_{\!2}\cap V_{\!3}\neq\zeroSubs$.}
	\Blind{(a)} By {\TIPS}, $\Dim\Par{V_{\!1}\cap V_{\!2}\cap V_{\!3}}\geq\dim V_{\!1}+\dim V_{\!2}+\dim V_{\!3}\uline{{}-2\dim V}>0.$\TextB{\vspace{4pt}}
	\hypertarget{2C4e15}{}(b) \TextB{$\dim V_{\!1}+\dim V_{\!2}+\dim V_{\!3} > 2\dim V$. Provt $V_{\!1}\cap V_{\!2}\cap V_{\!3}\neq\zeroSubs$.}
...
\ProblemBnoor{\hypertarget{3B4e33}{9.A.2,6 \OR 4E 3.B.33}}{
	\TextB{Sup that $V,W$ are on $\Rbb,$ and $T\in\Lm{V,W}.$ Shat}
...
\ProblemBnoor{9.A.5}{
	\TextB{Sup $V$ is on $\Rbb,$ and $S,T\in\Lm{V,W}.$ Provt $\Par{S+\lambda T}{_\Cbb}=S_\Cbb+\lambda T_{\!\Cbb}.$}
...
\ProblemB{
	\TextB{Sup $U,V,W$ are on $\Rbb,$ $S\in\Lm{V,W},T\in\Lm{U,V}.$ Provt $\Par{ST}{_\Cbb}=S_\Cbb T_{\!\Cbb}.$}
...
\ProblemBnoor{4E 1.B.7}{
	...
	(b) \TextB{Provt $W^V$ is a vecsp with these defs.}
}\par\quad
...
\ProblemN[]{\hypertarget{3A5}{5}}{
	\TextN{Becs $\Lm{V,W}=\Bra{T:V\rightarrow W\;{\envFontHuge\envFontA\mmid}\;T\text{ is linear}}$ is a subsp of $W^V,$ $\Lm{V,W}$ is a vecsp.}
}\SepLine

\ProblemN{\hypertarget{3A3}{3}}{
	\TextN{Sup $T\in\Lm{\Fbb^n,\Fbb^m}$. Provt $\exists\,A_{j,k}\in\Fbb\,$suth for any $\Par{x_1,\dots,x_n}\in\Fbb^n,$}\hspace{-40pt}
...
\ProblemN{\hypertarget{3A4}{4}}{
	\TextN{Sup $T\in\Lm{V,W},$ and $v_1,\dots,v_m\in V$ suth $\Par{Tv_1,\dots,Tv_m}$ is linely inde in $W$.} \TextN{Provt $\Par{v_1,\dots,v_m}$ is linely inde.}
}Sup $a_1 v_1+\dots+a_m v_m=0$. Then $a_1 Tv_1+\dots+a_m Tv_m=0$. Thus $a_1=\dots=a_m=0.$\PfEnd
\SepLine

\ProblemN{\hypertarget{3A7}{7}}{
	\TextN{Shat every linear map from a one-dim vecsp to itself is a multi by some scalar.}
	\TextN{More precisely, provt if $\dim V = 1$ and $T\in\Lm{V}$, then $\exists\,\lambda\in\Fbb,Tv = \lambda v,\forall v\in V$.}
...
\ProblemN{\hypertarget{3A8}{8}}{
	\TextN{Give a map $\varphi:\Rbb^2\rightarrow\Rbb$ suth $\forall a\in\Rbb,v\in\Rbb^2,\varphi\Par{av} = a\varphi\Par{v}$ but $\varphi$ is not linear.\vspace{4pt}}
...
\ProblemN{\hypertarget{3A9}{9}}{
	\TextN{Give a map $\varphi:\Cbb\rightarrow\Cbb$ suth $\forall w,z\in\Cbb,\varphi\Par{w + z} = \varphi\Par{w} + \varphi\Par{z}$ but $\varphi$ is not linear.}
}Define $\varphi\Par{u+\i v}=u=\REAL\Par{u+\i v}$\quad\Or Define $\varphi\Par{u+\i v}=v=\IMAGINARY\Par{u+\i v}.$\PfEnd
\SepLine

\ProblemB{
	\hypertarget{3A4e10}{}\TextB{Provt if $q\in\PoRi$ and $T:\PoRi\rightarrow\PoRi$ is defined by $\underbrace{Tp=q\circ p}_{composition},$ then $T$ is not linear.\vspace{-8pt}}
...
\ProblemN{\hypertarget{3A10}{10}}{
	...
	\TextNL{Provt $T$ is not a linear map on $V$.}
}Asm $T$ is a linear map. Sup $v\in V\Backslash U,\,\, u\in U$ suth $Su\neq 0$.\parSol{}
...
\ProblemN{\hypertarget{3A11}{11}}{
	...
	\TextNL{Provt $\exists\,T\in\Lm{V,W},Tu = Su,\forall u\in U$. {\large\tgnr\envFontDefault\BigPar{ \Or $\exists\,T\in\Lm{V,W},T\mmid_U=S.$ }}}
	\TextNL{\large In other words, every linear map on a subsp of $V$ can be {\tgsc extended} to a linear map on the entire $V$.}
}Sup $W$ is suth $V=U\oplus W.$ Then $\forall v\in V,\exists\,!\,u_v\in U,w_v\in W,v=u_v+w_v.$\parSol{}
Define $T\in\Lm{V,W}$ by $T\Par{u_v+w_v}=Su_v.$\PfEnd\parSol{\vspace{2pt}}
\Or \Sbra[3pt]{{\tgsl Finid Req}} \;Define by $T\XPar{\sum_{i=1}^m a_i u_i}=\sum_{i=1}^n a_i Su_i.$ Let $B_V=\Par{\overbrace{u_1,\dots,u_n}^{B_U},\dots,u_m}.$\PfEnd
\SepLine

\ProblemN{\hypertarget{3A12}{12}}{
	\TextNL{Sup nonzero $V$ is finide and $W$ is infinide. Provt $\Lm{V,W}$ is infinide.}
...
{Now we shat $\Par{v_1,\dots,v_n}$ is linely inde. Sup {$\exists\,a_i\in\Fbb,a_1 v_1+\dots+a_n v_n=0$}.}\vspace{2pt}\par\quad
...
\ProblemBnoor{\hypertarget{3A4e17}{4E 17}}{
	\TextB{Sup $V$ is finide. Shat all two-sided ideals of $\Lm{V}$ are $\zeroSubs$ and $\Lm{V}$.}
...
\ProblemBnoor{\hypertarget{3B4e32}{4E 3.B.32}}{
	\TextB{Sup $V$ is finide with $n=\dim V > 1$.}
	\TextB{Shat if $\varphi:\Lm{V}\rightarrow\Fbb$ is linear and $\forall S,T\in\Lm{V},\varphi\Par{ST} = \varphi\Par{S}\cdot\varphi\Par{T}$, then $\varphi = 0$.}
...
\ProblemB{
	\hypertarget{3A4e11}{}\TextB{Sup $V$ is finide. $T\in\Lm{V}$ is suth $\forall S\in\Lm{V},ST=TS$.}
	\TextB{Provt $\exists\,\lambda\in\Fbb,T=\lambda I$.}
...
To provt $\lambda_v$ is independent of $v$, we discuss in two cases:\vspace{4pt}\par\hspace{1pt}
$\MathRightBrace{l}{$
	...
	($=$) Othws, sup $w=cv$, $\lambda_w w=Tw=cTv=c\lambda_v v=\lambda_v w\Rightarrow\Par{\lambda_w-\lambda_v}w$
...
\ProblemB{
	\TipsN{3}\,\,\,\TextB{Sup $T\in\Lm{V,W}.$ Provt $Tv\neq 0\Rightarrow v\neq 0.$}
...
%\ProblemN{2}{
%	\TextN{Sup $S,T\in\Lm{V}$ are suth $\range S\subseteq\null T$. Provt $(ST)^2=0$.}
...
\ProblemN[]{\hypertarget{3B3}{3}}{
	...
	(b) \TextN{The inje of $T$ corres to $\Par{v_1,\dots,v_m}$ being linely inde.\hfill\large\envFontDefault $\Par{v_1,\dots,v_m}$ linely inde $\Longleftrightarrow T$ inje.}
}
\Comment \,\,\,Let $\Par{e_1,\dots,e_m}$ be std basis of $\Fbb^m.$ Then $T{e_k}=v_k.$
\SepLine

\ProblemN{\hypertarget{3B7}{7}}{
	\TextN{Sup $V$ is finide with $2\leqslant\dim V.$ And $\dim V\leqslant\dim W=m$, if $W$ is finide.}
	\TextN{Shat $U=\Bra{\,T\in\Lm{V,W}:\null T\neq\envFontDefault\zeroSubs\envFontLarge}$ is not a subsp of $\Lm{V,W}$.}
...
\ProblemN{\hypertarget{3B8}{8}}{
	\TextN{Sup $W$ is finide with $\dim W\geqslant 2.$ And $n=\dim V\geqslant\dim W$, if $V$ is finide.}
	\TextN{Shat $U=\Bra{\,T\in\Lm{V,W}:\range T\neq W}$ is not a subsp of $\Lm{V,W}$.}
...
\ProblemN{\hypertarget{3B9}{9}}{
	\TextN{Sup $\Par{v_1,\dots,v_n}$ is linely inde. Provt $\forall$ inje $T,\Par{Tv_1,\dots,Tv_n}$ is linely inde.}
...
\ProblemN{\hypertarget{3B10}{10}} {
	\TextNL{Sup $\Span{v_1,\dots,v_n}=V$. Shat $\Span{Tv_1,\dots,Tv_n}=\range T$.}
...
%\ProblemN{\hypertarget{3B11}{11}}{
	%	\TextNL{Sup $S_1,\dots,S_n$ are linear and inje. $S_1 S_2\cdots S_n$ makes sense. Provt $S_1 S_2\dots S_n$ is inje.}
...
\ProblemN{\hypertarget{3B16}{16}}{
	\TextNL{Sup $T\in\Lm{V}$ suth $\null T,\range T$ are finide. Provt $V$ is finide.}
...
\ProblemN{\hypertarget{3B17}{17}}{
	\TextNL{Sup $V,W$ are finide. Provt $\exists$ inje $T\in\Lm{V,W}\Longleftrightarrow\dim V\leqslant\dim W$.}
...
\ProblemN{\hypertarget{3B18}{18}}{
	\TextNL{Sup $V,W$ are finide. Provt $\exists$ surj $T\in\Lm{V,W}\Longleftrightarrow\dim V\geqslant\dim W$.}
...
\ProblemB{
	...
	{\IndentTipsN{2}}(a) \TextB{Shat if $U=X\oplus Y,$ then $\range T=\range T\mmid_X\oplus\range T\mmid_Y.$\vspace{1pt}}
...
\ProblemN{\hypertarget{3B12}{12}}{
	\TextNL{Provt $\forall T\in\Lm{V,W},\exists$ subsp $U$ of $V$ suth}
	\TextNL{{\large$U\,\cap\,\null T$}$\,=\null T\mmid_U=\zeroSubs,\;\range T=\,${\large\envFontDefault$\Bra{Tu:u\in U}$}$\,=\range T\mmid_U.$}
	\TextNL{\envFontDefault\large Which is equivalent to $T\mmid_U:U\rightarrow\range T$ being iso.}
...
We have shown $Q\Rightarrow P.$ Now we shat $P\Rightarrow Q$ to complete the proof.\parCor
...
\BulletPointX\TipsN{3}\,\,\,{Sup $T\in\Lm{V,W}$ and $U$ is a subsp suth $V=U\oplus\null T.$ Let $\null T=X\oplus Y.$}\TextB{}
...
By (3.A.4), $R=\Par{v_1,\dots,v_n}$ is linely inde in $V.$ Let $\Spn R=U.$ We will provt $U\oplus\null T=V.$\TextB{\vspace{2pt}}
...
%\ProblemB{
%	\TextB{Sup $V$ is finide, $T\in\Lm{V,W},B_{\range T}=\BigPar{Tv_1,\dots,Tv_n},B_V=\BigPar{v_1,\dots,v_n,u_1,\dots,u_m}$.\vspace{3pt}}
...
\ProblemBnoor{\hypertarget{3B4e27}{4E 27}, \OR 5.B.4}[\Sbra]{
	\TextB{Sup $P\in\Lm{V}$ and $P^2 = P$. Provt $V=\null P\oplus\range P$.\vspace{0pt}}
...
\Or \Sbra[3pt]{{\tgsl Only in Finid}} \;Let $B_{\range P^2}=\Par{P^2 v_1,\dots,P^2 v_n}.$ Then $\Par{Pv_1,\dots,Pv_n}$ is linely inde.\par\quad
Let $U=\Span{Pv_1,\dots,Pv_n}\Rightarrow V=U\oplus\null P^2.$ \;While $U=\range P=\range P^2;\;\;\null P=\null P^2.$\PfEnd
\SepLine

\ProblemB{
	\TextB{Sup $T\in\Lm{V},v\in V,$ and $n\in\Nbp$ suth $T^{n-1}v\neq 0,\;T^nv=0.$\qquad\large\envFontDefault\tgnr\Sbra{See [5.16]}}
	\TextB{Provt $\BigPar{v,Tv,\dots,T^{n-1}v}$ is linely inde.}
...
\ProblemBnoor{\hypertarget{3B4e21}{4E 21}}{
	\TextB{Sup $V$ is finide, $T\in\Lm{V,W},$ $Y$ is a subsp of $W$. Let $\Bra{v\in V: Tv\in Y}.$\vspace{1.5pt}}
	(a) \TextB{Provt $\Bra{v\in V: Tv\in Y}$ is a subsp of $V.$\vspace{1.5pt}}
	(b) \TextB{Provt $\Dim\Bra{v\in V: Tv\in Y}=\dim\null T +\Dim\BigPar{Y\cap\range T}.$}
...
\ProblemBnoor{\hypertarget{3B4e31}{4E 31}}{
	\TextB{Sup $V$ is finide, $X$ is a subsp of $V$, and $Y$ is a finide subsp of $W$.}
	\TextB{Provt if $\dim X + \dim Y = \dim V$, then $\exists\,T\in\Lm{V,W},\null T = X,\range T = Y$.}
...
%\ProblemN{\hypertarget{3B31}{31}}{
	%	\TextNL{Provt $\exists\,T_1,T_2\in\Lm{\Rbb^5,\Rbb^2},\null T_1=\null T_2$ and $T_1\neq cT_2,\forall c\in\Fbb$.}
...
%\ProblemB{
%	\TipsN{5}\,\,\,\TextB{Sup $U,V$ are finide, $S\in\Lm{V,W},T\in\Lm{U,V}.$ Shat}
...
\ProblemN{\hypertarget{3B22}{22}}{
	\TextNL{Sup $U,V$ are finide, $S\in\Lm{V,W},T\in\Lm{U,V}$.}
	\TextNL{Provt $\dim \null ST\leqslant\dim\null S+\dim\null T$.\vspace{2pt}}
...
\ProblemN{\hypertarget{3B23}{23}}{
	\TextNL{Sup $V$ is finide, $S\in\Lm{V,W},T\in\Lm{U,V}$.}
	\TextNL{Provt $\dim\range ST\leqslant\min\!\Bra{\dim \range S, \dim\range T}$.}
...
\ProblemB{
	%(a) \TextB{Sup $\dim V = 5,$ and $ST = 0$ where $S,T\in\Lm{V}$. Provt $\dim\range TS\leqslant 2.$\vspace{2pt}}
	\hypertarget{3B4e24}{}(a) \TextB{Sup $\dim V=n,$ \,$ST=0$ where $S,T\in\Lm{V}.$ Provt $\dim\range TS\leqslant\Big\lfloor${\LARGE$\frac{\,n\,}{2}$}$\Big\rfloor.$}
...
%We shat $\dim\range TS\leqslant 2$ by ctradic. Asm $\dim\range TS\geqslant 3$.\par\quad\Ha
...
\ProblemN{\hypertarget{3B26}{26}}{
	\TextNL{Sup $D\in\Lm[\BigPar]{\PoRi}$ and $\forall p,\Deg\BigPar{Dp}=\Par{\!\deg p}-1.$ \;Provt $D\in\PoRi$ is surj.\vspace{2pt}}
...
(ii) {Sup we have defined $Dp_0=1,Dp_k=x^k$ for each $k\in\Bra{1,\dots,n}.$ Becs $\deg D\Par{x^{n+2}}=n+1.$}\vspace{2pt}\par\quad\Hii
...
\ProblemN{\hypertarget{3B20}{}\hypertarget{3B21}{20, 21}}{
	(a) \Text{Provt if $ST=I\in\Lm{V},$ then $T$ is inje and $S$ is surj.}
	\Blind{\Onumber{20, 21} }(b) \Text{Sup $T\in\Lm{V,W}.$ Provt if $T$ is inje, then $\exists\,S\in\Lm{W,V},\;ST=I$.}
	\Blind{\Onumber{20, 21} }(c) \Text{Sup $S\in\Lm{W,V}.$ Provt if $S$ is surj, then $\exists\,T\in\Lm{V,W},\;ST=I.$\vspace{2pt}}
}\par\quad
...
\Or \Sbra[3pt]{{\tgsl Req $V$ Finid}} \;Let $B_{\range T}=\Par{Tv_1,\dots,Tv_n}\Rightarrow B_V=\Par{v_1,\dots,v_n}.$ Let $U\oplus\range T=W$.\par\quad\Hb
...
\Or \Sbra[3pt]{{\tgsl Req $V$ Finid}} \;Let $B_{\range S}=B_{V}=\Par{Sw_1,\dots,Sw_n}\Rightarrow\Span{w_1,\dots,w_n}\oplus\null S=W.$\par\quad\Hc
...
\ProblemN{\hypertarget{3B24}{24}}{
	\TextNL{Sup $S, T\in\Lm{V,W},$ and $\null S\subseteq\null T.$ Provt $\exists\,E\in\Lm{W},T=ES$.}
}\par\quad
...
\Or \Sbra[3pt]{{\tgsl Req $\range S$ Finid}} \;Let $B_{\range S}=\Par{Sv_1,\dots,Sv_n}$. Then \uline{$V=\Span{v_1,\dots,v_n}\oplus\null S$.}\par\quad
...
\Corollary \,\,\,\Sbra[3pt]{{\tgsl Req $W$ Finid}} \;Sup $\null S=\null T.$ We shat $\exists$ inv $E\in\Lm{W},T=ES.$\par\quad
...
\ProblemN{\hypertarget{3B25}{25}}{
	\TextNL{Sup $S, T\in\Lm{V,W},$ and $\range T\subseteq\range S.$ Provt $\exists\,E\in\Lm{V},T = SE$.}
}\par\quad
...
\Or \Sbra[3pt]{{\tgsl Req $\range T$ Finid}} \;Let $B_{\range T}=\Par{Tv_1,\dots,Tv_n}.$ Then \uline{$V=\Span{v_1,\dots,v_n}\oplus\null T.$}\par\quad
\uline{Let $S\Par{u_i}=Tv_i$ for each $Tv_i.$} \;Define $E$ by $Ev_i=u_i,Ex=0$ for all $x\in\null T$ and each $v_i.$\PfEnd\vspace{4pt}\quad
\Comment \,\,\,\Sbra[3pt]{{\tgsl Req $V$ Finid}} \;Note that $\dim U_2\leqslant\dim U_1\Longrightarrow\dim\null T=p\geqslant q=\dim\null S.$\parCom\quad
...
\Corollary \,\,\,\Sbra[3pt]{{\tgsl Req $V$ Finid}} \;If $\range T=\range S,$ then $\dim\null T=\dim\null S=p.$\parCor\quad
...
\ProblemN{\hypertarget{3B28}{28}}{
	...
	(a) \TextNL{Provt $\exists\,\varphi_1,\dots,\varphi_m\in\Lm{V,\Fbb}$ suth $\forall v\in V,Tv=\varphi_1\Par{v}w_1+\dots+\varphi_m\Par{v}w_m$.\vspace{2pt}}
	...
	\Blind{(b) {\envFontSmall\normalsize\Sbra{4E 3.F.5}}} \TextNL{Thus defining each $\varphi_i:V\rightarrow\Fbb.$ Shat each $\varphi_i\in\Lm{V,\Fbb}.$}
...
\ProblemN{\hypertarget{3B30}{30}}{
	\TextNL{Sup $\varphi,\beta\in\Lm{V,\Fbb}$ and $\null\varphi=\null\beta=\eta.$ Provt $\exists\,c\in\Fbb,\varphi=c\beta.$}
...
\Or We discuss in two cases. If $\null \beta=\null \varphi$, or if $\varphi=0,$ then we are done. Othws,\par\quad\Ha
...
\BulletPointX\NoteForSmall{Transpose}\;\;{\normalsize\envFontSmall\Sbra{\hypertarget{3F33}{3.F.33}}}\;Define $\fT:A\rightarrow A^t.$ By [3.111], $\fT$ is linear. Becs $\Par{A^t}{^t}=A.$ \TextB{}
...
Now we shat (a) \uline{$\fT\fR_j=\fC_j\fT,$} \,(b) \uline{$\fT\fC_k=\fR_k\fT,$} \,and (c) \uline{$\fT\fP_{j,k}=\fP_{k,j}\fT.$}\TextB{\vspace{2pt}}
...
\ProblemB{
	\hypertarget{3C4e16}{}\TextB{Sup $A\in\Fbb^{m,n}\nonzero.$ Provt [P] $\rank A=1\Longleftrightarrow\exists\,c_j,d_k\in\Fbb,$ each $A_{j,k}=c_j\cdot d_k.$ [Q]}
}\par\quad
...
%(a) Sup $T$ is inv, so is $T\apostrophe$. Becs $\BigPar{T\apostrophe\Par{\varphi_1},\dots,T\apostrophe\Par{\varphi_m}}$ is linely inde.\par\quad\Ha
...
\ProblemB{
	...
	\IndentTipsN{1}(a) \TextB{Shat [P] $L$ is linely inde $\Longleftrightarrow M$ is linely inde. [Q]\vspace{2pt}}
	\IndentTipsN{1}(b) \TextB{Shat [P] $\Spn L=W\Longleftrightarrow\Spn M=\Fbb^{m,1}.$ [Q]\hfill\large\envFontDefault\Sbra{ Let $A=\Mt{T,B_V,B_W}.$\hspace{1pt}}}
}\par\quad
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Sup $p$ is a poly of $\,n\,$ variables in $\Fbb.$ Provt $\Mt[\BigPar]{p\Par{T_1,\dots,T_n}}=p\BigPar{\Mt{T_1},\dots,\Mt{T_n}}.$}
	\IndentTipsN{2}\TextB{\large\envFontDefault Where the linear maps $T_1,\dots,T_n$ are suth $p\Par{T_1,\dots,T_n}$ makes sense. \tgnr See [5.16,17,20].}
...
\ProblemN{\hypertarget{3C13}{13}}{
	\TextNL{Provt the distr holds for matrix add and matrix multi.}
	\TextNL{\large\envFontDefault Sup $A, B, C$ are matrices suth $A\Par{B + C}$ make sense, we prove the left distr.}
...
%\ProblemN{\hypertarget{3C14}{14}}{
	%	\TextNL{Provt matrix multi is associ.}
	%	\TextNL{\large\envFontDefault Sup $A,B,C$ are matrices suth $\Par{AB}C$ makes sense, we provt $\Par{AB}C=A\Par{BC}.$}
	%}Sup $A\in\Fbb^{m,n}$ and $B,C\in\Fbb^{n,p}.$ We shat $LHS=\Sbra{\Par{AB}C}_{j,k}=\Sbra{A\Par{BC}}_{j,k}=RHS.$\parSol{}
...
%\ProblemN{\hypertarget{3C15}{15}}{
	%	\TextNL{Sup $A\in\Fbb^{n,n},j,k\in\Bra{1,\dots,n}$. Shat $\BigPar{A^3}_{j,k}=\sum_{p=1}^n \sum_{r=1}^n A_{j,p}A_{p,r}A_{r,k}$.\vspace{6pt}}
...
%\ProblemB{
	%	\hypertarget{3C12}{}\TextB{Provt the commutativity does not hold in $\Fbb^{m,n}.$}
...
\ProblemN{\hypertarget{3C1}{1}}{
	\TextN{Sup $T\in\Lm{V,W}.$ Shat for each pair of $B_V$ and $B_W,$}
...
\ProblemN{\hypertarget{3C6}{6}}{
	\TextN{Sup $V$ and $W$ are finide and $T\in\Lm{V,W}$.}
	\TextN{Provt $\dim\range T = 1\Longleftrightarrow\exists\,B_V,B_W,$ all ent of $A=\Mt[\BigPar]{T,B_V,B_W}$ equal $1$.}
}\par\quad
(a) Sup $B_V=\Par{v_1,\dots,v_n},B_W=\Par{w_1,\dots,w_m}$ are the bases suth all ent of $A$ equal $1$.\par\quad\Ha
Then $Tv_i=w_1+\dots+w_m$ for all $i=1,\dots,n$. Becs $w_1,\dots,w_n$ is linely inde, $w_1+\dots+w_n\neq 0.$\vspace{4pt}\par\quad
...
By \Sbra{2.C {\TIPS}}, $\exists$ a basis $\Par{u_1,\dots,u_n}$ of $V$ suth each $u_k\not\in\null T.$\par\quad\Hb
...
\ProblemN{\hypertarget{3C3}{3}}{
	\TextN{Sup $V$ and $W$ are finide and $T\in\Lm{V,W}$. Provt $\exists\,B_V,B_W$ suth}
...
\ProblemN{\hypertarget{3D2}{2}}{
	\TextN{Sup $V$ is finide and $\dim V > 1$.}
	\TextN{Provt the set $U$ of non-inv optors on $V$ is not a subsp of $\Lm{V}$.}
...
\ProblemB{
	\Tips \,\,\,\TextB{Sup $U\oplus X=W\oplus Y,$ and $X,Y$ are iso. Provt $U,W$ are iso.}
...
Surjectivity: $\forall w\in W,\pi\Par{w}=w\in\range\pi.$ \;Thus $\pi$ is iso of $U$ onto $W.$\PfEnd
\SepLine\pagebreak

\ProblemN{\hypertarget{3D3}{3}}{
	\TextN{Sup $V$ and $W$ are iso, $U$ is a subsp of $V$, and $S\in\Lm{U,W}.$}
	\TextN{Provt $\exists$ inv $T\in\Lm{V,W},Tu = Su,\forall u\in U$ $\Longleftrightarrow$ $S$ is inje. \hfill{\envFontDefault\large\Sbra{ See also (3.A.11). }}}\vspace{2pt}
...
\Or \Sbra[3pt]{{\tgsl Req $V$ Finid}} \;Let $B_U=\Par{u_1,\dots,u_m}.$ Then $S$ inje $\Rightarrow\Par{Su_1,\dots,Su_m}$ linely inde.\parSol{\Hb}
...
\ProblemN{\hypertarget{3D8}{8}}{
	\TextN{Sup $T\in\Lm{V,W}$ is {\tgsc surj}. Provt $\exists$ subsp $U$ of $V,$ \;$T\mmid_U:U\rightarrow W$ is iso.}
}By (3.B.12). Note that $\range T=W.$ \; \Or \Sbra[3pt]{{\tgsl Req $\range T$ Finid}} \;By \Sbra{3.B \TIPSN{4}}.\PfEnd
%\vspace{4pt}\Comment \,\,\,See (3.B.12), (4E 3.B.21), (3.B \TIPS).\vspace{-2pt}
\SepLine

\ProblemN{\hypertarget{3D18}{18}}{
	\TextNL{Shat $V$ and $\Lm{\Fbb, V}$ are iso vecsps.}
}\par\quad
...
%\ProblemB{
	%	\TextB{Provt [P] $\Par{v_1,\dots,v_m}$ is linely inde $\Longleftrightarrow\BigPar{\Psi\Par{v_1},\dots,\Psi\Par{v_m}}$ is linely inde. [Q]}
	%}\par\quad
...
%	\TextN{Sup $V$ is finide. If $\range S=\range T.$ Then $S=TE,\,\exists$ inv $E\in\Lm{V}$}
...
\ProblemN{\hypertarget{3D6}{6}}{
	\TextN{Sup $V$ and $W$ are finide. $\dim\null S=\dim\null T=n.$}
	\TextN{Provt $S=E_2 T E_1,\exists$ inv $ E_1\in\Lm{V}, E_2\in\Lm{W}.$}
...
\ProblemB{
	(a) \TextB{Sup $T=ES$ and $E\in\Lm{W}$ is inv. Provt $\null S=\null T.$\vspace{2pt}}
	(b) \TextB{Sup $T=SE$ and $E\in\Lm{V}$ is inv. Provt $\range S=\range T.$\vspace{2pt}}
...
\BulletPointX\NoteForSmall{[3.69]}\;\;Sup $V,W$ are finide and iso, $T\in\Lm{V,W}.$ Then $T$ inv $\Longleftrightarrow$ inje $\Longleftrightarrow$ surj.
\SepLine
...
\ProblemNnoor{\hypertarget{3D9}{9}}{\OR \hypertarget{3D1}{1}}{
	\TextN{Sup $U,V,W$ are iso and finide, $S\in\Lm{V,W},T\in\Lm{U,V}.$}
	\TextN{Provt $ST$ is inv $\Longleftrightarrow S,T$ are inv.}
...
\ProblemN{\hypertarget{3D13}{13}}{
	\TextNL{Sup $U,V,W,X$ are iso and finide, $R\in\Lm{W,X}, S\in\Lm{V,W}, T\in\Lm{U,V}.$}
	\TextNL{Sup $RST$ is surj. Provt $S$ is inje.}
...
%	\TextN{Sup $T\in\Lm{U,V},S\in\Lm{V,W}$ are inv. Provt $ST$ is inv and $\Par{ST}{^{-1}} = T^{-1}S^{-1}$.\vspace{8pt}}
...
\ProblemN{\hypertarget{3D10}{10}}{
	\TextN{Sup $V$ is finide and $S,T\in\Lm{V}.$ Provt $ST=I\Longleftrightarrow TS=I.$}
...
\ProblemN{\hypertarget{3D11}{11}}{
	\TextNL{Sup $V$ is finide, $S, T, U\in\Lm{V}$ and $STU = I$. Shat $T$ is inv and $T^{-1} = US$.}
}Using Exe (9) and (10). {\tgsl\normalsize This result can fail without the hypothesis that $V$ is finide.}\parSol{}
...
\ProblemBnoor{4E 15}{
	\hypertarget{3D4e15}{}\TextB{Sup $T\in\Lm{V}$ and $V=\Span{Tv_1,\dots,Tv_m}$. Provt $V=\Span{v_1,\dots,v_m}$.}
...
\ProblemN{\hypertarget{3D15}{15}}{
	\TextNL{Provt every linear map from $\Fbb^{n,1}$ to $\Fbb^{m,1}$ is given by a matrix multi.}
	\TextNL{In other words, provt if $T\in\Lm{\Fbb^{n,1},\Fbb^{m,1}}$, then $\exists\,A\in\Fbb^{m,n},Tx = Ax,\,\forall x\in\Fbb^{n,1}$.}
}Let $B_1=\Par{E_1,\dots,E_n},B_2=\Par{R_1,\dots,R_m}$ be std bases of $\Fbb^{n,1},\Fbb^{m,1}$.\vspace{-12pt}\parSol{}
...
\ProblemBnoor{4E 23, \OR \hypertarget{3D4e23}{10.A.4}}{
	...
	\TextB{Let $T\in\Lm{V}$ be suth each $T\alpha_k = \beta_k.$ Provt $\Mt{T,\alpha\rightarrow\alpha}=\Mt{I,\beta\rightarrow\alpha}.$}
...
\ProblemBnoor{4E 22, \OR \hypertarget{3D4e22}{10.A.1}}{
	\TextB{Sup $T\in\Lm{V}.$ Provt $\Mt{T,B_V}$ is inv $\Longleftrightarrow T$ itself is inv.}
...
\ProblemBnoor{4E 24, \OR \hypertarget{3D4e24}{10.A.2}}{
	\TextNL{Sup $A,B\in\Fbb^{n,n}$. Provt $AB = I\Longleftrightarrow BA=I.$\hfill\small\envFontSmall\Sbra{Using Exe (10, 15).}}
...
\ProblemN{\hypertarget{3D17}{17}}{
	\TextNL{Sup $V$ is finide. Shat the only two-sided ideals of $\Lm{V}$ are $\zeroSubs$ and $\Lm{V}$.}
...
\ProblemBnoor{4E 10}{
	\hypertarget{3D4e10}{}\TextB{Sup $V,W$ are finide, $U$ is a subsp of $V$.\vspace{3pt}}
	\TextB{Let $\mathcal{E} = \Bra{T\in\Lm{V,W}: U\subseteq\null T}=\Bra{T\in\Lm{V,W}:T\mmid_U=0}$.\vspace{2pt}}
	(a) \TextB{Shat $\mathcal{E}$ is a subsp of $\Lm{V,W}$.\vspace{1pt}}
...
\ProblemBnoor{4E 17}{
	\hypertarget{3D4e17}{}\TextB{Sup $V$ is finide and $S\in\Lm{V}$. Define $\mathcal{A}\in \Lm[\BigPar]{\Lm{V}}$ by $\mathcal{A}\Par{T} = ST$.}
	(a) \TextB{Shat $\dim\null \mathcal{A} = \Par{\!\dim V}\Par{\!\dim \null S}$.}
	(b) \TextB{Shat $\dim\range \mathcal{A} = \Par{\!\dim V}\Par{\!\dim \range S}$.}
...
\ProblemB{
	...
	(b) \TextB{Shat $\dim\range\mathcal{B}=\Par{\!\dim V}\Par{\!\dim\range S}.$}
}(a) %\Large\vspace{3pt}
...
\ProblemBnoor{\hypertarget{3D4e20}{4E 20}}{
	\TextB{Sup $q\in\PoRi.$ Provt $\exists\,p\in\PoRi,q\Par{x} = \Par{x^2 + x}p\apostrophe\apostrophe\Par{x} + 2xp\apostrophe\Par{x} + p\Par{3}.$\vspace{1pt}}
...
\ProblemN{\hypertarget{3D19}{19}}{
	...
	(a) \TextNL{Provt $T$ is surj;\quad {\large\tgnr(b)} Provt for every nonzero $p$, $\deg Tp=\deg p$.}
...
\ProblemN{\hypertarget{3D16}{16}}{
	\TextNL{Sup $V$ is finide and $S\in\Lm{V}$ suth $\forall T\in\Lm{V},ST=TS$. Provt $\exists\,\lambda\in\Fbb,S=\lambda I$.}
}If $S=0$, we are done. Now sup $S\neq 0.$\hfill\Sbra{Using nota in Exe (4E 17). See also in (3.A).}\par\quad
...
\ProblemBnoor{\hypertarget{3D4e19}{}10.A.3, \OR 4E 19}{
	\TextB{Sup $V$ is finide and $T\in\Lm{V}$.\large\envFontDefault\hfill\Sbra{See also in (3.A).}}
	\TextB{Provt $\forall B_V\neq B_V',\;\Mt[\BigPar]{T,B_V}=\Mt[\BigPar]{T,B'_V}\Longrightarrow T=\lambda{I},\exists\,\lambda\in\Fbb.$}
...
Now we shat $\lambda_v$ is independent of $v$, that is, for all disti $v,w\in V\nonzero,\lambda_v=\lambda_w.$\parSol{}
\!\!\!\!$\MathRightBrace{l}{
...
\ProblemN{\hypertarget{3E2}{2}}{
	\TextN{Sup $V_{\!1}\times\dots\times V_{\!m}$ is finide. Provt each $V_{\!j}$ is finide.}
}\par\quad
For any $k\in\Bra{1,\dots,m},$ define $S_k\in\Lm{V_{\!1}\times\dots\times V_{\!m},V_{\!k}}$ by $S_k\Par{v_1,\dots,v_m}=v_k.$\par\quad
Then $S_k$ is linear map. By [3.22], $\range S_k=V_{\!k}$ is finide.\PfEnd\vspace{6pt}\par\quad
...
We shat each $U_i$ is iso to $V_{\!i}.$ Then $U$ is finide $\Longrightarrow$ its subsp $U_i$ is  finide, so is $V_{\!i}.$\par\vspace{2pt}\quad
...
\ProblemN{\hypertarget{3E4}{4}}{
	\TextN{Provt $\Lm{V_{\!1}\times\cdots\times V_{\!m},W}$ and $\Lm{V_{\!1},W}\times\cdots\times\Lm{V_{\!m},W}$ are iso.}
...
\ProblemN{\hypertarget{3E5}{5}}{
	\TextN{Provt $\Lm{V,W_1\times\cdots\times W_m}$ and $\Lm{V,W_1}\times\cdots\times\Lm{V,W_m}$ are iso.}
...
\ProblemN{\hypertarget{3E6}{6}}{
	\TextN{For $m\in\Nbp,$ define $V^m$ by $\mathop{\underbrace{V\times\cdots\times V}}\limits_{m\,\,times}$. Provt $V^m$ and $\Lm{\Fbb^m,V}$ are iso.}
}\par\quad
...
(b) Sup $\psi\in\Lm{\Fbb^m,V}.$ Let $\Par{e_1,\dots,e_m}$ be std basis of $\Fbb^m$. Then $\forall\Par{b_1,\dots,b_n}\in\Fbb^m$,\vspace{3pt}\par\quad\Hb
...
And becs $\Par{v-\hat{v}}+\Par{w-\hat{w}}\in U$ and $\lambda\Par{v-\hat{v}}\in U$ asm $U$ is a subsp.\vspace{4pt}\parCom{\IndentB}
...
\ProblemBnoor{\hypertarget{3E4e8}{4E 8}}{
	\TextB{Sup $T\in\Lm{V,W},w\in\range T.$ Provt $\Bra{v\in V:Tv=w}=u+\null T.$}
...
\ProblemN{\hypertarget{3E7}{7}}{
	\TextN{Sup $v,x\in V,$ and $U,W$ are subsps of $V.$ Provt $v+U=x+W\Rightarrow U=W$.}
...
\ProblemN{\hypertarget{3E8}{8}}{
	...
	\TextN{Provt $A$ is a tslate of some subsp of $V$ $\Longleftrightarrow\lambda v+\Par{1-\lambda}w\in A\,\,,\forall v,w\in A,\lambda\in\Fbb.$}
}\par\quad
...
\ProblemN{\hypertarget{3E9}{9}}{
	...
	\TextN{Provt $A\cap B$ is either a tslate of some subsp of $V$ or is $\emptySet$.}
...
We shat $A\cap B=\alpha+\Par{U\cap W}.$ Note that $\alpha+\Par{U\cap W}\subseteq A\cap B.$\parSol{}
...
\ProblemN{\hypertarget{3E10}{10}}{
	\TextNL{Provt the intersec of any collec of tslates of subsps is either a tslate of some subsps or $\emptySet.$}
...
We shat $\bigcap_{\alpha\in\Gamma}A_\alpha=\bigcap_{\alpha\in\Gamma}\Par{x+V_{\!\alpha}}=x+\bigcap_{\alpha\in\Gamma}V_{\!\alpha}.$\parSol{}
...
\ProblemN{\hypertarget{3E11}{11}}{
	...
	(a) \TextNL{Provt $A$ is a tslate of some subsp of $V$}
	(b) \TextNL{Provt if $B$ is a tslate of some subsp of $V$ and $\Bra{v_1,\dots,v_m}\subseteq B$, then $A\subseteq B$.}
	(c) \TextNL{Provt $A$ is a tslate of some subsp of $V$ of dim less than $m.$\vspace{2pt}}
...
\Or Let $v=\lambda_1 v_1+\dots+\lambda_m v_m\in A$. To shat $v\in B$, use induction on $m$ by $k$.\par\quad\Hb
...
(ii) $2\leqslant k<m.$ Asm $v=\lambda_1 v_1+\dots+\lambda_k v_k\in A\subseteq B.\;\Sbra{\forall\lambda_i$ suth $\sum_{i=1}^k\lambda_i=1}$\par\quad\Hb\Hii
...
\ProblemN{\hypertarget{3E12}{12}}{
	\TextNL{Sup $U$ is a subsp of $V.$ Provt is $V$ is iso to $U\times\Par{V\XSlash U}$.}
}\par\quad
\!\Sbra[3pt]{{\tgsl Req $V\XSlash U$ Finid}} \;Let $B_{V\XSlash U}=\BigPar{v_1+U,\dots,v_n+U}.$\par\quad
...
\ProblemBnoor{\hypertarget{3E4e14}{4E 14}}{
	\TextB{Sup $V=U\oplus W,\;B_W=\Par{w_1,\dots,w_m}.$ Provt $B_{V\XSlash U}=\BigPar{w_1+U,\dots,w_m+U}.$\vspace{2pt}}
...
\ProblemN{\hypertarget{3E13}{13}}{
	\TextNL{Provt $B_{V\XSlash U}=\BigPar{v_1+U,\dots,v_m+U},B_U=\Par{u_1,\dots,u_n}\Rightarrow B_V=\BigPar{v_1,\dots,v_m,u_1,\dots,u_n}.$\vspace{2pt}}
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Sup $U,W$ are subsps of $V.$ Let $I=U\cap W.$ Provt $V=U+W\Longleftrightarrow V\XSlash I=U\XSlash I\oplus W\XSlash I.$}
...
\ProblemB{
	...
	\IndentTipsN{3}\TextB{Sup $S_V I=\Pure V\XSlash I,$ simlr for $S_V U,S_U I.$ \;Provt $S_V I=S_V U\oplus S_U I.$}
...
\ProblemN{\hypertarget{3E16}{16}}{
	\TextNL{Sup $\dim V\XSlash U=1$. Provt $\exists\,\varphi\in\Lm{V,\Fbb},\null\varphi=U.$}
...
\ProblemN{\hypertarget{3E17}{17}}{
	\TextNL{Sup $V\XSlash U$ is finide, $W$ is a subsp of $V$.}
	(a) \TextNL{Shat if $V=U+W$, then $\dim W\geqslant\dim V\XSlash U$.}
	(b) \TextNL{Shat $\exists\,W\in\mathcal{S}_{\!V} U,\dim W=\dim V\XSlash U.$}
...
\ProblemN{\hypertarget{3E18}{18}}{
	\TextNL{Sup $T\in\Lm{V,W}$ and $U$ is a subsp of $V.$ Let $\pi:V\rightarrow V\XSlash U$ be the quot map.}
	\TextNL{Provt $\exists\,S\in\Lm{V\XSlash U,W},T=S\circ\pi\Longleftrightarrow U\subseteq\null T$.}
}\par\quad
...
\ProblemN{\hypertarget{3E14}{14}}{
	...
	(a) \TextNL{Shat $U$ is a subsp of $\Fbb^{\infty}$. {\large\envFontDefault\Sbra{Do it in your mind}} \;\; {\tgnr\large(b)} Provt $\Fbb^{\infty}\XSlash[-3pt]U$ is infinide.}
...
Sup $u=\Par{x_1,\cdots,x_L,{0,\cdots}},$ where $L$ is the largest suth $u\Sbra{L}\neq 0.$\vspace{2pt}\par\quad
...
\Or \Sbra[3pt]{{\tgsl Req $V$ Finid}} \;By [3.106], $\dim U^0=\dim V-\dim U>0.$\parSol{}
...
\ProblemN{\hypertarget{3F20}{20}}{
	\TextNL{Sup $U,W$ are nonempty subsets of $V$. Provt $U\subseteq W\Rightarrow W^0\subseteq U^0.$}
...
\ProblemN{\hypertarget{3F21}{21}}{
	\TextNL{Sup $U,W$ are subsps of $V$. Provt $W^0\subseteq U^0\Rightarrow U\subseteq W.$}
...
\ProblemN{\hypertarget{3F22}{22}}{
	\TextNL{Sup $U$ and $W$ are subsps of $V$. Provt $\BigPar{U+W}{^0}=U^0\cap W^0$.}
}\vspace{-14pt}\parSol{}
\!\!\!$\hText{$
...
\ProblemN{\hypertarget{3F23}{23}}{
	\TextNL{Sup $U$ and $W$ are subsps of $V$. Provt $\BigPar{U\cap W}{^0}=U^0+W^0$.}
}\vspace{2pt}\par\quad
\!\!\!$\hText{$
...
(b) \!\Sbra[3pt]{{\tgsl Only in Finid; Req $U,W$ Subsps}} \;Using Exe (22).\par\vspace{2pt}\quad\Hb
...
%Now we shat $X\cap Y=I.$ So that $\BigPar{U\cap W}{^0}=I^0=\BigPar{X\cap Y}{^0}=X^0+Y^0=U^0+W^0.$\parCom
...
\ProblemB{
	\TipsN{1}\,\,\,(a) \TextB{Provt $V=U\oplus W\Longleftrightarrow V\apostrophe=U^0\oplus W^0.$\vspace{1pt}}
	\IndentTipsN{1}(b) \TextB{Sup $U\oplus W=V.$ Provt $U^0=\Bra{\varphi\in V\apostrophe:\varphi=\varphi\circ\iota},$}
...
\ProblemN{\hypertarget{3F31}{31}}{
	\TextNL{Sup $U$ is a subsp of $V.$ \;Let $B_{U_V\upapostrophe}=\Par{\varphi_1,\dots,\varphi_n}.$ Shat corres $B_U$ exists.}
...
\ProblemB{
	\TipsN{3}\,\,\,\TextB{Let $\Omega=\Span{\varphi_1,\dots,\varphi_m}\subseteq V\apostrophe.$ Provt {\tgnr\large(a)} $\Omega=\BigPar{\null_I}{^0};\;$ {\tgnr\large(b)} $\Omega=\BigPar{\null_C}{^0}.$}
...
%Thus $V=\Theta\oplus\null_C\oplus\Span{w}=\Delta\oplus\null_C\oplus\Span{v}.$ Now we shat $\psi\in\Omega.$\par\quad
%\PfEnd\vspace{6pt}
...
\ProblemN{24}{
	\TextNL{Sup $V$ is finide and $U$ is a subsp of $V$.}
...
(I)
%Sup for each $\varphi_k,$ let $\mathcal{K}_k$ be suth $V=\mathcal{K}_k\oplus\null\varphi_k.$ By (3.B.29), this $\mathcal{K}_k$ can be $\Span{v_k}.$\parSol{\HI}
...
\ProblemB{
	...
	\ProblemN[]{\hypertarget{3F29}{29}}{
		\TextNL{Provt $\range T\apostrophe=\Span{\varphi_1,\dots,\varphi_m}\Longleftrightarrow\null T=\Par{\null\varphi_1}\cap\cdots\cap\Par{\null\varphi_m}.$}}
	\TextB{\vspace{-4pt}}
...
\ProblemN[]{\hypertarget{3F13}{13}}{
	...
	\TextNL{Let $\Par{\varphi_1,\varphi_2},\Par{\psi_1,\psi_2,\psi_3}$ denote the dual basis of std basis of $\Rbb^2$ and $\Rbb^3$.\vspace{4pt}}
...
\Hc Let $\Par{e_1-2e_2+e_3,-2e_2,e_3}$ be a basis, with corres dual basis $\Par{\varepsilon_1,\varepsilon_2,\varepsilon_3}$.\vspace{1.5pt}\TextNL{}
...
%We shat ${U^0}=\Span{\varphi_{m+1},\dots,\varphi_n}.$ So that $\dim U^0=n-m=\dim V-\dim U.$\par\quad
...
\ProblemN{\hypertarget{3F37}{37}}{
	\TextNL{Sup $U$ is a subsp of $V$ and $\pi$ is the quot map. Thus $\pi\apostrophe\in\Lm[\BigPar]{\Par{V\XSlash U}\apostrophe,V\apostrophe}$.\vspace{2pt}}
	(a) \TextNL{Shat $\pi\apostrophe$ is inje\hspace{1pt}$:${\tgnr\large\envFontDefault\;\;Becs $\pi$ is surj. Use [3.108].}\vspace{2pt}}
	(b) \TextNL{Shat $\range \pi\apostrophe=U^0$\hspace{1pt}$:${\tgnr\large\envFontDefault\;\;By {\tgnr[3.109](b)}, $\range\pi\apostrophe=\BigPar{\null\pi}{^0}=U^0.$}\vspace{2pt}}
...
\ProblemB{
	\TextB{Sup $U$ is a subsp of $V.$ Provt $\Par{V\XSlash U}\apostrophe$ is iso to $U^0.$ \hfill\Sbra[3pt]{{\large\tgsc Another proof of \tgbfx[3.106]}}}
}\par\quad
...
We shat $\xi$ is inje and surj.\par\quad
...
\ProblemB{
	...
	(b) \TextB{Provt $\range\iota\apostrophe=W_V^0$\hspace{1pt}$:${\tgnr\large\envFontDefault\;\;$\range\iota\apostrophe=\BigPar{\null\iota}{^0_V}=W_V^0.$}\vspace{2pt}}
	(c) \TextB{Provt $\tilde{\iota\apostrophe}$ is iso from $U\apostrophe\XSlash{\envFontDefault\zeroSubs}$ onto $W^0$\hspace{1pt}$:${\tgnr\large\envFontDefault\;\;By (a), (b) and [3.91](d).}}
}\par\quad
...
\ProblemN{\hypertarget{3F36}{36}}{
	...
	(b) \TextNL{Provt $\range i\apostrophe=U\apostrophe$\hspace{1pt}$:${\tgnr\large\envFontDefault\;\;$\range i\apostrophe=\Par{\null i}{_U^0}={\zeroSubs}{_U^0}=U\apostrophe$.}\vspace{2pt}}
	(c) \TextNL{Provt $\tilde{i\apostrophe}$ is iso from $V\apostrophe\XSlash U^0$ onto $U\apostrophe$\hspace{1pt}$:${\tgnr\large\envFontDefault\;\;By (a), (b) and [3.91](d).}\vspace{2pt}}
}\par\quad
...
\ProblemN{\hypertarget{3F15}{15}}{
	\TextNL{Sup $T\in\Lm{V,W}$. Provt $T\apostrophe=0\Longleftrightarrow T=0.$}
}\par\quad
...
Now we provt if $\forall\varphi\in W\apostrophe,\varphi\Par{w}=0,$ then $w=0.$ So that $\range T=\zeroSubs$ and we are done.\par\quad
...
\ProblemN{\hypertarget{3F16}{16}}{
	\TextNL{Sup $V,W$ are finide. Define $\Gamma$ by $\Gamma\Par{T}=T\apostrophe$ for any $T\in\Lm{V,W}$.}
	\TextNL{Provt $\Gamma$ is iso of $\Lm{V,W}$ onto $\Lm{W\apostrophe,V\apostrophe}$.}
...
%Sup $\mathcal{T}\in\Lm{W\apostrophe,V\apostrophe}.$ Let $B_{\range\mathcal{T}}=\Par{\varphi_1,\dots,\varphi_p}.$ Let $\psi_k$ be suth $\mathcal{T}\Par{\psi_k}=\varphi_k$ for each $\varphi_k.$\par\quad
%Let $B_{V\apostrophe}=\Par{\varphi_1,,\dots,\varphi_p,\dots,\varphi_n}.$ By Exe (31), let corres $B_V=\Par{v_1,\dots,v_p,\dots,v_n}.$\par\quad
%Let $\Par{\psi_1,\dots,\psi_p}$ be linely inde in $W\apostrophe,$ and let $\Par{w_1,\dots,w_p}$ be corres basis of $\Span{\psi_1,\dots,\psi_p}.$\par\quad
...
{\tgsl Now we shat $\Gamma\mmid_X$ is surj without the cond that $V$ or $W$ is finide.}\par\quad
Sup $\mathcal{T}\in Y.$ Let $B_{\range\mathcal{T}}=\Par{\varphi_1,\dots,\varphi_m},$ with corres $\Par{v_1,\dots,v_m}.$ Let $\varphi_k=\mathcal{T}\Par{\psi_k}.$\par\quad
...
\ProblemN[]{\hypertarget{3F5}{5}}{
	\TextN{Provt $\Par{V_{\!1}\times\dots\times V_{\!m}}\apostrophe$ and $V\apostrophe_1 \times\dots\times V\apostrophe_m$ are iso.\hfill\Sbra[3pt]{{\large\tgnr Using notas in (3.E.2).}}}\vspace{4pt}
}
$\MathRightBrace{l}{$
...
\ProblemN{\hypertarget{3F4e24}{}\hypertarget{3F6}{6}}{
	...
	(a) \TextN{Shat $\Span{v_1,\dots,v_m}=V\,\Longleftrightarrow \Gamma$ is inje.}
	(b) \TextN{Shat $\Par{v_1,\dots,v_m}$ is linely inde $\Longleftrightarrow \Gamma$ is surj.}
}\par\quad
...
(b) Sup $\Gamma$ is surj. Then let $\Gamma\Par{\varphi_i}=e_i$ for each $i$, where $\Par{e_1,\dots,e_m}$ is std basis of $\Fbb^m$.\par\quad\Hb
...
\Or Let $\Par{e_1,\dots,e_m}$ be std basis of $\Fbb^m$ and let $\Par{\psi_1,\dots,\psi_m}$ be corres dual basis.\par\quad
...
\ProblemBnoor{\hypertarget{3F4e25}{4E 25}}{
	...
	(c) \TextB{Shat $\Span{\varphi_1,\dots,\varphi_m}=V\apostrophe\,\Longleftrightarrow \Gamma$ is inje.}
	(d) \TextB{Shat $\Par{\varphi_1,\dots,\varphi_m}$ is linely inde $\Longleftrightarrow \Gamma$ is surj.}
}\par\quad
...
Sup $\Gamma$ is surj. Let $\Par{e_1,\dots,e_m}$ be std basis of $\Fbb^m$.\par\quad\Hd
Sup $v_i\in V$ suth $\Gamma\Par{v_i}=\Par{\varphi_1\Par{v_i},\dots,\varphi_m\Par{v_i}}=e_i,$ for each $i.$\par\quad\Hd
...
(d) the surj of $\Phi$ corres to $\Par{\varphi_1,\dots,\varphi_m}$ being linely inde;\; 又 $\Phi=\Psi\circ\Gamma$ surj $\Longleftrightarrow\Gamma$ surj.\PfEnd
\SepLine

\ProblemN{\hypertarget{3F35}{35}}{
	\TextNL{Provt $\BigPar{\PoFi}\apostrophe$ is iso to $\Fbb^{\infty}.$}
}\par\quad
...
\ProblemN{\hypertarget{3F7}{7}}{
	\TextN{Shat the dual basis of $\Par{1, x,\dots,x^m}$ of $\PoR{m}$ is $\Par{\varphi_0,\varphi_1,\dots,\varphi_m}$, where {\large\envFontDefault $\varphi_k\Par{p}=\Frac{p^{\SmallPar{k}}\Par{0}}{k!}$.}\vspace{2pt}}
...
\ProblemN{\hypertarget{3F34}{34}}{
	...
	(a) \TextNL{Shat $\Lambda$ is a linear map from $V$ to $V\apostrophe\apostrophe$.\vspace{2pt}}
	(b) \TextNL{Shat if $T\in\Lm{V}$, then $T\apostrophe\apostrophe\circ\Lambda=\Lambda\circ T$, where $T\apostrophe\apostrophe=\Par{T\apostrophe}\apostrophe$.\vspace{2pt}}
	(c) \TextNL{Shat if $V$ is finide, then {\tgsc $\Lambda$ is iso from $V$ onto $V$\hspace{1pt}$\apostrophe\apostrophe$}.\vspace{2pt}}
	\TextNL{\normalsize Sup $V$ is finide. Then $V$ and $V\apostrophe$ are iso, and finding iso from $V$ onto $V\apostrophe$ generally requires choosing\vspace{-2pt}}
