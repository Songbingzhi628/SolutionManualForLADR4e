...
\ProblemBnoor{\hypertarget{3C4e17}4E 3.C.17, \OR 3.F.32}[\Sbra]{
	...
	\TextB{{\tgnr\large(a)} $T$ is inje$;$ \; {\tgnr\large(b)} $\BigPar{A_{\cdot,1},\dots,A_{\cdot,n}}$ is a basis of \,$\Fbb^{n,1};$ \; {\tgnr\large(c)} $\BigPar{A_{1,\cdot},\dots,A_{n,\cdot}}$ is a basis of \,$\Fbb^{1,n}.$\vspace{2pt}}
}\vspace{-5pt}\AlignEq{}{&\qquad\hspace{1pt} T \text{ is inje } \Longleftrightarrow\dim V=\dim\range T=n\\[-2pt]
...
}Using \Sbra{3.B \TIPSN{4}}. Let $B_{\range T}=\Par{Tv_1,\dots,Tv_n},B_V=\Par{v_1,\dots,v_n,u_1,\dots,u_m}.$\PfEnd
\SepLine
...
(a) \,$T^{-1}T=TT^{-1}=I\Rightarrow\Mt{T^{-1}}\Mt{T}=\Mt{T}\Mt{T^{-1}}=I\Rightarrow\Mt{T^{-1}}=\Mt{T}{^{-1}}.$\vspace{2pt}\par\quad
...
Let $B_{\range T}=B_W=\Par{Tv_1,\dots,Tv_m},B_U=\Par{v_1,\dots,v_m}$.\par\quad
Then $\dim U=\dim W.$ Thus $T\mmid_U$ is an iso of $U$ onto $W.$\PfEnd\vspace{4pt}\quad
\Or By (3.B.12), there is a subsp $U$ of $V$ such that\par\quad
$U\cap \null T=\zeroSubs=\null T\mmid_U,\;W=\range T=\Bra{Tu:u\in U}=\range T\mmid_U.$\PfEnd
\Comment \,\,\,See (3.B.12), (4E 3.B.21), (3.B \TIPS).
\SepLine
\pagebreak
