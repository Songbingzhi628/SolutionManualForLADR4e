...
\BulletPointX\NoteFor{{\tgsc liney indep sequence and }[2.34]}\;\;$“V=\Span{v_1,\dots,v_n,\dots}”$ is an invalid expression.\TextB{}
...
\Comment \,\,\,The base step and the induc step can be independent.\vspace{10pt}\par\quad
...
To prove $\lambda_v$ is independent of $v$, we discuss in two cases:\vspace{4pt}\par\hspace{1pt}
$\MathRightBrace{l}{$
...
(ii) Asum $\forall s\in\PoR{n},\deg s=\deg Ts.$ We show $\forall p\in\PoR{n+1},\deg Tp=\deg p$ by ctradic.\par\quad\Hii
Sups $\exists\,r\in\PoR{n+1},\;\deg Tr\leqslant n<n+1=\deg r.$ Then by (a), $\exists\,s\in\PoR{n},\;T\Par{s}=\Par{Tr}.$\par\quad\Hii
...
\ProblemBnoor{\hypertarget{3D4e19}{}10.A.3, \OR 4E 19}{
	\TextB{Sups $V$ is finide and $T\in\Lm{V}$.\large\envFontDefault\hfill\Sbra{See also in (3.A).}}
...
Now we show $\lambda_v$ is independent of $v$, that is, for all disti $v,w\in V\nonzero,\lambda_v=\lambda_w.$\parSol{}
\!\!\!\!$\MathRightBrace{l}{
...
\BulletPointX\NoteFor{[3.88, 3.90, 3.91]}\;\;{Sups $W\in\mathcal{S}_{\!V} U.$ Then $V\XSlash U$ is iso to $W.$}\TextB{}
...
}Sups $V_0\oplus U=V.$ Then $V_0$ is iso to $V\XSlash U.$ $\dim V_0=1.$\parSol{}
