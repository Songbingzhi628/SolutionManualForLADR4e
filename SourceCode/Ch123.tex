...
%\!$\hText{$Let \uline{$V=U\oplus\null S$}$\\$
%	\uline{$\Rightarrow S\mmid_{U}:U\rightarrow\range S$ is an iso.}$\\$
%	Extend $T\BigPar{S\mmid_{U}}{^{-1}}$ to $E\in\Lm{W}.}\hspace{-10pt}\small\left.\begin{tikzcd}
%	{\range T} & V \\[4pt] & {\range S}
...
$\hText{$\includegraphics[width=80pt]{diagram3B-2}$}\hText{$
...
\uline{Define $E=\Par{S\mmid_U}{^{-1}}T=\Par{S\mmid_U}{^{-1}}\Big|{_{\range T}}T\in\Lm{V,U}\subseteq\Lm{V}.$}\PfEnd\vspace{4pt}\quad
