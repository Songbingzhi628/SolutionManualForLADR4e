...
\Blind{$T$ is inje} $\Longleftrightarrow B_V=\Par{Tu_1,\dots,Tu_n}\overset{\Delta}{\Longleftrightarrow}B_{\Fbb^{n,1}}=\BigPar{A_{\cdot,1},\cdots,A_{\cdot,n}}\xLongleftrightarrow[\text{[2.42]}]{\rank} B_{\Fbb^{1,n}}=\BigPar{A_{1,\cdot},\cdots,A_{n,\cdot}}.$\par\vspace{2pt}\quad
\Comment \,\,\,$T\apostrophe$ is inv $\Longleftrightarrow B_{V\apostrophe}=\BigPar{T\apostrophe\Par{\psi_1},\dots,T\apostrophe\Par{\psi_n}}$\parCom\quad
\Blind{$T\apostrophe$ is inv }$\overset{\Delta}{\Longleftrightarrow}B_{\Fbb^{n,1}}={\envFontLarge\BigPar{\envFontDefault\Par{A^t}{_{\cdot,1}},\cdots,\Par{A^t}{_{\cdot,n}}\envFontLarge}}\xLongleftrightarrow{\text{[2.39]}} B_{\Fbb^{1,n}}=\XPar{\BigPar{\Par{A^t}{_{\cdot,1}}}{^t},\cdots,\BigPar{\Par{A^t}{_{\cdot,n}}}{^t}}.$\par\vspace{4pt}\quad
Note that $\mathcal{M}\!:\,Tu_k\rightarrow A_{\cdot,k}$ is an iso of $V$ onto $\Fbb^{1,n}.$ Hence $\Delta$ holds.\PfEnd\vspace{4pt}\quad
