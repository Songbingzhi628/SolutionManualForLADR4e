...
\;\hspace{1pt}\Sbra[2pt]{{\tgsl Existns}} \;Let $x=\Frac{1}{3}\Par{w-v}.$\vspace{2pt}\par\quad
\Sbra[2pt]{{\tgsl Uniqnes}} \;Suppose $v+3x_1=w,$(I)$\,\,v+3x_2=w\,$(II). Then (I) $-$ (II) $: 3\Par{x_1-x_2}=0\Rightarrow x_1=x_2.$\vspace{4pt}\PfEnd\quad
...
But the key point is, how can we guarantee that such a $“$list$”$ exists. \colorbox{yellow}{TODO: More details.}%\TextB{}
%\TextB{}
\SepLine\ChEnd
...
\ProblemB[]{
	\Corollary \,\,\,\TextB{Suppose $W$ is finite-dim, $\dim W=m$ and $w\in W\nonzero.$}
	\IndentCorollary{}\TextB{Prove that $\exists\,B_W=\Par{w_1,\dots,w_m}$ such that $w=w_1+\dots+w_m.$\vspace{4pt}}
...
\Comment \,\,\,{\tgsl\Large$\dim\!\Par{V_1+\dots+V_m}=\dim V_1+\dots+\dim V_m\Longleftrightarrow V_1+\dots+V_m$ is a direct sum.}\parCom
For each $k$, $\Par{V_1+\dots+V_k}\cap V_{k+1}=\zeroSubs\Longleftrightarrow V_1+\dots+V_m$ is a direct sum\parCom
$\Longleftrightarrow\Par{\mathcal{E}_1\cap\dots\cap\mathcal{E}_{k-1}}\cap\mathcal{E}_k=\emptyset$ for each $k$ 又 $\dim\Span{\mathcal{E}_1\cup\dots\cup\mathcal{E}_m}=\card\Par{\mathcal{E}_1\cup\dots\cup\mathcal{E}_m}$\parCom
$\Longleftrightarrow\dim\Span{\mathcal{E}_1\cup\dots\cup\mathcal{E}_m}=\card\mathcal{E}_1+\dots+\card\mathcal{E}_m$\parCom
...
}Suppose $V_\Cbb$ is the complexification of a vecsp $V$. Suppose $\varphi:V_\Cbb\rightarrow V_\Cbb.$\parSol{}
...
\Blind{\Or \;}{\vspace{4pt}\hspace{-2.7pt}$\hMath{l}{\left.}{\right.}{$Then$\\[6pt]\;}$ {\Large$\hMath{r}{\left|}{\right\}}{A^{\SmallPar[1.5pt]{j,k}}Tv_j=TA^{\SmallPar[1.5pt]{j,k}}v_j=Tv_k=a_kv_k\\A^{\SmallPar[1.5pt]{j,k}}Tv_j=A^{\SmallPar[1.5pt]{j,k}}a_jv_j=a_jA^{\SmallPar[1.5pt]{j,k}}v_j=a_jv_k}\Rightarrow a_k=a_j.$}} {Hence $a_k$ is inde of $v_k.$}\PfEnd
\SepLine
...
\ChDecl{Ch3B}{3$\cdot$B}{}\orMode{\hLk{3B3}{3}\;\;\hLk{3B7}{7}\;\;\hLk{3B8}{8}\;\;\hLk{3B9}{9}\;\;\hLk{3B10}{10}\;\;\hLk{3B11}{11}\;\;\hLk{3B12}{12}\;\;\hLk{3B16}{16}\;\;\hLk{3B17}{17}\;\;\hLk{3B18}{18}\;\;\hLk{3B19}{19}\;\;\hLk{3B20}{20}\;\;\hLk{3B21}{21}\;\;\hLk{3B22}{22}\;\;\hLk{3B23}{23}\;\;\hLk{3B24}{24}\;\;\hLk{3B25}{25}\;\;\hLk{3B26}{26}\;\;\hLk{3B28}{28}\;\;\hLk{3B29}{29}\;\;\hLk{3B30}{30}$\\[-4pt]$\hLk{3B4e21}{4E:\;\;21}\;\;\hLk{3B4e24}{24}\;\;\hLk{3B4e27}{27}\;\;\hLk{3B4e32}{32}\;\;\hLk{3B4e33}{33}}[-40pt]{[1]: 3, 7, 8, 9, 10, 11, 16; [2]: 17, 18, 19, 12; [3]: (4E 21), 28, 29; [4]: 30, (4E 31), (4E 27), 20, 21;$\\$[5]: 24, 25, 22, 23; [6]: (4E 24), 26; [7]: (4E 33); [前两页]: (4E 32).}
...
\Comment \,\,\,Let $\Par{e_1,\dots,e_m}$ be the standard basis of $\Fbb^m.$ Then $T{e_k}=v_k.$\parCom
...
\ProblemN[]{\hypertarget{3B11}{11}}{
	Suppose $S_1,\dots,S_n\in\Lm{V}$ and $S=S_1S_2\cdots S_n$ makes sense. Then using induction\hspace{1pt}$:$\TextNL{}
	(a) $\range S_1\supseteq\range\Par{S_1S_2}\supseteq\cdots\supseteq\range\Par{S};$ \; (b) $\null S_n\subseteq \null\Par{S_{n-1}S_n}\subseteq\cdots\subseteq\null\Par{S}.$\TextNL{\vspace{2pt}}
	\Corollary \,\,\,(1) $S$ surj $\Longrightarrow$ each $S_k$ surj; \; (2) $S$ inje $\Longleftrightarrow$ each $S_k$ inje.\TextNL{\vspace{-4pt}}
}\SepLine
...
\ProblemB{
	\TipsN{1}\,\,\,\TextB{Suppose $U$ is a subsp of \,$V$. Prove that $\forall T\in\Lm{V,W},U\cap\null T=\null T\mmid_U.$}
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Suppose $T\in\Lm{V,W}$ and $T\mmid_U:U\rightarrow\range T$ is an iso. Let $U=X+Y.$}
	{\IndentTipsN{2}}(a) \TextB{Show that $\range T=\range T\mmid_X+\range T\mmid_Y.$\vspace{2pt}}
	{\IndentTipsN{2}}(b) \TextB{Show that if $X\cap Y=\zeroSubs,$ then $\range T\mmid_X\cap\range T\mmid_Y=\zeroSubs.$}
}\par\quad
(a) Because $\forall v\in V,\exists\,!\,u\in U,u_0\in\null T\Rightarrow\exists\,x\in X,y\in Y,v=\Par{x+y}+u_0.$\par\quad\Ha
Now $Tv=Tx+Ty\Rightarrow\range T=\range T\mmid_X+\range T\mmid_Y.$\par\vspace{2pt}\quad
(b) Assume that for some $v\in V,$ there exist two distinct pairs $\Par{x_1,y_1},\Par{x_2,y_2}$ in $X\times Y$\par\quad\Hb
such that $Tv=Tx_1+Ty_1=Tx_2+Ty_2.$ Because $\forall v\in X\oplus Y,\exists\,!\,\Par{x,y}\in X\times Y,v=x+y.$\par\quad\Hb
Now $T\Par{x_1+y_1}=T\Par{x_2+y_2}\Rightarrow x_1+y_1=x_2+y_2\Rightarrow x_1=x_2,y_1=y_2.$ Contradicts.\par\quad\Hb
...
Assume that $\range T=\range T\mmid_U.$ Then $\range T\mmid_X=\zeroSubs.$ While $T\mmid_X$ is inje. Contradicts.
%\Or $\range T\mmid_X\subseteq\range T\mmid_U\Rightarrow \forall x\in X,Tx\in\range T\mmid_U$\parCor
%$\Rightarrow\exists\,u\in U,Tu=Tx\Rightarrow u=x\in U\cap X=\zeroSubs\Rightarrow X=\zeroSubs.$ Contradicts.\PfEnd
\SepLine\pagebreak

\BulletPointX\TipsN{3}\,\,\,{Suppose $T\in\Lm{V,W}$ and $U$ is a subsp such that $V=U\oplus\null T.$}\TextB{}
Now $\forall v\in V,\exists\,!\,u_v\in U,w_v\in\null T,v=u_v+w_v.$ Define $i\in\Lm{V,U}$ by $i\Par{v}=u_v.$ \uline{Then $T=T\circ i.$}\TextB{}
Because $\forall v\in V,T\Par{v}=T\Par{u_v+w_v}=T\Par{u_v}=T\BigPar{i\Par{v}}=\Par{T\circ i}\Par{v}.$\par
\SepLine

\BulletPointX\TipsN{4}\,\,\,Suppose $T\in\Lm{V,W},T\neq 0.$ Let $\Par{Tv_1,\dots,Tv_n}$ be a basis of $\range T.$\TextB{}
...
}{{\tgsl Always notice that $\mathcal{S}_V\Span{v_1,\dots,v_n}=\Bra{U_1,\cdots,\null T,\cdots,U_n,\cdots}.$}} A counterexample:\par\quad
Let $\dim V=3, Tv_1=Tv_2=Tv_3=w_1.$ Then $\Span{Tv_1,Tv_2,Tv_3}=\Span{w_1}$.\par\quad
Extend $\Par{v_i}$ to $\Par{v_1,v_2,v_3}$ for each $i$. But none of $\Par{v_1,v_2},\Par{v_1,v_3},\Par{v_2,v_3}$ is a basis of $\null T.$\PfEnd
\SepLine

\ProblemB{
	\hypertarget{3B4e21}{}\TextB{Suppose $V$ is finite-dim, $T\in\Lm{V,W},$ $Y$ is a subsp of \,$W$. Let $\mathcal{K}_Y=\Bra{v\in V: Tv\in Y}$.}
	(a) \TextB{Prove that $\mathcal{K}_Y$ is a subsp of \,$V.$}
	(b) \TextB{Prove that $\dim\mathcal{K}_Y=\dim\null T +\Dim\Par{Y\cap\range T}.$}\vspace{2pt}
}(a) $\forall u,w\in\mathcal{K}_Y,\Sbra{\,Tu,Tw\in Y\,},\lambda\in\Fbb,T\Par{u+\lambda w}=Tu+\lambda Tw\in Y\Longrightarrow \mathcal{K}_Y$ is a subsp of $V$.\parSol{\vspace{2pt}}
(b) Define the range-restricted map $R$ of $T$ as $Rv=Tv$ for all $v\in\mathcal{K}_Y.$\parSol{\Hb}
Obviously $R=T\mmid_{\mathcal{K}_Y}:\mathcal{K}_Y\rightarrow Y$ is linear. Now $\range R=Y\cap \range T.$\parSol{\Hb}
...
\Comment \,\,\,Now $\Span{v_1,\dots,v_m}\oplus\null T=\mathcal{K}_Y.$ {Where $B_{Y\,\cap\,\range T}=\Par{Tv_1,\dots,Tv_m}.$}\vspace{2pt}\parCom
...
Define $\varphi_i\in\Lm{V,\Fbb}$ by $\varphi_i\Par{v_j}=\delta_{i,j},\;\varphi_i\Par{u}=0$ for all $u\in\null T.$ We now check the linearity.\par\quad{}
$\forall v,w\in V\,\Sbra{\exists\,!\,a_i,b_i\in\Fbb},\lambda\in\Fbb,\varphi_i\Par{v+\lambda w}=a_i+\lambda b_i=\varphi\Par{v}+\lambda\varphi\Par{w}.$\PfEnd
\SepLine
...
\Or (a) $\forall\,v=cu\in\null\varphi\cap\Span{u},\varphi\Par{v}=0=c\varphi\Par{u}\Longrightarrow c=0.$\parSol{\Ha}
...
\Or \NOTICE that $V=U\oplus\null T.$ By the {\COROLLARY} in Problem (12), $\range T=\range T\mmid_U.$\par\quad{\Blind{\Or}}
又 $\dim\range T\mmid_U=\dim U=\dim Y;\;\range T\subseteq Y.$\par\quad
\Or Let $B_X=\Bra{x_1,\dots,x_n}.$ Now $\range T=\Span[\BigPar]{Tv_1,\dots,Tv_m,Tx_1,\dots,Tx_n}=\Span{w_1,\dots,w_m}=Y.$\PfEnd
\SepLine
...
\Or \Sbra[3pt]{{\tgsl Only in Finite-dim}} \;Let $\Par{P^2 v_1,\dots,P^2 v_n}$ be a basis of $\range P^2$. Then $\Par{Pv_1,\dots,Pv_n}$ is linely inde.\par\quad
...
(b) Suppose $T$ is inje. Let $B_{\range T}=\Par{Tv_1,\dots,Tv_n}.$\par\quad\Hb
Then $\Span{v_1,\dots,v_n}\oplus\null T=V.$ Let $U\oplus\range T=W$.\par\quad\Hb
Define $S\in\Lm{W,V}$ by $S\Par{Tv_i}=v_i,Su=0$ for each $v_i$ and all $u\in U.$ Thus $ST=I.$\par\vspace{6pt}\quad\Hb
...
(b) Suppose $T$ is surj. Let $B_{\range T}=B_{W}=\Par{Tv_1,\dots,Tv_n}.$ Then $\Span{v_1,\dots,v_n}\oplus\null T=V.$\par\quad\Hb
...
Let \uline{$W=\range S\oplus U.$} Define $E\in\Lm{W}$ by \uline{$E\Par{Sv+w}=Tv$} for all $w\in U$ and $Sv.$\par\quad
{\normalsize Linearity: Because $\forall w_1,w_2\in W,\exists\,!\,Sv_1,Sv_2\in\range S,u_1,u_2\in U,w_1=Sv_1+u_1,w_2=Sv_2+u_2.$}\par\vspace{-2pt}\quad
{\normalsize Now $E\Par{w_1+\lambda w_2}=E\BigPar{\Par{Sv_1+\lambda Sv_2}+\Par{u_1+\lambda u_2}}=T\Par{v_1+\lambda v_2}=Tv_1+\lambda Tv_2=E{w_1}+\lambda E{w_2}.$ Checked.}\vspace{6pt}\par\quad
\Or Let \uline{$V=U\oplus\null S\Rightarrow S\mmid_{U}:U\rightarrow\range S$ is an iso. Extend $T\Par{S\mmid_{U}}{^{-1}}\in\Lm{\range S,W}$ to $E\in\Lm{W}.$}\vspace{6pt}\par\quad
...
\Or \Sbra[3pt]{{\tgsl Req $W$ Finite-dim}} \;Extend $B_{\range S}$ to \uline{$B_W=\Par{Sv_1,\dots,Sv_n,w_1,\dots,w_m}.$}\par\quad
Define $E\in\Lm{W}$ by $E\Par{Sv_k}=Tv_k,\;Ew_j=0.$ Because \uline{$\forall\,v\in V,\exists\,a_i\in\Fbb,Sv=a_1 Sv_1+\dots+a_n Sv_n.$}\par\quad
\uline{Now \;$v-\Par{a_1 v_1+\dots+a_n v_n}\in\null S\subseteq\null T\Longrightarrow T\BigPar{v-\Par{a_1 v_1+\dots+a_n v_n}}=0.$}\par\quad
...
\ProblemN{\hypertarget{3B25}{25}}{
	\TextNL{Suppose $S, T\in\Lm{V,W},$ and $\range S\subseteq\range T.$ Prove that $\exists\,E\in\Lm{V},S = TE$.}
}\par\quad
Let $V=U\oplus\null T\Rightarrow T\mmid_U:U\rightarrow\range T$ is an iso. Because $\Par{T\mmid_U}{^{-1}}:\underset{\supseteq\,\range S}{\uline{\range T}}\rightarrow U.$\par\vspace{-10pt}\quad
\uline{Define $E=\Par{T\mmid_U}{^{-1}}S\in\Lm{V,U}.$} Then write $E\in\Lm{V}.$\PfEnd\vspace{6pt}\quad
\Or \Sbra[3pt]{{\tgsl Req $\range S$ Finite-dim}} \;Let $B_{\range S}=\Par{Sv_1,\dots,Sv_n}.$ Then \uline{$V=\Span{v_1,\dots,v_n}\oplus\null S.$}\par\quad
\uline{Let $T\Par{u_i}=Sv_i$ for each $Sv_i.$} Define $E$ by $Ev_i=u_i,Ex=0$ for all $x\in\null S$ and each $v_i.$\par\quad
Hence $\forall v\in V,\,\,\BigPar{\exists\,!\,a_i\in\Fbb,x\in\null S\,},\,Sv=a_1 Sv_1+\dots+a_n Sv_n=T\BigPar{E\Par{a_1 v_1+\dots+a_n v_n+x}}.$\PfEnd
\SepLine
...
\ProblemN{\hypertarget{3B23}{23}}{
	...
	\TextNL{Prove that $\dim\range ST\leqslant\min\!\Bra{\dim \range S, \dim\range T}$.\vspace{4pt}}
...
\AlignEq{}{\text{And\,}ST=0&\Rightarrow \dim\range TS\leqslant\dim\range T\leqslant\dim\null S\leqslant n-\dim\range TS\hspace{70pt}\\[-4pt]&\Longrightarrow 2\dim\range TS\leqslant n.\text{ Thus }\dim\range TS\leqslant\Frac{n}{2}\Rightarrow\dim\range TS\leqslant\left\lfloor\Frac{n}{2}\right\rfloor.}\PfEnd\vspace{6pt}
\hspace{-2pt}$\hMath{l}{\left.}{\right.}{$(c) Let $B_{\Fbb^5}=\Par{v_1,\dots,v_5}.$ Define $S,T\in\Lm{\Fbb^5}$ by $\\\;}\MathLeftMid{l}{T: \; v_1\mapsto 0, \;\;\, v_2\mapsto 0, \;\;\; v_i\mapsto v_i\;;\\\,S: \; v_1\mapsto v_4, \; v_2\mapsto v_5, \;\; v_i\mapsto 0\;;\;\; i=3,4,5.}$\PfEnd
\SepLine
...
\ProblemB{
	\hypertarget{3B4e33}{}Suppose that $V$ and $W$ are real vecsps and $T\in\Lm{V,W}$.\TextB{}
	Define $T_{\Cbb}:V_{\Cbb}\rightarrow W_{\Cbb}$ by $T_{\Cbb}\Par{u+\i v}=Tu+\i Tv$ for all $u,v\in V$.\TextB{}
	Show that {\tgnr\large(a)} $T_{\Cbb}$ is linear, {\tgnr\large(b)} $T_{\Cbb}$ is inje $\Longleftrightarrow$ T is inje, {\tgnr\large(c)} $T_{\Cbb}$ is surj $\Longleftrightarrow T$ is surj.\TextB{}
}\normalsize\envFontSmall(a) \vspace{-6pt}\AlignEq{}{&\forall u_1+\i v_1,u_2+\i v_2\in V_{\Cbb}, \lambda\in\Fbb,\\&T\BigPar{\Par{u_1+\i v_1}+\lambda\Par{u_2+\i v_2}}=T\BigPar{\Par{u_1+\lambda u_2}+\i\Par{v_1+\lambda v_2}}=T\Par{u_1+\lambda u_2}+\i T\Par{v_1+\lambda v_2}\hspace{-55pt}\\= \,& Tu_1+\i Tv_1+\lambda Tu_2+\i\lambda Tv_2=T\Par{u_1+\i v_1}+\lambda T\Par{u_2+\i v_2}.}\parSol{}
(b) $\left|\begin{array}{l}$
		...
		$\end{array}\right.$\parSol{\vspace{3pt}}
(c) $\left|\begin{array}{l}$
		...
		$\end{array}\right.$\large\envFontDefault\par\vspace{10pt}
\SepLine
...
%}\!\!Define $B\in\Lm[\BigPar]{\PoR{}}$ by $B=5D^2+3D.$ Because $\Deg\Par{Bq}=\Par{\!\deg q}-1.$ By Problem (26).\PfEnd
%\SepLine

\ChEnd

\vfill\ChDecl{Ch3C}{3$\cdot$C}{}\orMode{\hLk{3C1}{1}\;\;\hLk{3C3}{3}\;\;\hLk{3C4}{4}\;\;\hLk{3C5}{5}\;\;\hLk{3C6}{6}\;\;\hLk{3C9}{9}\;\;\hLk{3C10}{10}\;\;\hLk{3C11}{11}\;\;\hLk{3C12}{12}\;\;\hLk{3C13}{13}\;\;\hLk{3C14}{14}\;\;\hLk{3C15}{15}\;\;|\;\;\hLk{3C4e16}{4E:\;\;16}\;\;\hLk{3C4e17}{17}}{[1]: 10, 9, 11; [2]: (4E 16); [3]: (4E 17), 1, 3, 4; [4]: 5, 6, 13; [5]: 14, 15, 12.}
\vspace{10pt}

\BulletPointX\NoteForSmall{[3.47]}\,\, $\BigPar{AC}{_{j,k}}=\sum_{r=1}^n A_{j,r}C_{r,k}=\sum_{r=1}^n \BigPar{A_{j,\cdot}}_{1,r}\BigPar{C_{\cdot,k}}_{r,1}=\BigPar{A_{j,\cdot}C_{\cdot,k}}_{1,1}=A_{j,\cdot}C_{\cdot,k}.$\par
\SepLine
...
\BulletPointX\NoteForSmall{[3.49]} $\XSbra{\BigPar{AC}_{\cdot,k}}_{j,1}=\BigPar{AC}_{j,k}=\sum_{r=1}^n A_{j,r}C_{r,k}=\sum_{r=1}^n A_{j,r}\BigPar{C_{\cdot,k}}_{r,1}=\BigPar{AC_{\cdot,k}}_{j,1}$\PfEnd
\SepLine
...
$A\,=\,$ {\normalsize$\begin{pmatrix} 10 &\hspace{-4pt} 7 &\hspace{-4pt} 4 &\hspace{-4pt} 1 \\[-2pt] 26 &\hspace{-4pt} 19 &\hspace{-4pt} 12 &\hspace{-4pt} 5\\[-2pt] 46 &\hspace{-4pt} 33 &\hspace{-4pt} 20 &\hspace{-4pt} 7\end{pmatrix}$
	{$\overset{\SmallPar{\text{I}}}{=\hspace{-3pt}=}$}
	...
	{$\overset{\SmallPar{\text{II}}}{=\hspace{-4pt}=\hspace{-4pt}=}$}
...
\Sbra[3pt]{{\tgsl Using CR Factorization}}\vspace{2pt}\par\quad
$P\Rightarrow Q:$\,\;Immediately.\par\vspace{-18pt}\quad
$Q\Rightarrow P:$\,\;Because $\;A=\begin{pmatrix}c_1 \\[-4pt] \vdots \\[-5pt] c_m \end{pmatrix}\begin{pmatrix}d_1 & \hspace{-6pt}\cdots & \hspace{-6pt}d_n\end{pmatrix}=\begin{pmatrix} c_1 d_1 & \hspace{-6pt}\cdots & \hspace{-6pt}c_1 d_n\\[-4pt] \vdots & \hspace{-6pt}\ddots & \hspace{-6pt}\vdots \\[-5pt] c_m d_1 & \hspace{-6pt}\cdots & \hspace{-6pt}c_m d_n \end{pmatrix}.$ We have $S_r=\Spn\!\MathLeftrightBrace{l}{
	\!\begin{pmatrix}c_1 d_1 & \hspace{-6pt}\cdots & \hspace{-6pt}c_1 d_n\end{pmatrix},\\
	\!\begin{pmatrix} c_2 d_1 & \hspace{-6pt}\cdots & \hspace{-6pt}c_2 d_n\end{pmatrix},\\[-4pt] \;\;\qquad\vdots\\[-5pt]
...
.$\par\vspace{-6pt}\quad
\Blind{$P\Rightarrow Q:$\,\;}\Or $S_c=\Spn\!\MathLeftrightBrace{c}{\!\!\begin{pmatrix} c_1d_1 \\[-4pt] \vdots \\[-5pt] c_md_1\end{pmatrix},\begin{pmatrix} c_1d_2 \\[-4pt] \vdots \\[-5pt] c_md_2\end{pmatrix},\dots,\begin{pmatrix} c_1d_n \\[-4pt] \vdots \\[-5pt] c_md_n\end{pmatrix}\!\!\!}=\Spn\!\MathLeftrightBrace{c}{\!\!\begin{pmatrix}c_1 \\[-4pt] \vdots \\[-5pt] c_m\end{pmatrix}\!\!\!}.$\par\vspace{4pt}\quad
...
$Q\Rightarrow P:$\,\;Using [4E 3.51(a)]. Each $A_{\cdot,k}\in\Spn${\normalsize$\MathLeftrightBrace{c}{\!\!\begin{pmatrix}c_1 \\[-4pt] \vdots \\[-5pt] c_m\end{pmatrix}\!\!\!}$}. $\hMath{l}{\left.}{\right.}{$
...
\ProblemBnoor{\hypertarget{3C4e17}4E 3.C.17, \OR 3.F.32}[\Sbra]{
...
}\vspace{-8pt}\AlignEq{}{&\qquad\hspace{1pt} T \text{ is inje } \Longleftrightarrow\dim V=\dim\range T=n\\[-2pt]
	&\hspace{-18.5pt}\Delta\MathLeftBrace{l}{\Longleftrightarrow\Par{Tu_1,\dots,Tu_n}\text{ is a basis of }V; 又 \dim\Span{\Mt{Tu_1},\dots,\Mt{Tu_n}}=n\\
		\Longleftrightarrow\BigPar{\Mt{Tu_1},\dots,\Mt{Tu_n}}\text{ is a basis of }\Fbb^{n,1},\text{ as well as }\Par{A_{\cdot,1},\dots,A_{\cdot,n}}}\\
...
\Comment \,\,\,Moreover, let $Tv_k=w_k,$ extend $B_{\range T}$ to $B_W=\Par{w_1,\dots,w_n,\dots,w_p}.$\parCom
Define $E_{j,k}\in\Lm{V,W}$ by $E_{j,k}\Par{v_j}=Tv_k,\;E_{j,k}\Par{v_i}=E_{j,k}\Par{u_x}=0.$ Then $T=E_{1,1}+\dots+E_{n,n}.$
\SepLine
...
$\forall k\in\Bra{1,\dots,n},Tu_k\in\range T=\Span{w}\Rightarrow Tu_k=\lambda_k w,\exists\,\lambda_k\in\nonzeroFbb.$\par\quad\Hb
...
Note that $\Sbra{A\Par{B+C}}{_{j,k}}=\sum_{r=1}^n A_{j,r}\Par{B+C}{_{r,k}}=\sum_{r=1}^n \Par{A_{j,r}B_{r,k}+A_{j,r}C_{r,k}}=\Par{AB+AC}{_{j,k}}.$\PfEnd\parSol{\vspace{8pt}}
\Or Define $T,S,R$ such that $\Mt{T}=A,\Mt{S}=B,\Mt{R}=C.$\parSol{}
$A\Par{B+C}=\Mt{T\Par{S+R}}\overset{[3.9]}{=\hspace{-3pt}=}\Mt{TS+TR}=AB+AC.$\parSol{}
...
$LHS=\Par{AB}{_{j,\cdot}}C_{\cdot,k}=\sum_{s=1}^n\Par{A_{j,s}B_{s,\cdot}}C_{\cdot,k}=\sum_{s=1}^n A_{j,s}\Par{B_{s,\cdot}C_{\cdot,k}}=\sum_{s=1}^n A_{j,s}\Par{BC}{_{s,k}}=RHS.$\PfEnd\parSol{\vspace{8pt}}
\Or Define $T,S,R$ such that $\Mt{T}=A,\Mt{S}=B,\Mt{R}=C.$\parSol{}
$\Par{AB}C=\Mt{T\Par{SR}}\overset{[3.9]}{=\hspace{-3pt}=}\Mt{TSR}\overset{[3.9]}{=\hspace{-3pt}=}\Mt{\Par{TS}R}=A\Par{BC}.$\parSol{}
...
\ProblemN{\hypertarget{3C15}{15}}{
	...
	\text{\Or}\;\;\BigPar{AAA}_{j,k} &=\textstyle\sum_{r=1}^n\BigPar{AA}_{j,r}A_{r,k} =\textstyle\sum_{r=1}^n\XPar{\sum_{p=1}^n A_{j,p}A_{p,r}}\hspace{1pt}A_{r,k}\\&=\textstyle\sum_{r=1}^n\left[A_{j,1}\BigPar{A_{1,r}A_{r,k}}+\dots+A_{j,n}\BigPar{A_{n,r}A_{r,k}}\right]\\&=\textstyle A_{j,1}\sum_{r=1}^n A_{1,r}A_{r,k}+\dots+A_{j,n}\textstyle\sum_{r=1}^n A_{n,r}A_{r,k}=\textstyle\sum_{p=1}^n \sum_{r=1}^n A_{j,p}A_{p,r}A_{r,k}.}\PfEnd[-25pt]
\Comment \,\,\,
\SepLine
...
Hence $ST=TS.$ Which in general is not true.\PfEnd
\SepLine
...
\Or Reduce the spanning list $\Par{Tv_1,\dots,Tv_m}$ of $V$ to a basis $\Par{Tv_{\alpha_1},\dots,Tv_{\alpha_k}}$ of $V.$\par\quad
\Blind{\Or}Where $k=\dim V$ and each $\alpha_i\in\Bra{1,\dots,k}.$ Then by Problem (4E 3),\par\quad
...
\ProblemN{\hypertarget{3D3}{3}}{
	...
	\TextN{Prove that $\exists$ inv $T\in\Lm{V},Tu = Su,\forall u\in U$ $\Longleftrightarrow$ $S$ is inje. {\large\Sbra{ Compare this with (3.A.11). }}}
}\par\quad
(a) $\forall u\in U,u=T^{-1}Su\Longrightarrow S$ is inje. \Or $\null S=\null T\cap U=\zeroSubs\cap U=\zeroSubs.$\par\quad
(b) Let $\Par{u_1,\dots,u_m}$ be a basis of $U.$ Then $S$ inje $\Longrightarrow\Par{Su_1,\dots,Su_m}$ linely inde.\par\quad\Hb
...
\ProblemN{\hypertarget{3D8}{8}}{
	...
	\TextN{Prove that there is a subsp $U$ of $V$ such that $T\mmid_U$ is an iso of $U$ onto $W$.}
...
Suppose $ST$ is inv. Let $R=\Par{ST}{^{-1}}\Rightarrow R\Par{ST}=\Par{ST}R=I$.\par\vspace{4pt}\quad
$\MathRightBrace{l}{$
...
Suppose $ST=I$. $\MathRightBrace{l}{Tv=0\Rightarrow v=STv=0\\ v\in V\Rightarrow v=S\Par{Tv}\in\range S}\Rightarrow T$ is inje, $S$ is surj. While $V$ is finite-dim.\par\vspace{4pt}\quad
\Or {\normalsize By Problem (9), $V$ is finite-dim and $ST=I$ is inv $\Rightarrow$ $S,T$ are inv.}\par\vspace{4pt}\quad
$S\BigPar{\Par{TS}v}=ST\Par{Sv}=Sv\Rightarrow \Par{TS}v=v\Rightarrow S$ is inv.\par\quad
\Or {\normalsize$ST=I\Rightarrow S=T^{-1}\Rightarrow S^{-1}=T.$ 又 $S=S\Rightarrow TS=S^{-1}S=I$.}\par\vspace{4pt}\quad
...
}Using Problem (9) and (10). {\tgsl\normalsize This result can fail without the hypothesis that $V$ is finite-dim.}\par\vspace{4pt}\quad
$\Par{ST}U=U\Par{ST}=\Par{US}T=T\Par{US}=S\Par{TU}=\Par{TU}S=I.$\par\quad
$\Rightarrow U^{-1}=ST,\qquad\qquad T^{-1}=US,\qquad\qquad S^{-1}=TU.$\PfEnd\vspace{2pt}
...
$\forall v\in V,v=\Par{RST}Xv\in\range R\Rightarrow R$ is surj.$\\\end{array}\right\}\Rightarrow S=R^{-1}\Par{RST}T^{-1}$ is inv.\PfEnd\vspace{8pt}\quad
...
Let $B_1=\Par{E_1,\dots,E_n},B_2=\Par{R_1,\dots,R_m}$ be the standard bases of $\Fbb^{n,1}$ and $\Fbb^{m,1}$.\vspace{-12pt}\par\quad
$\forall k=1,\dots,n,$ suppose $T\Par{E_{k}}=A_{1,k}R_1+\dots+A_{m,k}R_m,\exists\,A_{j,k}\in\Fbb$, forming $A\,=\,${\normalsize$\begin{pmatrix} A_{1,1} &\hspace{-4pt} \cdots &\hspace{-4pt} A_{1,n}\\[-2pt] \vdots &\hspace{-4pt} \ddots &\hspace{-4pt} \vdots\\[-2pt] A_{m,1} &\hspace{-4pt} \cdots &\hspace{-4pt} A_{m,n}\end{pmatrix}.$}\PfEnd\vspace{-6pt}\quad
...
}Using Problem (10) and (15).\vspace{2pt}\par\quad
...
$\forall S\in\Lm{U,W},$ by (3.A.11), $\exists\,T\in\Lm{V,W},\Phi\Par{T}=S\in\range\Phi.$ Thus $\range\Phi=\Lm{U,W}.$\vspace{2pt}\par\quad\Hb
...
\BulletPointX\Comment\,\,\, {\Large\vspace{6pt}Define $\mathcal{B}\in\Lm[\BigPar]{\Lm{V}}$ by $\mathcal{B}\Par{T}=TS.$ Similarly to Problem (4E 17),}\par\quad
...
\Or Using \NOTEFOR\;[3.60] and the notation in Problem (4E 17).\par
...
\ProblemBnoor{\hypertarget{3D4e19}{}10.A.3, \OR 4E 3.D.19}{
	...
	\TextB{Prove that $\forall B_V\neq B_V',\;\Mt{T,B_V}=\Mt{T,B'_V}\Longrightarrow T=\lambda{I},\exists\,\lambda\in\Fbb.$}
}\Sbra{ Compare with the first solution of (3.D.16) in 3.A }\par\quad
...
where $v\apostrophe_j=v_k,\,\,v_k\apostrophe=v_j$ and $v\apostrophe_i=v_i$ for all $i\in\Bra{1,\dots,m}\Backslash[\LARGE]\Bra{\,j,k}.$\vspace{3pt}\par\quad
...
\ProblemN[]{\hypertarget{3E20}{20}}{
	\TextNL{Define $\Gamma:\Lm{V\XSlash U,W}\rightarrow\Lm{V,W}$ by $\Gamma\Par{S}=S\circ\pi.$ Prove that\hspace{1pt}$:$\vspace{4pt}}
	(a) \TextNL{$\Gamma$ is linear\hspace{1pt}$:$ {\large\tgnr By [3.9] distr and [3.6].}\vspace{4pt}}
	(b) \TextNL{$\Gamma$ is inje\hspace{1pt}$:$ {\large\envFontDefault $\Gamma\Par{S}=0=S\circ\pi\Longleftrightarrow\forall v\in V,S\Par{\pi\Par{v}}=0\Longleftrightarrow\forall v+U\in V\XSlash U,S\Par{v+U}=0\Longleftrightarrow S=0.$}\vspace{4pt}}
	(c) \TextNL{$\range\Gamma=\Bra{T\in\Lm{V,W}:U\subseteq\null T}\hspace{1pt}:$ {\normalsize\tgnr By Problem (18).\PfEnd}\vspace{-3pt}}
}\SepLine\pagebreak

\BulletPointX\NoteFor{[3.88, 3.90, 3.91]} {\vspace{2pt}Suppose $W\in\mathcal{S}_V U.$ Then $V\XSlash U$ and $W$ are iso.}\TextB{}
...
\ProblemN{\hypertarget{3E12}{12}}{
	\TextNL{Suppose $U$ is a subsp of \,$V$ such that $V\XSlash U$ is finite-dim. Prove that is $V$ is iso to $U\times \Par{V\XSlash U}$.}
}\par\quad
...
\Blind{Thus de}and $\psi\in\Lm[\BigPar]{U\times\Par{V\XSlash U},V}$ by $\psi\Par{u,v+U}=v+u,$ where $\exists\,!\,a_i\in\Fbb,v=\sum_{i=1}^n a_i v_i+U.$\PfEnd\vspace{8pt}\quad
\Or \Sbra[3pt]{{\tgsl $V\XSlash U,U$ and $V$ can be infinite-dim}} \;Define $S\in\Lm{V\XSlash U,V}$ by $S\Par{v+U}=v.$\vspace{2pt}\par\quad
...
\ProblemBnoor{\hypertarget{3E4e14}{4E 3.E.14}}{
	...
	\TextB{Prove that $\Par{w_1+U,\dots,w_m+U}$ is a basis of $V\XSlash U$.\vspace{2pt}}
...
\ProblemN{\hypertarget{3E13}{13}}{
	\TextNL{Suppose $\Par{v_1+U,\dots,v_m+U}$ is a basis of \,$V\XSlash U$ and $\Par{u_1,\dots,u_n}$ is a basis of $U$.}
...
\ProblemN{\hypertarget{3E16}{16}}{
	\TextNL{Suppose $\dim V\XSlash U=1$. Prove that $\exists\,\varphi\in\Lm{V,\Fbb}$ such that null $\varphi=U.$}
}\par\quad
...
\ProblemN{\hypertarget{3E17}{17}}{
	...
	(b) \TextNL{Find a $W$ such that $\dim W=\dim V\XSlash U$ and $V=U\oplus W$.}
...
\ProblemB{
	\TextB{Suppose $U$ is a subsp of $V.$ Prove that $\Par{V\XSlash U}\apostrophe$ and $U^0$ are iso. \hfill\Sbra[3pt]{{\large\tgsc Another proof of \tgbfx[3.106]}}}
}\par\quad
