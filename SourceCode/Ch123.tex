...
\ProblemB{
	...
	\IndentTipsN{1}\Hb where $\iota\in\Lm{V,W}:u_v+w_v\rightarrow w_v$.\;\;\;\NewNotation\;\;Denote $W^0$ by $U_V\upapostrophe,$ and $U^0$ by $W_V\upapostrophe.$\TextB{}
...
(b) $\varphi\in U^0\Longleftrightarrow U\subseteq\null\varphi\Longleftrightarrow\varphi=\varphi\circ\iota,$ by \Sbra{3.B \TIPSN{3}}.\PfEnd
\SepLine
