...
\ProblemB{
	...
	(b) \TextB{Suppose $\dim V=n.$ Prove that in {\tgnr\large(a)}, $\dim\range TS\leqslant\left\lfloor\Frac{\;n\;}{2}\right\rfloor.$}
...
$\min\!\Bra{n-\dim\null T,n-\dim\null S}\geqslant \left\lfloor\Frac{\;n\;}{2}\right\rfloor+1\Rightarrow\max\!\Bra{\!\dim\null T,\dim\null S}\leqslant n-\left\lfloor\Frac{\;n\;}{2}\right\rfloor-1.$\par\vspace{2pt}\quad\Hb
又 $\dim\null ST=n\leqslant\dim\null S+\dim\null T\leqslant 2\XPar{n-\left\lfloor\Frac{\;n\;}{2}\right\rfloor-1}\Rightarrow \left\lfloor\Frac{\;n\;}{2}\right\rfloor+1\leqslant\Frac{\;n\;}{2}.$\PfEnd\vspace{10pt}\quad\Hb
\Or $\dim\null S=n-\dim\range S\leqslant n-\dim\range TS.$\par\vspace{-4pt}\quad\Hb
\AlignEq{}{\text{And\,}ST=0&\Rightarrow \dim\range TS\leqslant\dim\range T\leqslant\dim\null S\leqslant n-\dim\range TS\hspace{70pt}\\[-4pt]&\Longrightarrow 2\dim\range TS\leqslant n.\text{ Thus }\dim\range TS\leqslant\Frac{\;n\;}{2}\Rightarrow\dim\range TS\leqslant\left\lfloor\Frac{\;n\;}{2}\right\rfloor.}\PfEnd\vspace{-2pt}
%\vspace{6pt}\quad
...
{$\Rightarrow x^{n+1}=D\Sbra{\uline{a_{n+1}^{-1}\Par{x^{n+2}-a_n p_n-\dots-a_1 p_1-a_0 p_0}}}.$ Thus defining $p_{n+1},$ so that $Dp_{n+1}=x^{n+1}.$}\PfEnd
\SepLine
\ChEnd
...
And $C=\Mt{T,B_U,B_V}\in\Fbb^{n,p},A=\Mt{S,B_V,B_W}\in\Fbb^{m,n}.$\vspace{2pt}\parCom
Then $\Mt{Tu_k,B_V}=C_{\cdot,k}\Rightarrow\Mt[\BigPar]{S\Par{Tu_k},B_W}=AC_{\cdot,k},$ 又 $\Mt[\envFontLarge\BigPar]{\envFontDefault\Par{ST}\Par{u_k},B_W\envFontLarge}=\Par{AC}{_{\cdot,k}}$\PfEnd
\SepLine
