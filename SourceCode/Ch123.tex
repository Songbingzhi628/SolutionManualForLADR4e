...
(b) $\hMath{l}{\left|}{\right\}}{$
	Let \;$f_e\Par{x}=\Frac{\;1\;}{2}\Sbra{g\Par{x}+g\Par{-x}}\Longrightarrow f_e\in V_{\!E}\vspace{4pt}\\$
...
Now $\forall v\in V,\exists\,!\,u_v\in U,\Par{x_v,y_v}\in X\times Y,v=u_v+x_v+y_v.$ Define $i\in\Lm{V,U}$ by $i\Par{v}=u_v+x_v.$\TextB{}
...
}Using \TIPSN{4}. For each $w_i,\;\exists\,v_i,\;Tv_i=w_i.$ \;Then $\Par{v_1,\dots,v_m}$ is linely inde.\parSol{}
And $\Span{v_1,\dots,v_m}\oplus\null T=V.$ Now $\forall v\in V,\exists\,!\,a_i\in\Fbb,u\in\null T,\;v=\sum_{i=1}^m a_i v_i+u.$\parSol{}
...
$\dim\range TS\leqslant\min\!\Bra{\dim \range S,\dim\range T}.$ We prove by contradiction.\par\vspace{2pt}\quad
Assume that $\dim\range TS\geqslant \left\lfloor\Frac{\;n\;}{2}\right\rfloor+1.$ \;Then \;$\min\!\envFontLarge\Bra{n-\dim\null T,n-\dim\null S}\envFontDefault\geqslant \left\lfloor\Frac{\;n\;}{2}\right\rfloor+1$\par\quad
又 $\dim\null ST=n\leqslant\dim\null S+\dim\null T$ \;$\left|\,\;\Rightarrow\max\!\envFontLarge\Bra{\!\dim\null T,\dim\null S}\envFontDefault\leqslant n-\left\lfloor\Frac{\;n\;}{2}\right\rfloor-1.\right.$\par\vspace{2pt}\quad
Thus \;$n\leqslant 2\XPar{n-\left\lfloor\Frac{\;n\;}{2}\right\rfloor-1}\Rightarrow \left\lfloor\Frac{\;n\;}{2}\right\rfloor+1\leqslant\Frac{\;n\;}{2}.$ \;Contradicts.\PfEnd\vspace{10pt}\quad
\Or $\dim\null S=n-\dim\range S\leqslant n-\dim\range TS.$ 又 $ST=0\Rightarrow\range T\subseteq\null S.$\par\quad
$\dim\range TS\leqslant\dim\range T\leqslant\dim\null S\leqslant n-\dim\range TS.$ \;Thus \;$2\dim\range TS\leqslant n.$\PfEnd\vspace{10pt}\quad
$\hspace{-2pt}\hText{$\Example \,\,\,Let $B_V=\Par{v_1,\dots,v_5}.$ \;Define$\\\;}\hText{T: \; v_1\mapsto 0, \;\;\, v_2\mapsto 0, \;\;\; v_i\mapsto v_i\;;\\\,S: \; v_1\mapsto v_4, \; v_2\mapsto v_5, \;\; v_i\mapsto 0\;;\;\; i=3,4,5.}$\vspace{6pt}
\SepLine
...
Note that $\forall v\in V,\exists\,!\,a_i\in\Fbb,v+U=\sum_{i=1}^m a_i v_i+U\Rightarrow\exists\,!\,b_i\in\Fbb,v-\sum_{i=1}^m a_i v_i=\sum_{i=1}^m b_i u_i\in U$\par\quad
...
(a) $\hMath{l}{\left|\;}{\right\}}{U\subseteq U+W\Rightarrow\Par{U+W}{^0}\subseteq U^0\\W\subseteq U+W\Rightarrow\Par{U+W}{^0}\subseteq W^0}\Rightarrow\Par{U+W}{^0}\subseteq U^0\cap W^0.$\vspace{4pt}\par\quad\Ha
...
(a) $\hMath{r}{\left|\;}{\right\}}{U\cap W\subseteq U\Rightarrow\Par{U\cap W}{^0}\supseteq U^0\\U\cap W\subseteq W\Rightarrow\Par{U\cap W}{^0}\supseteq W^0}\Rightarrow\Par{U\cap W}{^0}\supseteq U^0+W^0\;\Sbra{\supseteq U^0\cap W^0=\Par{U+W}{^0}.\,}$\par\vspace{4pt}\quad\Ha
...
(b) \!\Sbra[3pt]{{\tgsl Only in Finite-dim; Req $U,W$ Subsps}} \;Using Problem (22).\par\quad\Hb
...
Thus $B_V=\Par{u_1,\dots,u_n}.$ And $\varphi_i\Par{u_x}=\delta_{i,x}.$\PfEnd\vspace{6pt}\quad
