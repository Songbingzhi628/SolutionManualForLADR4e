...
\Anchor{2C4e14}\Anchor{2C4e15}\ProblemB[]{
	...
	\Blind{\PrePa}By {\TIPS}, $\Dim\Par{V_{\!1}\cap V_{\!2}\cap V_{\!3}}\geq\dim V_{\!1}+\dim V_{\!2}+\dim V_{\!3}\uline{{}-2\dim V}>0.$\TextB{\vspace{4pt}}
	\PrePb\TextB{$\dim V_{\!1}+\dim V_{\!2}+\dim V_{\!3} > 2\dim V$. Prove $V_{\!1}\cap V_{\!2}\cap V_{\!3}\neq\zeroSubs$.}
	\Blind{\PrePb}By {\TIPS}, $\Dim\Par{V_{\!1}\cap V_{\!2}\cap V_{\!3}}\uuline{{}>2\dim V}-\Dim\Par{V_{\!2}+V_{\!3}}-\Dim\Par{V_{\!1}+\Par{V_{\!2}\cap V_{\!3}}}\geq 0.$\PfEnd\vspace{14pt}
}\SepLine
\ChEnd\pagebreak
...
\ProblemN{\Anchor{3F34}{34}}{
	...
	\PrePa\TextA{Show $\Lambda$ is a liney map from $V$ to $V\apostrophe\apostrophe$.\vspace{2pt}}
	...
	\PrePc\TextA{Show if $V$ is finide, then {\tgsc $\Lambda$ is iso from $V$ onto $V$\hspace{1pt}$\apostrophe\apostrophe$}.\vspace{2pt}}
...
\Anchor{3FN16}\BulletPointX\NoteForSmall{Exe (16)}\TextB{}
%\TextA{Supp $V,W$ finide. Prove $\forall\mathcal{T}\in\Lm{W\apostrophe,V\apostrophe},\exists\,!\,T\in\Lm{V,W},T\apostrophe=\mathcal{T}.$}
Let $B_{\range\mathcal{T}}=\Par{\varphi_1,\dots,\varphi_p}$ with each $\varphi_k=\mathcal{T}\psi_k\Rightarrow\Par{\psi_1,\dots,\psi_p}$ liney indep.\TextB{}
Let $B_{V\apostrophe}=\Par{\varphi_1,\dots,\varphi_p,\gamma_1,\dots,\gamma_q}\Rightarrow B_V=\Par{v_1,\dots,v_p,u_1,\dots,u_q}.$\TextB{}
...
Define $T$ with each $Tv_i=w_i$ and each $Tu_j=0.$ Then each $T\apostrophe\Par{\beta_k}=\mathcal{T}\beta_k=0.$\TextB{}
...
\Or Let $B_V=\Par{v_1,\dots,v_n},B_{V\apostrophe}=\Par{\varphi_1,\dots,\varphi_n},B_W=\Par{w_1,\dots,w_m},B_{W\apostrophe}=\Par{\psi_1,\dots,\psi_m}.$\TextB{}
...
Note that each $E_{j,k}\!\!\upapostrophe\,\,\Par{\psi_x}=\psi_x\circ E_{j,k}=\delta_{k,x}\varphi_j=\reflectbox{\textit{E}}{_{k,j}}\Par{\psi_x}\Rightarrow E_{j,k}\!\!\upapostrophe\,\,=\reflectbox{\textit{E}}{_{k,j}}.$\TextB{}
By {\NOTEFOR} [3.60], $\forall T\in\Lm{V,W},T=\sum_{j=1}^n\sum_{k=1}^mA_{k,j}E_{j,k}\Rightarrow T\apostrophe=\sum_{j=1}^n\sum_{k=1}^mA_{k,j}\reflectbox{\textit{E}}{_{k,j}}.$
\SepLine
