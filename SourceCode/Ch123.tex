...
Fix one $k\in\Bra{1,\dots,m}.$ For $\lambda_1,\dots,\lambda_{k-1},\lambda_{k+1},\dots,\lambda_m\in\Fbb.$ Let $\lambda_k=1-\lambda_1-\dots-\lambda_{k-1}-\lambda_{k+1}-\dots-\lambda_m$\par\quad\Hc
