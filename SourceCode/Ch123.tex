...
{\Large\vspace{4pt}$\Rightarrow x^{k+1}=\displaystyle\frac{1}{a_{k+1}}\XPar{p_{k+1}\Par{x}-r_{k+1}\Par{x}}\in\Span{1,x,\dots,x^k,p_{k+1}}=\Span{p_0,p_1,\dots,p_k,p_{k+1}}$.}\par\vspace{2pt}\quad\Hii
...
{\Large $\Rightarrow x^{m-\SmallPar{k+1}}=\displaystyle\frac{1}{a_{m-\SmallPar{k+1},m-\SmallPar{k+1}}}\XPar{p_{m-\SmallPar{k+1}}\Par{x}-r_{m-\SmallPar{k+1}}\Par{x}}$\par}\vspace{4pt}\quad\Hii
