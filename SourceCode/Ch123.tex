...
\Blind{Note that $\range T\subsetneq\range S$}{ }$\Longleftrightarrow U_2$ and $\range S$ are not iso, so are $U_2$ and $U_1;\;$ $\underset{\text{By (3.D }\textsc{Tips}\text{)}}{\uline{\text{also }\null T\text{ and }\null S.}}$\par\vspace{-6pt}\quad
Let $U_1=\range E\mmid_{U_2}\oplus\Delta.$ 又 $\range E\mmid_{U_2}$ and $U_2$ are iso.\par\quad
Thus $U_1\oplus\null S=\range E\mmid_{U_2}\oplus\Par{\Delta\oplus\null S}=U_2\oplus\null T.$\par\quad
By (3.D \TIPS), $\null T$ and $\Par{\Delta\oplus\null S}$ are iso. Hence, if $\Delta$ is nonzero,\par\quad
