...
\BulletPointX\TipsN{1}\,\,\,Suppose $U,W\subseteq V.$ And $U,W,V$ are vecsps $\Rightarrow U,W$ are subsps of $V.$\TextB{}
\IndentTipsN{1}Then $U+W$ is also a subsp of $V.$ Because $\forall u\in U,w\in U,u+w\in V$ since $u,w\in V.$
\SepLine
...
\ProblemN{\hypertarget{1C24}{24}}{
	\TextNL{Let $V_{\!E}=\Bra{\,f\in\Rbb^{\Rbb}:\text{f is even}},V_{\!O}=\Bra{\,f\in\Rbb^{\Rbb}:\text{f is odd}}.$ Show that $V_{\!E}\oplus V_{\!O}=\Rbb^{\Rbb}.$\vspace{4pt}}
...
\BulletPointX\Largesl{Suppose $U,W,V_{\!1},V_{\!2},V_{\!3}$ are subsps of $V.$}\par
...
}Suppose $\Bra{U_{\alpha}}{_{\alpha\in\Gamma}}$ is a collection of subsps of $V$; here $\Gamma$ is an index set.\vspace{2pt}\par\quad
We show that $\bigcap_{\alpha\in\Gamma}U_\alpha,$ which equals the set of vecs that are in $U_\alpha$ for each $\alpha\in\Gamma$, is a subsp of $V$.\par\vspace{4pt}\,
$\begin{array}{l}$
...
\ExampleX[]{
	...
	\TextE{Prove that $U+W=\Bra{\Par{x,x,y,z}\in\Fbb^4}$.\vspace{2pt}}
}\TextB{}
...
\ProblemN{\hypertarget{1C23}{23}}{
	\TextNL{Give an example of vecsps $V_{\!1},V_{\!2},U$ such that $V_{\!1}\oplus U=V_{\!2}\oplus U$, but $V_{\!1}\neq V_{\!2}$.\vspace{3pt}}
}$V=\Fbb^2$,  $U=\Bra{\Par{x,x}\in\Fbb^2}$, $V_{\!1}=\Bra{\Par{x,0}\in\Fbb^2}$, $V_{\!2}=\Bra{\Par{0,x}\in\Fbb^2}$.\par
\SepLine

\ProblemB{
	\TipsN{2}\,\,\,\TextB{Suppose $V_{\!1}\subseteq V_{\!2}$ in Exercise {\tgnr(23)}. Prove that $V_{\!1}=V_{\!2}.$}
}\par\quad
Because the subset $V_{\!1}$ of vecsp $V_{\!2}$ is closed under add and scalar multi, $V_{\!1}$ is a subspace of $V_{\!2}.$\par\quad
Suppose $W$ is such that $V_{\!2}=V_{\!1}\oplus W.$ Now $V_{\!2}\oplus U=\Par{V_{\!1}\oplus W}\oplus U=\Par{V_{\!1}\oplus U}\oplus W=V_{\!1}\oplus U.$\par\quad
If $W\neq\zeroSubs,$ then $V_{\!1}\oplus U\subsetneq\Par{V_{\!1}\oplus U}\oplus W$, contradicts. Hence $W=\zeroSubs,V_{\!1}=V_{\!2}.$\PfEnd
\SepLine

\ProblemB{
	\TextB{Suppose $V_{\!1},V_{\!2},U_1,U_2$ are vecsps, $V_{\!1}\oplus U_1=V_{\!2}\oplus U_2,\;V_{\!1}\subseteq V_{\!2},\;U_2\subseteq U_1.$}
	\TextB{Prove or give a counterexample\hspace{1pt}$:$ $V_{\!1}=V_{\!2},\;U_1=U_2.$}
}Let $U_2=\zeroSubs.$ Give an example that each of $V_1,V_2,U_1$ is nonzero.\par\vspace{-58pt}\quad
\hspace{450pt}\includegraphics[width=2.4cm,height=1.2cm,scale=0.22]{diagram1C-1.png}\vspace{18pt}\PfEnd
\SepLine

\ProblemB{
	\TipsN{3}\,\,\,\TextB{Suppose the intersection of any two of the vecsps $U,W,X,Y$ is $\zeroSubs.$}
	\IndentTipsN{3}\TextB{Give an example that $\BigPar{X\oplus U}\,${\LARGE$\cap$}$\,\BigPar{Y\oplus W}\neq\zeroSubs.$}
}\Sbra{ Using notations in Chapter 2. } \;Let $B_X=\Par{e_1},B_U=\Par{e_2-e_1},B_Y=\Par{\,},B_W=\Par{e_2}.$
\SepLine

\ProblemB{
	\TipsN{4}\,\,\,\TextB{Let $V=U+W,\;I=U\cap W,\,U=I\oplus X,\,W=I\oplus Y.$ Prove that $V=I\oplus\Par{X\oplus Y}.$}
}We show that $X\cap Y=U\cap Y=W\cap X=\zeroSubs$ by contradiction.\parSol{}
...
Now we show that $V=I+\Par{X+Y}.$ \;$\forall v\in V,v=u+w,\exists\,\Par{u,w}\in U\times W$\parSol{}
$\Rightarrow\exists\,\Par{i_u,x_u}\in I\times X,\,\Par{i_w,y_w}\in I\times Y,\;v=\Par{i_u+i_w}+x_u+y_w\in I+\Par{X+Y}.$\PfEnd
\SepLine

%\ProblemB{
%	\TipsN{3}\,\,\,\TextB{Let $V=U+W,\,I=U\cap W,\,U=I\oplus X,W=I\oplus Y.$ Prove that $V=I\oplus\Par{X\oplus Y}.$}
...
\ProblemN{\hypertarget{2A1}{1}}{
	\TextN{Prove that [P] $\Par{v_1,v_2,v_3,v_4}$ spans $V\Longleftrightarrow\BigPar{v_1-v_2,v_2-v_3,v_3-v_4,v_4}$ also spans V [Q].}
}Note that $V=\Span{v_1,\dots,v_n}\Longleftrightarrow\forall v\in V,\exists\,a_1,\dots,a_n\in\Fbb,v=a_1v_1+\dots+a_nv_n.$\par\quad
Assume that $\forall v\in V,\exists\,a_1,\dots,a_4,b_1,\dots,b_4\in\Fbb,$ \BigPar{ that is, if $\exists\,a_i,$ then we are to find $b_i,$ vice versa }\par\quad
...
Then $a_k=b_k+\dots+b_m;\;\;a_{k+1}=b_{k+1}+\dots+b_m\Rightarrow b_k=a_k-a_{k+1};\;b_m=a_m.$ Similar to Problem (1).\vspace{4pt}\par\quad
...
\Or By (a), let $W=\Span{v_1,\dots,v_m}=\Span{w_1,\dots,w_m}.$ Suppose $\Par{w_1,\dots,w_m}$ is linely dep.\par\quad\Hb
By [2.21](b), a list of length $\Par{m-1}$ spans $W.$ 又 By [2.23], $\Par{w_1,\dots,w_m}$ linely inde $\Rightarrow m\leqslant m-1.$\par\quad\Hb
...
Thus $\Par{1,x,\dots,x^m}$ is linely inde in $\Rbb^{[0,1]}.$ Similar to [2.16], $U$ is infinite-dim.\PfEnd\vspace{8pt}\quad
\Or Note that\; $\Frac{\;1\;}{1}>\Frac{\;1\;}{2}>\dots>\Frac{\;1\;}{m},\,\,\,\forall m\in\Nbp.$ Suppose\; $f_m=\MathLeftBrace{l}{
...
by the steps in [2.23] trivially, $\Par{p_0,p_1,\dots,p_m}$ of length $\Par{m+1}$ spans $\PoF{m}.$ Contradicts.\PfEnd\vspace{8pt}\par\quad
...
}A counterexample\hspace{1pt}: Let $V=\Rbb^4$ and $B_V=\Par{e_1,e_2,e_3,e_4}$ be std basis.\par\quad
...
Now consider the field $\Bra{0,1}$ containing only the add identity and multi identity,\parSol{}
...
\ProblemBnoor{\hypertarget{2B4e5}{4E 5}}{
	...
	\TextB{Prove that $\exists\,B_V$ consisting of vecs in $U\cup W$.\vspace{-4pt}}
...
\ProblemN{\hypertarget{2C15}{15}}{
	...
	\TextNL{Prove that $\exists$ one-dim subsps $V_{\!1},\dots,V_{\!n}$ of $V$ such that $V=V_{\!1}\oplus \dots\oplus V_{\!n}.$}
}Suppose $B_V=\Par{v_1,\dots,v_n}.$ Define $V_{\!i}$ by $V_{\!i}=\Span{v_i}$ for each $i\in\Bra{1,\dots,n}.$\parSol{}
...
\Comment \,\,\,Let $B_V=\Par{v_1,\dots,v_n}$ and suppose $v=u_1+\dots+u_n,$ where each $u_i=a_i v_i\in V_{\!i}.$\parCom
...
\ProblemN{\hypertarget{2C9}{9}}{
	...
	\TextN{Prove that $\dim\Span[\BigPar]{v_1+w,\dots,v_m+w}\geq m-1$.}
...
$\Par{v_1,\dots,v_m}$ linely inde $\Rightarrow$ $\BigPar{v_1,v_2-v_1,\dots,v_m-v_1}$ linely inde $\Rightarrow$ $\underbrace{\BigPar{v_2-v_1,_{}\dots,v_m-v_1}}_{\text{of length }\Par{m-1}}$ linely inde.\vspace{-15pt}\par\quad
...
And because $\forall v\in \bigcap\limits_{i=1}^{n-m}U_i,v=v_0+b_1 u_1+\dots+b_{n-m} u_{n-m}\in U_i\Rightarrow$ each $b_i=0\Rightarrow v\in U.$\vspace{-4pt}\parSol{}
...
(a) If $p_0,p_1,\dots,p_m$ are such that all $a_{k,k}\neq 0,$ and\TextB{}
...
(b) If $p_0,p_1,\dots,p_m$ are such that all $a_{k,k}\neq 0,$ and\TextB{}
...
\ProblemN{\hypertarget{2C10}{10}}{
	\TextNL{Suppose $m\in\Nbp,\;p_0,p_1,\dots,p_m\in\PoFi$ are such that each $p_k$ has degree $k.$}
...
(ii) {$1\leqslant k\leqslant m-1.$ \;Assume that $\Span[\BigPar]{p_0,p_1,\dots,p_k}=\Span[\BigPar]{1,x,\dots,x^k}.$}\par\quad\Hii
...
(ii) {$1\leqslant k\leqslant m-1.$ \;Assume that $\Span[\BigPar]{x^m,\dots,x^{m-k}}=\Span[\BigPar]{p_m,\dots,p_{m-k}}.$}\par\quad\Hii
...
For convenicence, we assume that $z^0=1$ in formula deduction and poly def. Absolutely without $0^0.$
\SepLine
...
\ProblemBnoor{\hypertarget{2C4e10}4E 10}{
	...
	\TextB{Show that $\Par{p_0,\dots,p_m}$ is a basis of $\PoF{m}$.\vspace{0pt}}
...
We use induction on to show that $S\Par{m}$ holds for all $m\in\Nbp.$\vspace{2pt}\par\quad
...
(ii) $1\leqslant m.$ \;Assume that $S\Par{m}$ and $S\Par{m-1}$ holds. Now we show that $S\Par{m+1}$ holds.\vspace{2pt}\par\quad\Hii
Suppose $\sum_{k=0}^{m+1}a_kp_{k,m+1}\Par{x}=\sum_{k=0}^{m+1}a_k\Sbra{x^k\Par{1-x}{^{m+1-k}}}=0,\forall x\in\Fbb.$\vspace{6pt}\par\quad\Hii
...
\envFontDefault{\vspace{4pt}Hence \;$\sum_{k=0}^{m-1}a_{k+1}p_{k,m-1}\Par{x}=0,\forall x\in\Fbb\Backslash{\def\envFont{\envFontB}\Bra{\,0,1}}.$ Which has infinitely many zeros.}\par\quad\Hii
Moreover, \;$\sum_{k=0}^{m-1}a_{k+1}p_{k,m-1}\Par{x}=0.$ By assumption, $a_1=\dots=a_{m-1}=a_{m}=0.$\par\quad\Hii
Thus $\Par{p_{0,m+1},\dots,p_{m+1,m+1}}$ is linely inde and $S\Par{m+1}$ holds.\PfEnd
\SepLine

\ProblemN{\hypertarget{2C14}{14}}{
	\TextNL{Suppose $V_{\!1},\dots,V_{\!m}$ are finite-dim. Prove that $\dim\!\Par{V_{\!1}+\dots+V_{\!m}}\leqslant\dim V_{\!1}+\dots+\dim V_{\!m}$.}
...
\ProblemN{\hypertarget{2C17}{17}}{
	\TextNL{Suppose $V_{\!1},V_{\!2},V_{\!3}$ are subsps of a finite-dim vecsp, then}
...
Because \;\;$\cMid{X\cup Y}=\cMid{X}+\cMid{Y}-\cMid{X\cap Y};\,\,\,\Par{X\cup Y}\cap Z=\Par{X\cap Z}\cup\Par{Y\cap Z}$.\par\quad
...
For example, $X=\Bra{\Par{x,0}\in\Rbb^2:x\in\Rbb},Y=\Bra{\Par{0,y}\in\Rbb^2:y\in\Rbb},Z=\Bra{\Par{z,z}\in\Rbb^2:z\in\Rbb}.$\par\vspace{2pt}\quad
...
However, $\Par{X+Y}\cap Z\supseteq\Par{X\cap Z}+\Par{Y\cap Z}$ holds. Because $\forall v\in\Par{X\cap Z}+\Par{Y\cap Z},$\par\quad
...
\BulletPointX\Corollary \,\,\,\Largesl{Suppose $V_{\!1},V_{\!2},V_{\!3}$ are finite-dim, then} {\small $\Frac{\Par{1}+\Par{2}+\Par{3}}{3}$}:\vspace{-4pt}\par
...
\BulletPointX\Tips \,\,\,Because $\dim \Par{V_{\!1}\cap V_{\!2}\cap V_{\!3}}=\dim V_{\!1}+\Dim\Par{V_{\!2}\cap V_{\!3}}-\Dim\BigPar{V_{\!1}+\Par{V_{\!2}\cap V_{\!3}}}.$\TextB{}
...
\ProblemB[]{
	\TextB{Suppose $V_{\!1},V_{\!2},V_{\!3}$ are subsps of $V$ with}
	\hypertarget{2C4e14}{}(a) \TextB{$\dim V=10,\;\dim V_{\!1} = \dim V_{\!2} = \dim V_{\!3} = 7$. Prove that $V_{\!1}\cap V_{\!2}\cap V_{\!3}\neq\zeroSubs$.}
	\Blind{(a)} By {\TIPS}, $\Dim\Par{V_{\!1}\cap V_{\!2}\cap V_{\!3}}\geq\dim V_{\!1}+\dim V_{\!2}+\dim V_{\!3}\uline{{}-2\dim V}>0.$\TextB{\vspace{4pt}}
	\hypertarget{2C4e15}{}(b) \TextB{$\dim V_{\!1}+\dim V_{\!2}+\dim V_{\!3} > 2\dim V$. Prove that $V_{\!1}\cap V_{\!2}\cap V_{\!3}\neq\zeroSubs$.}
...
\ProblemN[]{\hypertarget{3A5}{5}}{
	\TextN{Because $\Lm{V,W}=\Bra{T:V\rightarrow W\;{\envFontHuge\envFontA\mmid}\;T\text{ is linear}}$ is a subsp of $W^V,$ $\Lm{V,W}$ is a vecsp.}
}\SepLine
...
\ProblemB{
	\hypertarget{3A4e10}{}\TextB{Prove that if $q\in\PoRi$ and $T:\PoRi\rightarrow\PoRi$ is defined by $\underbrace{Tp=q\circ p}_{composition},$ then $T$ is not linear.\vspace{-8pt}}
...
\Or We prove the contrapositive\hspace{1pt}: \,Suppose $\forall w_1,\dots,w_m\in W,\exists\,T\in\Lm{V,W},Tv_k=w_k$  for each $w_k.$\par\quad
...
\Blind{\Or \;}{\Large\vspace{6pt}Suppose $v\in V.$ Define $S_v\in\Lm{V}$ by $S_v \Par{u}=\varphi\Par{u}v.$}\par\quad
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Suppose $T\in\Lm{V,W}$ and $T\mmid_U$ is inje. Let $V=M+N,\;U=X+Y.$\vspace{0pt}}
	{\IndentTipsN{2}}\TextB{Then $\range T=\range T\mmid_M+\range T\mmid_N=\range T\mmid_X+\range T\mmid_Y.$\vspace{1pt}}
	{\IndentTipsN{2}}(a) \TextB{Show that if $U=X\oplus Y,$ then $\range T=\range T\mmid_X\oplus\range T\mmid_Y.$\vspace{1pt}}
	{\IndentTipsN{2}}(b) \TextB{Give an example such that $V=M\oplus N,\;\range T\neq\range T\mmid_M\oplus\range T\mmid_N.$}
}Assume that for some $v\in V,$ there exist two distinct pairs $\Par{x_1,y_1},\Par{x_2,y_2}$ in $X\times Y$\parSol{}
such that $Tv=Tx_1+Ty_1=Tx_2+Ty_2.$ Because $\forall v\in X\oplus Y,\exists\,!\,\Par{x,y}\in X\times Y,v=x+y.$\parSol{}
Now $T\Par{x_1+y_1}=T\Par{x_2+y_2}\Longrightarrow x_1+y_1=x_2+y_2\Longrightarrow x_1=x_2,y_1=y_2.$ Contradicts.\parSol{}
...
We have shown $Q\Rightarrow P.$ Now we show that $P\Rightarrow Q$ to complete the proof.\parCor
...
\uline{Then $T=T\circ i.$} Because $\forall v\in V,T\Par{v}=T\Par{u_v+x_v+y_v}=T\Par{u_v}=T\Par{u_v+x_v}=T\BigPar{i\Par{v}}=\Par{T\circ i}\Par{v}.$\par
\SepLine
...
Thus $U+\null T=V.$ \;\Or $\range T=\Bra{Tu:u\in U}=\range T\mmid_U.$ Using Problem (12).\PfEnd\vspace{2pt}
...
\ProblemB{
	\TextB{Suppose $T\in\Lm{V},v\in V,$ and $n\in\Nbp$ such that $T^{n-1}v\neq 0,\;T^nv=0.$\qquad\large\envFontDefault\tgnr\Sbra{See [5.16]}}
	\TextB{Prove that $\BigPar{v,Tv,\dots,T^{n-1}v}$ is linely inde.}
...
\Or \NOTICE that $V=U\oplus\null T.$ By Problem (12), $\range T=\range T\mmid_U.$\parSol{}
...
\ProblemN{\hypertarget{3B23}{23}}{
	\TextNL{Suppose $V$ is finite-dim, $S\in\Lm{V,W},T\in\Lm{U,V}$.}
...
\ProblemB{
	%(a) \TextB{Suppose $\dim V = 5,$ and $ST = 0$ where $S,T\in\Lm{V}$. Prove that $\dim\range TS\leqslant 2.$\vspace{2pt}}
	\hypertarget{3B4e24}{}(a) \TextB{Suppose $\dim V=n,$ \,$ST=0$ where $S,T\in\Lm{V}.$ Prove that $\dim\range TS\leqslant\Big\lfloor${\LARGE$\frac{\,n\,}{2}$}$\Big\rfloor.$}
	(b) \TextB{Give an example of such $S, T$ with $n=5$ and $\dim\range TS = 2$.\vspace{1pt}}
}Note that $\dim\range TS\leqslant\min\!\envFontLarge\Bra{\!\dim\range T,\dim\range S}.$ We prove by contradiction.\par\vspace{1pt}\quad
...
%又 $\dim\null ST=5\leqslant\dim\null S+\dim\null T\leqslant 4.$ Contradicts.\vspace{6pt}\par\quad\Ha
...
Assume that $\dim\range TS\geqslant \Big\lfloor${\Large$\frac{\,n\,}{2}$}$\Big\rfloor+1.$ \,Then $\min\!\envFontLarge\Bra{n-\dim\null T,n-\dim\null S}\envFontDefault\geqslant \Big\lfloor${\Large$\frac{\,n\,}{2}$}$\Big\rfloor+1$\vspace{1pt}\par\quad
...
Thus \;$n\leqslant 2\envFontLarge\BigPar{\envFontDefault \Big\lceil${\Large$\frac{\,n\,}{2}$}$\Big\rceil-1\envFontLarge}\envFontDefault\Rightarrow{}${\Large$\frac{\,n\,}{2}$}${}\leqslant\Big\lceil${\Large$\frac{\,n\,}{2}$}$\Big\rceil-1$. \;Contradicts.\PfEnd\vspace{4pt}\quad
...
\Or Because $\dim\range TS\leqslant\Big\lfloor${\Large$\frac{\,n\,}{2}$}$\Big\rfloor,$ and $\Big\lfloor${\Large$\frac{\,n\,}{2}$}$\Big\rfloor+\Big\lceil${\Large$\frac{\,n\,}{2}$}$\Big\rceil=n.$\par\vspace{1pt}\quad
...
\ProblemN{\hypertarget{3B26}{26}}{
	\TextNL{Suppose $D\in\Lm[\BigPar]{\PoRi}$ and $\forall p,\Deg\BigPar{Dp}=\Par{\!\deg p}-1.$ \;Prove that $D\in\PoRi$ is surj.\vspace{2pt}}
...
Because $B_{\PoR[\SmallPar]{m}}=\Par{p_1,\dots,p_m,p_{m+1}}.$ And for all $p\in\PoRi,\exists\,!\,m=\deg p\in\Nbp.$\par\quad
...
(ii) {Suppose we have defined $Dp_0=1,Dp_k=x^k$ for each $k\in\Bra{1,\dots,n}.$ Because $\deg D\Par{x^{n+2}}=n+1.$}\vspace{2pt}\par\quad\Hii
...
\ProblemN{\hypertarget{3B20}{}\hypertarget{3B21}{20, 21}}{
	...
	\Blind{\Onumber{20, 21} }(c) \Text{Suppose $S\in\Lm{W,V}.$ Prove that if $S$ is surj, then $\exists\,T\in\Lm{V,W},\;ST=I.$\vspace{2pt}}
}\par\quad
...
Let $V=U\oplus\null S\Rightarrow S\mmid_U:U\rightarrow\range S$ is an iso. Because $\Par{S\mmid_U}{^{-1}}:\underset{\supseteq\,\range T}{\uline{\range S}}\rightarrow U.$\par\vspace{-12pt}\quad
...
\ProblemN{\hypertarget{3B28}{28}}{
	...
	(a) \TextNL{Prove that $\exists\,\varphi_1,\dots,\varphi_m\in\Lm{V,\Fbb}$ such that $\forall v\in V,Tv=\varphi_1\Par{v}w_1+\dots+\varphi_m\Par{v}w_m$.\vspace{2pt}}
	...
	\Blind{(b) {\envFontSmall\normalsize\Sbra{4E 3.F.5}}} \TextNL{Thus defining each $\varphi_i:V\rightarrow\Fbb.$ Show that each $\varphi_i\in\Lm{V,\Fbb}.$}
...
\ProblemN{\hypertarget{3B30}{30}}{
	\TextNL{Suppose $\varphi,\beta\in\Lm{V,\Fbb}$ and $\null\varphi=\null\beta=\eta.$ Prove that $\exists\,c\in\Fbb,\varphi=c\beta.$}
}If $\eta=V$, then $\varphi=\beta=0,$ we are done. Now by Problem (29),\par\quad
...
\BulletPointX\NoteForSmall{Transpose}\;\;{\normalsize\envFontSmall\Sbra{\hypertarget{3F33}{3.F.33}}}\;Define $\fT:A\rightarrow A^t.$ By [3.111], $\fT$ is linear. Because $\Par{A^t}{^t}=A.$ \TextB{}
...
Now we show that (a) \uline{$\fT\fR_j=\fC_j\fT,$} \,(b) \uline{$\fT\fC_k=\fR_k\fT,$} \,and (c) \uline{$\fT\fP_{j,k}=\fP_{k,j}\fT.$}\TextB{\vspace{2pt}}
...
\ProblemBnoor[]{4E 3.51}[\Sbra]{
	Suppose $C\in\Fbb^{m,c},R\in\Fbb^{c,p}$. \hfill\Sbra{ See also {\NOTEFOR} [3.49] and Problem (10). }\TextB{\vspace{2pt}}
...
\ProblemB{
	...
	(a) \TextB{Suppose $S_c=\Span[\BigPar]{A_{\cdot,1},\cdots,A_{\cdot,n}}\subseteq\Fbb^{m,1},\dim S_c=c,\text{ the col rank}.$ Let $p=c.$\vspace{3pt}}
	(b) \TextB{Suppose $S_r=\Span[\BigPar]{A_{1,\cdot},\cdots,A_{m,\cdot}}\subseteq\Fbb^{1,n},\dim S_r=r,\text{ the row rank}.$ Let $p=r.$\vspace{3pt}}
...
$P\Rightarrow Q:$\,\;Because $\dim S_c=\dim S_r=1.$\vspace{4pt}\par\quad
...
%(b) Suppose the rows of $A$ are linely inde, so are the cols of $A^t$. \NOTICE that $A^t$ has $\dim V\apostrophe$ cols.
...
\ProblemB{
	\TipsN{1}\,\,\,\TextB{Suppose $T\in\Lm{V,W},\;B_V=\Par{v_1,\dots,v_n},B_W=\Par{w_1,\dots,w_m}.$\vspace{-1pt}}
	...
	\IndentTipsN{1}(a) \TextB{Show that [P] $L$ is linely inde $\Longleftrightarrow M$ is linely inde. [Q]\vspace{2pt}}
	\IndentTipsN{1}(b) \TextB{Show that [P] $\Spn L=W\Longleftrightarrow\Spn M=\Fbb^{m,1}.$ [Q]\hfill\large\envFontDefault\Sbra{ Let $A=\Mt{T,B_V,B_W}.$\hspace{1pt}}}
}\par\quad
...
(a) $P\Rightarrow Q:$\,\;Suppose $\;c_1A_{\cdot,{\alpha_1}}+\dots+c_kA_{\cdot,{\alpha_k}}=0.$ \;Let $v=c_1v_{\alpha_1}+\dots+c_kv_{\alpha_k}.$\par\quad\Ha
...
$Q\Rightarrow P:$\,\;Because $c_1Tv_{\alpha_1}+\dots+c_kTv_{\alpha_k}=0.$ For each $i\in\Bra{1,\dots,m},\;c_1A_{i,{\alpha_1}}+\dots+c_kA_{i,{\alpha_k}}=0.$\par\quad\Ha
...
$P\Rightarrow Q:$\,\;Suppose each $w_i=Iw_i=J_{1,i}Tv_{\alpha_1}+\dots+J_{k,i}Tv_{\alpha_k}.$\par\quad\Hb
...
\Blind{$Q\Rightarrow P:$\,\;}Because $w=a_1\BigPar{J_{1,1}Tv_{\alpha_1}+\dots+J_{k,1}Tv_{\alpha_k}}+\dots+a_m\BigPar{J_{1,m}Tv_{\alpha_1}+\dots+J_{k,m}Tv_{\alpha_k}}$\par\vspace{2pt}\quad\Hb
\Blind{$Q\Rightarrow P:$\,\;Because} $\Blind{w}=\BigPar{a_1J_{1,1}+\dots+a_mJ_{1,m}}Tv_{\alpha_1}+\dots+\BigPar{a_1J_{k,1}+\dots+a_mJ_{k,m}}Tv_{\alpha_k}.$\par\vspace{2pt}\quad\Hb
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Suppose $p$ is a poly of $\,n\,$ variables in $\Fbb.$}
	\IndentTipsN{2}\TextB{Prove that $\Mt[\BigPar]{p\Par{T_1,\dots,T_n}}=p\BigPar{\Mt{T_1},\dots,\Mt{T_n}}.$}
	\IndentTipsN{2}\TextB{\large\envFontDefault Where the linear maps $T_1,\dots,T_n$ are such that $p\Par{T_1,\dots,T_n}$ makes sense. \tgnr See [5.16,17,20].}
...
\BulletPointX\Corollary \,\,\,Suppose $\tau$ is an algebraic property. Then $\tau$ holds for linear maps $\Longleftrightarrow \tau$ holds for matrices.\parCor{\IndentB}
...
\Or Suppose $B_{\range T}=\Par{w}.$ \,By \Sbra{2.C {\NOTEFOR} (15)}, $\exists\,B_W=\Par{w_1,\dots,w_m},\;w=w_1+\dots+w_m.$\par\quad\Hb
...
\Or Using Problem (4). Let $B_{W\apostrophe}$ be the $B_V.$\par\quad
Now $\exists\,B_{V\apostrophe}$ such that $\Mt{T\apostrophe,B_{W\apostrophe}\,,B_{V\apostrophe}}{_{\cdot,1}}={\small\begin{pmatrix}1&0&\cdots&0\end{pmatrix}}{^t}$ or ${\small\begin{pmatrix}0&\cdots&0\end{pmatrix}}{^t}.$\par\quad
Which is equiv to $\exists\,B_V$ \Sbra{Using (3.F.31)} such that $\Mt{T,B_V,B_W}{_{1,\cdot}}={\small\begin{pmatrix}1&0&\cdots&0\end{pmatrix}}$ or ${\small\begin{pmatrix}0&\cdots&0\end{pmatrix}}.$\PfEnd
\SepLine
\ChEnd
...
\BulletPointX\NoteForSmall{[3.62]}\;\;$\Mt{v}=\Mt[\BigPar]{I,\Par{v},B_V}.$ Where $I$ is the identity operator restricted to $\Span{v}.$\par\vspace{2pt}
...
\ProblemBnoor{4E 23, \OR \hypertarget{3D4e23}{10.A.4}}{
	...
	\TextB{Let $T\in\Lm{V}$ be such that each $T\alpha_k = \beta_k.$ Prove that $\Mt{T,\alpha\rightarrow\alpha}=\Mt{I,\beta\rightarrow\alpha}.$}
...
\ProblemBnoor{\hypertarget{3D4e20}{4E 20}}{
	\TextB{Suppose $q\in\PoRi.$ Prove that $\exists\,p\in\PoRi,q\Par{x} = \Par{x^2 + x}p\apostrophe\apostrophe\Par{x} + 2xp\apostrophe\Par{x} + p\Par{3}.$\vspace{1pt}}
...
\ProblemN{\hypertarget{3D19}{19}}{
	\TextNL{Suppose $T\in\Lm[\BigPar]{\PoRi}$ is inje. And $\deg Tp\leqslant\deg p$ for every nonzero $p\in\PoRi$.}
...
(ii) Assume $\forall s\in\PoR{n},\deg s=\deg Ts.$ We show $\forall p\in\PoR{n+1},\deg Tp=\deg p$ by contradiction.\par\quad\Hii
Suppose $\exists\,r\in\PoR{n+1},\;\deg Tr\leqslant n<n+1=\deg r.$ Then by (a), $\exists\,s\in\PoR{n},\;T\Par{s}=\Par{Tr}.$\par\quad\Hii
...
\ProblemN{\hypertarget{3E2}{2}}{
	\TextN{Suppose $V_{\!1}\times\dots\times V_{\!m}$ is finite-dim. Prove that each $V_{\!j}$ is finite-dim.}
}\par\quad
For any $k\in\Bra{1,\dots,m},$ define $S_k\in\Lm{V_{\!1}\times\dots\times V_{\!m},V_{\!k}}$ by $S_k\Par{v_1,\dots,v_m}=v_k.$\par\quad
Then $S_k$ is linear map. By [3.22], $\range S_k=V_{\!k}$ is finite-dim.\PfEnd\vspace{6pt}\par\quad
...
We show that each $U_i$ is iso to $V_{\!i}.$ Then $U$ is finite-dim $\Longrightarrow$ its subsp $U_i$ is  finite-dim, so is $V_{\!i}.$\par\vspace{2pt}\quad
...
\ProblemN{\hypertarget{3E4}{4}}{
	\TextN{Prove that $\Lm{V_{\!1}\times\cdots\times V_{\!m},W}$ and $\Lm{V_{\!1},W}\times\cdots\times\Lm{V_{\!m},W}$ are iso.}
...
Because $\BigPar{\Par{v-w}+u}\in U$ or $u-u\apostrophe\in U$ needs that $U$ is closed under add.\parCom{\IndentB}
And because $\Par{v-\hat{v}}+\Par{w-\hat{w}}\in U$ and $\lambda\Par{v-\hat{v}}\in U$ assume that $U$ is a subsp.\vspace{4pt}\parCom{\IndentB}
...
\ProblemBnoor{\hypertarget{3E4e8}{4E 8}}{
	\TextB{Suppose $T\in\Lm{V,W},w\in\range T.$ Prove that $\Bra{v\in V:Tv=w}=u+\null T.$}
}{\def\mK{\mathcal{K}_{\!u}}Let $\mK=\Bra{v\in V:Tv=w}.$ \Sbra{ Not a vecsp.\hspace{1pt}} \;Suppose $u\in\mK.$ Then $u+\null T\subseteq\mK.$\parSol{}
...
(a) Suppose $A=a+U.$ Then $\lambda\Par{a+u_1}+\Par{1-\lambda}\Par{a+u_2}=a+\BigPar{\lambda\Par{u_1-u_2}+u_2}\in A.$\vspace{2pt}\par\quad
(b) Suppose $\lambda v+\Par{1-\lambda}w\in A,\forall v,w\in A,\lambda\in\Fbb.$ \;Suppose \uline{$a\in A$} and let $A\apostrophe=\Bra{x-a:x\in A}.$\par\Hb\quad
...
(II) Because $\lambda\Par{v-a}+\Par{1-\lambda}\Par{w-a}=\Sbra{\lambda v+\Par{1-\lambda}w}-a\in A\apostrophe.$\par\Hb\quad\HII
...
Thus $A\apostrophe=-a+A$ is a subsp of $V.$ Hence $a+A\apostrophe=a+\Bra{x-a:x\in A}=A$ is a translate.\PfEnd
\SepLine\pagebreak

\ProblemN{\hypertarget{3E9}{9}}{
	\TextN{Suppose $A=v+U$ and $B=x+W$ for some $v,x\in V$ and some subsps $U,W$ of $V$.}
	\TextN{Prove that $A\cap B$ is either a translate of some subsp of $V$ or is $\emptySet$.}
}$\forall v+u,x+w\in A\cap B\neq\emptySet,\lambda\in\Fbb,\lambda\Par{v+u}+\Par{1-\lambda}\Par{x+w}\in A\cap B.$ By Problem (8).\PfEnd\parSol{}
\Or Let $A=v+U,\;B=x+W.$ \;Suppose $\alpha\in\Par{v+U}\cap\Par{x+W}\neq\emptySet.$\parSol{}
Then $\alpha-v\in U\Rightarrow \alpha+U=v+U=A,$ and $\alpha-x\in W\Rightarrow \alpha+W=x+W=B.$\parSol{}
We show that $A\cap B=\alpha+\Par{U\cap W}.$ Note that $\alpha+\Par{U\cap W}\subseteq A\cap B.$\parSol{}
...
\ProblemN{\hypertarget{3E10}{10}}{
	\TextNL{Prove that the intersection of any collection of translates of subsps}
	\TextNL{is either a translate of some subsps or $\emptySet.$}
}Suppose $\Bra{A_{\alpha}}{_{\alpha\in\Gamma}}$ is a collection of translates of subsps of $V$, where $\Gamma$ is an index set.\vspace{2pt}\parSol{}
$\forall x,y\in\bigcap_{\alpha\in\Gamma}A_{\alpha}\neq\emptySet,\lambda\in\Fbb,\lambda x+\Par{1-\lambda}y\in A_{\alpha}$ for each $\alpha.$ By Problem (8).\PfEnd\parSol{\vspace{6pt}}
...
We show that $\bigcap_{\alpha\in\Gamma}A_\alpha=\bigcap_{\alpha\in\Gamma}\Par{x+V_{\!\alpha}}=x+\bigcap_{\alpha\in\Gamma}V_{\!\alpha}.$\parSol{}
...
\ProblemN{\hypertarget{3E11}{11}}{
	...
	(c) \TextNL{Prove that $A$ is a translate of some subsp of $V$ of dim less than $m.$\vspace{2pt}}
}(a) By Problem (8), $\forall u, w\in A,\lambda\in\Fbb,\lambda u+\Par{1-\lambda}w=\XPar{\lambda\sum_{i=1}^m a_i+\Par{1-\lambda}\sum_{i=1}^m b_i}v_i\in A.$\par\vspace{4pt}\quad
(b) Suppose $B=v+U,$ where $v\in V$ and $U$ is a subsp of $V.$ \uline{Let each $v_k=v+u_k\in B,\exists\,!\,u_k\in U.$}\par\vspace{2pt}\quad\Hb
...
\Or Let $v=\lambda_1 v_1+\dots+\lambda_m v_m\in A$. To show that $v\in B$, use induction on $m$ by $k$.\par\quad\Hb
(i) $k=1,v=\lambda_1 v_1\Rightarrow \lambda_1=1.$ 又 $v_1\in B.$ Hence $v\in B$.\par\quad\Hb\Hi
\vspace{4pt}$k=2,v=\lambda_1 v_1+\lambda_2 v_2\Rightarrow\lambda_2=1-\lambda_1.$ 又 $v_1,v_2\in B.$ By Problem (8), $v\in B$.\par\quad\Hb\Endi
(ii) $2\leqslant k<m.$ Assume that $v=\lambda_1 v_1+\dots+\lambda_k v_k\in A\subseteq B.\;\Sbra{\forall\lambda_i$ such that $\sum_{i=1}^k\lambda_i=1}$\par\quad\Hb\Hii
...
(c) If $m=1,$ then let $A=v_1+\zeroSubs$ and we are done. \;Now suppose $m\geqslant 2.$ Fix one $k\in\Bra{1,\dots,m}.$\par\quad\Hc
...
\BulletPointX\NoteFor{[3.88, 3.90, 3.91]}\;\;{Suppose $W\in\mathcal{S}_{\!V} U.$ Then $V\XSlash U$ is iso to $W.$}\TextB{}
{Because $\forall v\in V,\exists\,!\,u_v\in U,w_v\in W,v=u_v+w_v.$ \uline{Define $T\in\Lm{V}$ by $T\Par{v}=w_v.$}}\TextB{}
...
\BulletPointX\TipsN{1}\,\,\,{Suppose $U$ is a subsp of $V.$ \uline{Define $S\in\Lm{V\XSlash U,V}$ by $S\Par{v+U}=v.$}}\TextB{}
{Then $\range S$ is the {\tgsl purest} in $\mathcal{S}_{\!V} U.$ Now $\null S=\zeroSubs,\;U\oplus\range S=V.$}\TextB{}
{\uline{Let $E=S\circ\pi.$} Because $S$ is inje and $\pi$ is surj, $\null E=\null\pi=U,\;\range E=\range S.$}\TextB{}
...
{because $e_2=e_1+\Par{e_2-e_1},$ now still, $\tilde{T}\BigPar{\Par{e_2-e_1}+U}=e_2-e_1=Te_2.$}\TextE{}
...
Because $\Dim\Sbra{\Span{v_1,\dots,v_m}\oplus U}=m+n=\dim V.$ \;Now by (2.B.8).\PfEnd
\SepLine\pagebreak
...
\ProblemB{
	\TipsN{2}\,\,\,\TextB{Suppose $U,W$ are subsps of $V.$ Let $I=U\cap W.$}
	\IndentTipsN{2}\TextB{Prove that $V=U+W\Longleftrightarrow V\XSlash I=U\XSlash I\oplus W\XSlash I.$}
}(a) Suppose $U+W.$ Then $\forall x\in V\XSlash I,\exists\,v\in V,\Par{u_v,w_v}\in U\times W,x=v+I=\Par{u_v+w_v}+I.$\parSol{\Ha}
...
(b) Suppose $V\XSlash I=U\XSlash I\oplus W\XSlash I.$ Then $\forall v\in V,v+I=\Par{u+I}+\Par{w+I}$\parSol{\Hb}
$\Rightarrow v-u-w\in I=U\cap W\Rightarrow\exists\,x\in U\cap W,v=u+w+x\in U+W.$\PfEnd
\SepLine

\ProblemB{
	\TipsN{3}\,\,\,\TextB{Suppose $I$ is a subsp of $U.$ Suppose $U$ is a subsp of $V.$}
	\IndentTipsN{3}\TextB{Let $V=S_V I\oplus I=S_V U\oplus U.$ \;Let $U=S_U I\oplus I.$ \;Then $V=S_V U\oplus S_U I\oplus I.$\vspace{2pt}}
	\IndentTipsN{3}\TextB{Suppose $S_V I=\Pure V\XSlash I,$ similar for $S_V U,S_U I.$ \;Prove that $S_V I=S_V U\oplus S_U I.$}
}$\forall v_i\in S_V I,v_i=v_u+u,\exists\,!\,v_u\in S_V U,u\in U\Rightarrow\exists\,!\,u_i\in S_U I,i\in I,v_i=v_u+u_i+i.$\parSol{}
又 $v_i\in\Pure V\XSlash I.$ Hence $i=0,$ and $v_i\in S_V U\oplus S_U I.$ Now because $S_V U,U\subseteq S_V I.$\PfEnd
\SepLine
...
\ProblemN{\hypertarget{3E17}{17}}{
	...
	(b) \TextNL{Show that $\exists\,W\in\mathcal{S}_{\!V} U,\dim W=\dim V\XSlash U.$}
...
(a) Suppose $\exists\,S\in\Lm{V\XSlash U,W},T=S\circ\pi.$ Then $U=\null\pi\subseteq\null\Par{S\circ\pi}=\null T.$\par\quad
...
\ProblemN{\hypertarget{3E14}{14}}{
	...
	(a) \TextNL{Show that $U$ is a subsp of $\Fbb^{\infty}$. \large\envFontDefault\Sbra{Do it in your mind}}
	(b) \TextNL{Prove that $\Fbb^{\infty}\XSlash[-3pt]U$ is infinite-dim.}
...
Suppose $u=\Par{x_1,\cdots,x_L,{0,\cdots}},$ where $L$ is the largest such that $u\Sbra{L}\neq 0.$\vspace{2pt}\par\quad
Let $s\in\Nbp$ be such that $h=s\cdot m!+1> L,$ \,and \,$e_1\Sbra{h}=\cdots=e_m\Sbra{h}=1.$\vspace{2pt}\par\quad
...
Let \,$1=p_1\leqslant\cdots\leqslant p_{\tau\TinyPar{p}}=p$\, be the distinct factors of $p.$ Moreover, $r\,\mmid\,p\Longleftrightarrow r=p_k$ for some $k.$\par\vspace{2pt}\quad
...
So is $\Par{e_1+U,\dots,e_m+U}$ in $\Fbb^{\infty}\XSlash[-2.5pt]U.$ Because $m$ is arbitrary. By (2.A.14).\PfEnd\vspace{10pt}\quad
...
\ProblemN{\hypertarget{3F4}{4}}{
	\TextN{Suppose $U$ is a subsp of $V$ and $U \neq V$. Prove that $\exists\,\varphi \in V\apostrophe\nonzero,\varphi\Par{u}=0$ for all $u\in U.$\vspace{1pt}}
}Let $X\oplus U=V\Rightarrow X\neq\zeroSubs.$ Suppose $s\in X\nonzero.$ Let $Y\oplus\Span{s}=X.$\parSol{}
...
Then $\nexists\,\psi\in W\apostrophe\nonzero[\LARGE],\BigPar{T\apostrophe\Par{\psi}}\Par{v}=\psi\Par{Tv}=0$ for all $v\in V.$\parCom\Ha
Thus if we assume that $\range T\neq W$ then contradicts. Hence $\range T=W.$\parCom
(b) Suppose $T$ is surj. Then $\Par{\range T}{^0}=\zeroSubs=\null T\apostrophe.$\PfEnd
\SepLine
...
Assume that $v\in V\Backslash U.$ Then let $\Span{v}\oplus U\oplus X=V.$ $\exists\,\psi\in V\apostrophe,\null\psi=U\oplus X.$\parSol{}
又 $\psi\in U^0\Rightarrow\psi\Par{v}=0.$ Contradicts. \;Hence $v\in U\Longleftrightarrow\forall\varphi\in U^0,\varphi\Par{v}=0.$\PfEnd\vspace{2pt}
\Comment \,\,\,$W\subseteq X=\Bra{v\in V:\varphi\Par{v}=0,\forall\varphi\in W^0},$ the {\tgsc promotion} of the subset $W$ of $V.$
\SepLine

\ProblemN{\hypertarget{3F20}{20}}{
	\TextNL{Suppose $U$ and $W$ are subsets of $V$. Prove that $U\subseteq W\Rightarrow W^0\subseteq U^0$.}
...
\ProblemN{\hypertarget{3F21}{21}}{
	\TextNL{Suppose $U$ and $W$ are subsps of $V$. Prove that $U\subseteq W\Leftarrow W^0\subseteq U^0$.}
}\Sbra[3pt]{{\tgsl Req $U,W$ Subsp}} \;Using Problem (25). $v\in U\Rightarrow\forall\varphi\in W^0\subseteq U^0,\varphi\Par{v}=0\Rightarrow v\in W.$\PfEnd\vspace{2pt}
\Comment \,\,\,For (b), $\varphi\in W^0\Longleftrightarrow{}$\uline{$\null\varphi\supseteq W\Rightarrow\null\varphi\supseteq U$}${}\Longleftrightarrow\varphi\in U^0.$ But cannot conclude $W\supseteq U.$
\Comment \,\,\,This result is not true if $U$ {\tgsc and} $W$ are merely subsets.\par
\Example \,\,\,Let $U=\Bra{\Par{x,x+1}\in\Rbb^2},W=\Bra{\Par{x,\sqrt{x}}\in\Rbb^2}.$\par
\Blind{\Example \,\,\,}Then the promotion $X,Y=\Rbb^2,$ and $X^0=Y^0,$ but $U\neq W.$\par
\Comment \,\,\,True if $W$ is a subsp. Because the promotion of every subset of $W$ is a subsp of $W.$\parCom
(1) If $U$ is merely a subset and $W$ is a subsp. Promote $U$ to $X,$ let $W=Y.$\parCom
\Blind{(1)} Then $Y^0=W^0\subseteq U^0=X^0\Rightarrow Y=W\supseteq X\supseteq U.$\parCom
(2) If $W$ is merely a subset and $U$ is a subsp. Promote $W$ to $Y,$ let $U=X.$\parCom
\Blind{(2)} \Example \,\,\,Let $W=\Bra{\Par{1,0}}\cup\Bra{\Par{0,1}},U=\Bra{\Par{x,0}\in\Rbb^2}.$\parCom
\Blind{(2) \Example \,\,\,}Then $Y=\Rbb^2.$ And $Y^0=\zeroSubs\subseteq U^0.$ But $U\not\subseteq W.$
\SepLine
...
\ProblemN{\hypertarget{3F22}{22}}{
	\TextNL{Suppose $U$ and $W$ are subsps of $V$. Prove that $\BigPar{U+W}{^0}=U^0\cap W^0$.}
}\vspace{-14pt}\parSol{}
\!\!\!$\hText{$
...
\ProblemN{\hypertarget{3F23}{23}}{
	\TextNL{Suppose $U$ and $W$ are subsps of $V$. Prove that $\BigPar{U\cap W}{^0}=U^0+W^0$.}
}\vspace{2pt}\par\quad
\!\!\!$\hText{$
...
(b) \!\Sbra[3pt]{{\tgsl Only in Finite-dim; Req $U,W$ Subsps}} \;Using Problem (22).\par\vspace{2pt}\quad\Hb
...
\Comment \,\,\,If $U$ or $W$ is merely a subset. By Problem (25), promote $U\cap W$ as $I,$ $U$ as $X,$ and $W$ as $Y.$\parCom
Now we show that $X\cap Y=I.$ So that $\BigPar{U\cap W}{^0}=I^0=\BigPar{X\cap Y}{^0}=X^0+Y^0=U^0+W^0.$
\SepLine
...
\ProblemB{
	\TipsN{1}\,\,\,(a) \TextB{Prove that $V=U\oplus W\Longleftrightarrow V\apostrophe=U^0\oplus W^0.$\vspace{1pt}}
	\IndentTipsN{1}(b) \TextB{Suppose $U\oplus W=V.$ Prove that $U^0=\Bra{\varphi\in V\apostrophe:\varphi=\varphi\circ\iota},$}
...
\ProblemN{\hypertarget{3F31}{31}}{
	\TextNL{Suppose $U$ is a subsp of $V.$ \;Let $B_{U_V\upapostrophe}=\Par{\varphi_1,\dots,\varphi_n}.$ Show that the correspd $B_U$ exists.}
}Let each \uline{$\null\varphi_i\oplus\Span{u_i}=V$} with $\varphi_i\Par{u_i}=1.$\parSol{}
Now $a_1u_1+\dots+a_nu_n=0\Rightarrow$ \uline{Each $a_i=\varphi_i\Par{a_1u_1+\dots+a_nu_n}=0,$ by def of dual basis.}\PfEnd
\Comment \,\,\,Cannot extend $B_U$ freely.\par
\Example \,\,\,Let $B_V=\Par{e_1,e_2-e_1}.$ Let the correspd  $B_{V\apostrophe}=\Par{\varphi_1,\varphi_2}.$ Let $U_V\upapostrophe=\Span{\varphi_1}.$\par
\Blind{\Example \,\,\,}Then we get $e_1.$ Extend to $B_V'=\Par{e_1,e_2}.$ Then the correspd $B_{V\apostrophe}$ is not $\Par{\varphi_1,\varphi_2,\varphi_3}.$
\SepLine
}
...
{
\pagebreak
\BulletPointX\TipsN{2}\,\,\,Suppose $\varphi_1,\dots,\varphi_m\in V\apostrophe.$ Let $\null_I=\Par{\null\varphi_1}\cap\dots\cap\Par{\null\varphi_m}.$\TextB{}
\IndentTipsN{2}Suppose $\Omega$ is a subsp of $V\apostrophe.$ Let $\null_C=\Bra{v\in V:\varphi\Par{v}=0,\forall\varphi\in\Omega}.$\TextB{}
\IndentTipsN{2}If $\Omega=\Span{\varphi_1,\dots,\varphi_m}.$ Then $\null_I=\null_C.$\TextB{}
\IndentTipsN{2}Because $v\in\null_I\Longleftrightarrow$ each $\varphi_i\Par{v}=0\Longleftrightarrow\forall\varphi\in\Omega,\varphi_i\Par{v}=0\Longleftrightarrow v\in\null_C.$\TextB{}
\Comment \,\,\,If $\Omega$ is infinite-dim. Then $\null_I=\bigcap_{\varphi\,\in\,\Omega}\null\varphi=\null_C.$
\SepLine

\ProblemB{
	\TipsN{3}\,\,\,\TextB{Let $\Omega=\Span{\varphi_1,\dots,\varphi_m}\subseteq V\apostrophe.$ Prove that {\tgnr\large(a)} $\Omega=\BigPar{\null_I}{^0};\;$ {\tgnr\large(b)} $\Omega=\BigPar{\null_C}{^0}.$}
}{\normalsize\hfill Here (a) is {\normalsize\envFontSmall\Sbra{\hypertarget{3F4e23}{4E 23}}}, (b) is Problem \hypertarget{3F26}{(26)}.}\par\quad
...
%Assume that $\Omega\subsetneq\BigPar{\null_C}{^0}.$ Suppose $\psi\in\BigPar{\null_C}{^0}\Backslash\Omega.$\par\quad
%Let $\null\psi\oplus\Span{w}=V.$ Then suppose $\varphi\in\Omega\nonzero\subseteq\BigPar{\null_C}{^0}.$\par\quad
%Let $\null\varphi\oplus\Span{v}=V.$ Then let $\Theta\oplus\null_C=\null\psi,\;\Delta\oplus\null_C=\null\varphi.$\par\quad
%Thus $V=\Theta\oplus\null_C\oplus\Span{w}=\Delta\oplus\null_C\oplus\Span{v}.$ Now we show that $\psi\in\Omega.$\par\quad
%\PfEnd\vspace{6pt}

\BulletPointX\NoteForSmall{Problem (26)}\;\;For every subsp $\Omega$ of $V\apostrophe,\;\exists\,!\,$subsp $U$ of $V$ such that $\Omega=U^0.$
\SepLine

\ProblemN{24}{
	\TextNL{Suppose $V$ is finite-dim and $U$ is a subsp of $V$.}
	\TextNL{Prove, using the pattern of [3.104], that $\dim U+\dim U^0=\dim V$.}
}Let $B_{\Omega}=B_{U^0}=\Par{\varphi_1,\dots,\varphi_m},B_{V\apostrophe}=\Par{\varphi_1,\dots,\varphi_m,\dots,\varphi_n}.$\parSol{}
...
%	(a) \TextNL{Suppose $\varphi\in\PoRi\apostrophe$ is defined by $\varphi\Par{p}=p\apostrophe\Par{4}$. Describe $T\apostrophe\Par{\varphi}\in\PoRi\apostrophe$.\vspace{4pt}}
...
%	(b) \TextNL{Suppose $\varphi\in\PoRi\apostrophe$ is defined by $\varphi\Par{p}=\int_0^1 p\Par{x}\d x$. Evaluate $\BigPar{T\apostrophe\Par{\varphi}}\Par{x^3}$.\vspace{4pt}}
...
\ProblemN[]{\hypertarget{3F5}{5}}{
	\TextN{Prove that $\Par{V_{\!1}\times\dots\times V_{\!m}}\apostrophe$ and $V\apostrophe_1 \times\dots\times V\apostrophe_m$ are iso.\hfill\Sbra[3pt]{{\large\tgnr Using notations in (3.E.2).}}}\vspace{4pt}
}
$\MathRightBrace{l}{$
...
\ProblemN{\hypertarget{3F35}{35}}{
	\TextNL{Prove that $\BigPar{\PoFi}\apostrophe$ is iso to $\Fbb^{\infty}.$}
}\par\quad
