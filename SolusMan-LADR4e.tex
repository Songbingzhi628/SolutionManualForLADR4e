...
\ProblemN[]{\hypertarget{3F13}{13}}{
	...
	(c) \TextNL{What is $\null T\apostrophe$? What is $\range T\apostrophe$?\colorbox{yellow}{TODO}\vspace{4pt}}
	\Hc\TextNL{\large\tgnr\envFontDefault $T\Par{x,y,z}=0\Longleftrightarrow\MathLeftBrace{l}{4x+5y+6z=0\\7x+8y+9z=0}\Longleftrightarrow \MathLeftBrace{l}{x+y+z=0\\y=2z=0}\Longleftrightarrow\Par{x,y,z}\in\Span{e_1-2e_2+e_3}.$\vspace{2pt}}
	\Hc\TextNL{\large\tgnr\envFontDefault Where $\Par{e_1,e_2,e_3}$ is standard basis of $\Rbb^3.$}
	\Hc\TextNL{\large\tgnr\envFontDefault Let $\Par{e_1-2e_2+e_3,e_2,e_3}$ be a basis, with the correspd dual basis $\Par{\varepsilon_1,\varepsilon_2,\varepsilon_3}$.}
	\Hc\TextNL{\large\tgnr\envFontDefault Thus $\Span{e_1-2e_2+e_3}=\null T\Rightarrow \Span{e_1-2e_2+e_3}{^0}=\Span{\varepsilon_2,\varepsilon_3}=\range T\apostrophe.$\PfEnd}
	\Hc\TextNL{\large\tgnr\envFontDefault Note that $\varepsilon_k=\varepsilon_k\Par{e_1}\psi_1+\varepsilon_k\Par{e_2}\psi_2+\varepsilon_k\Par{e_3}\psi_3.$ Then $\varepsilon_1=$}
