...
(b) Suppose $\varphi\in U^0\cap W^0\subseteq V\apostrophe.$ Then $\forall u\in U,w\in W,\varphi\Par{u+w}=0\Rightarrow\varphi\in \Par{U+W}{^0}.$\PfEnd\vspace{-2pt}
\SepLine
...
(b) Suppose $\varphi\in U^0,\psi\in W^0.$ Then $\forall v\in U\cap W$, $\Par{\varphi+\psi}\Par{v}=\varphi\Par{v}+\psi\Par{v}=0.$\PfEnd\vspace{-2pt}
\SepLine[-4pt]
...
}By Problem (17), (c) holds.\vspace{4pt}\par\quad
...
(b) Note that $W=\null\Par{i}\subseteq\null\Par{\psi\circ i}.$ Then $\psi\circ i\in W^0\Rightarrow\range i\apostrophe\in W^0.$\par\quad\Hb
...
And $\forall v\in V,\exists\,!\,u_v\in U,w_v\in\null T,v=u_v+w_v.$ Define $i\in\Lm{V,U}$ by $i\Par{v}=u_v.$\vspace{4pt}\par\quad
...
Where $T^{-1}\mid_{\range T}:\range T\rightarrow U;\;\;T:V\rightarrow\range T.$ Note that $T^{-1}\mid_{\range T}\circ T\mid_V=i.$\vspace{2pt}\par\quad
...
\Comment \,\,\,Is the result still true if one of $V,W$ is infinite-dim?\colorbox{yellow}{TODO}\vspace{2pt}\par
\ProblemB{
