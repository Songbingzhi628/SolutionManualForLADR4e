...
{\huge\timesbf 5.B: I}\quad {\LARGE[}{\Large\timessl See {\timesbf 5.B: II} below.}{\LARGE ]} % 4.5h+()/20h)
$\\\\ $
...
{\small $\bullet$} {\timesbf\Large E{\normalsize XAMPLE}:}
{\timessl\normalsize an operator on a complex vector space with no eigenvalues}\par\quad
...
{\small $\bullet$} (\normalsize{4E 5.B.11})\par\,\, {\timessl\Large 
...
{\small $\bullet$} (\normalsize{4E 5.B.12})\par\,\, {\timessl\Large 
...
{\small $\bullet$} (\normalsize{4E 5.B.27})\par\,\, {\timessl\Large 
...
{\small $\bullet$} (\normalsize{4E 5.C.10}) {\timessl\Large 
...
{\small $\bullet$} (\normalsize{4E 5.C.11}) {\timessl\Large 
...
{\small $\bullet$} (\normalsize{4E 5.C.12}) {\timessl\Large 
...
{\small $\bullet$} (\normalsize{4E 5.C.13}) {\timessl\Large 
...
{\small $\bullet$} (\normalsize{4E 5.C.14}) {\timessl\Large 
