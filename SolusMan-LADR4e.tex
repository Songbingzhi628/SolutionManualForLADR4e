...
Suppose $\Fbf=\Rbf,$ $V$ is finite-dim, and $T\in \Lm(V)$.}\par\,\,
{\timessl\Large Prove that the mini poly of $T_\Cbb$ equals the mini poly of $T$.
}\par\,\,
{\timessl\Large
}\par
{\timesbf S\footnotesize{OLUTION:}}\par\quad
...
Suppose $V$ is finite-dim and $T\in \Lm(V)$.}\par\,\,
{\timessl\Large Prove that the mini poly of $T' \in\Lm(V')$ equals the mini poly of $T$.
}\par\,\,
{\timessl\Large
}\par
{\timesbf S\footnotesize{OLUTION:}}\par\quad
