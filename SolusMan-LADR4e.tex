...
\ProblemBnoor{4E 3.E.14}{
	...
	\TextB{Prove that $\Par{w_1+U,\dots,w_m+U}$ is a basis of $V\mySlash U$.}
}\par\quad
...
\ProblemB{
	\Tips \,\,\,\TextB{Suppose $T\in\Lm{V}$ and $U$ is finite-dim such that $T\mid_U\in\Lm{U}$ is inv.}
	\Blind{\Tips \,\,\,}\TextB{Then $\exists$ invar subsp $W$ of $V$ under $T$ such that $V=U\oplus W.$}
}\par\quad
...
Let $U$ be invar under $T$ and $V=\Span{v}\oplus U$ \Par{ by \TIPS }. Define $\psi\in V\apostrophe$ by $\psi\Par{cv+u}=c.$\vspace{2pt}\par\quad\Ha
...
\Blind{$\lambda$ is an eigval of $T$} $\Longleftrightarrow T\apostrophe-\lambda I_{V\apostrophe}$ is not inje $\Longleftrightarrow\lambda$ is an eigval of $T\apostrophe.$\PfEnd
\SepLine
