...
Note that each $\varphi_i\in U^0.$ Hence $\Span{\varphi_{m+1},\dots,\varphi_n}\subseteq U^0.$\par\quad
And $\forall\varphi\in U^0,\exists\,a_i\in\Fbb,\varphi=\sum_{i=1}^m a_i\varphi_i+\sum_{i=m+1}^n a_i\varphi_i$ 又 $\forall i\in\Bra{1,\dots,m},\varphi\Par{u_i}=0\Rightarrow a_i=0.$\par\quad
Then $\varphi\in\Span{\varphi_{m+1},\dots,\varphi_n}$. Thus $\Span{\varphi_{m+1},\dots,\varphi_n}\supseteq U^0.$\PfEnd
\SepLine

\ProblemB{
	\TextB{Suppose $U$ is a subsp of $V.$ Prove that $\Par{V/U}\apostrophe$ and $U^0$ are iso. \hfill{\large Another proof of [3.104].}}
}\par\quad
...
Now $\xi\circ\nu=I_{\envFontSmall[\scriptsize]\Par{V/U}\apostrophe},\nu\circ\xi=I_{U^0}.$\PfEnd
\SepLine
...
\AlignEq{}{\forall u,v\in V,\lambda\in\Fbb,\,&T\Par{u+\lambda v}=\textstyle\sum_{i=1}^m\varphi_i\Par{u+\lambda v}w_i\\[-3pt]=\,&T\Par{u}+\lambda T\Par{v}=\XPar{\textstyle\sum_{i=1}^m\varphi_i\Par{u}w_i}+\lambda\XPar{\textstyle\sum_{i=1}^m\varphi_i\Par{v}w_i}=\textstyle\sum_{i=1}^m\BigPar{\varphi_i\Par{u}+\lambda\varphi_i\Par{v}}w_i.\hspace{-18pt}}\vspace{-3pt}\par\quad
Thus for each $i\in\Bra{1,\dots,m},\varphi_i\Par{u+\lambda v}=\varphi_i\Par{u}+\lambda\varphi_i\Par{v}.$\PfEnd\vspace{6pt}\quad
...
\ProblemB[]{
	\TextB{Suppose $V$ is a vecsp and $U\subseteq V.$\vspace{4pt}}
	\ProblemN[]{}{}
	...
	\ProblemN[]{\hypertarget{3F19}{19}}{
		\TextNL{\tgnr $U^0_V=\zeroSubs=V^0_V\Longleftrightarrow U=V$. {\large\tgnr By the inverse and contrapositive of Problem (4). \Or By [3.104].}}}
	\TextB{}
}\SepLine
...
又 $\dim V\apostrophe=m=\dim V$. Then $B_V=\Par{u_1,\dots,u_m}$.\PfEnd
\SepLine
