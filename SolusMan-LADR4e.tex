...
}Note that $U=\Bra{v\in V:v\in U}$ is a subsp of $V$; And $v\in U\Longleftrightarrow\varphi\Par{v}=0,\forall\varphi\in U^0.$\PfEnd\vspace{-3pt}
\SepLine
...
\ProblemN[]{\hypertarget{3F13}{13}}{
	...
	\Hc\TextNL{\large\tgnr\envFontDefault}
	\Hc\TextNL{\large\tgnr\envFontDefault}
	\Hc\TextNL{\large\tgnr\envFontDefault\PfEnd}
}\SepLine
