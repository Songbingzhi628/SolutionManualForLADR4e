...
\vfill\ExampleX[]{
	\TextE{Suppose $U=\Bra{\Par{x,x,y,y}\in\Fbb^4:x,y\in\Fbb},W=\Bra{\Par{x,x,x,y}\in\Fbb^4:x,y\in\Fbb}.$\vspace{3pt}}
	\TextE{Prove that $U+W=\Bra{\Par{x,x,y,z}\in\Fbb^4:x,y,z\in\Fbb}$.\vspace{3pt}}
}\par\quad
...
\ProblemB{
	({\normalsize\hypertarget{2C4e10}4E 2.C.10}) \TextB{Suppose $m$ is a positive integer. For $0\leqslant k\leqslant m$, let $p_k\Par{x}=x^k\Par{1-x}^{m-k}$.}
...
\ProblemB{
	({\normalsize\hypertarget{3C4e17}4E 3.C.17, \OR 3.F.32}) \TextB{Suppose $T\in\Lm{V}$ and $\Par{u_1,\dots,u_n},\Par{v_1,\dots,v_n}$ are bases of \,$V$.}
...
\large
\ProblemB{
	({\normalsize\hypertarget{3C4e16}4E 3.C.16, \OR 3.E.11}) \TextB{Suppose $A$ is an m-by-n matrix with $A\neq 0$.}
...
\ProblemB{
	({\normalsize\hypertarget{3D4e19}{}10.A.3, \OR 4E 3.D.19}) \TextB{Suppose $V$ is finite-dim and $T\in\Lm{V}$.}
...
\ProblemB{
	({\normalsize 4E 3.E.14}) \TextB{Suppose $V=U\oplus W$, $\Par{w_1,\dots,w_m}$ is a basis of $W$.}
...
\ProblemB{
	({\normalsize\hypertarget{3F4e5}{4E 3.F.5}}) \TextB{Suppose $T \in \Lm{V,W}$ and $\Par{w_1 , \dots , w_m}$ is a basis of $\range T$.\vspace{3pt}}
...
\ProblemB{
	({\normalsize\hypertarget{3F4e6}{4E 3.F.6}}) \TextB{Suppose $\varphi,\beta\in V\apostrophe$. Prove that $\null \varphi\subseteq\null\beta\Longleftrightarrow\beta=c\varphi$. $\exists\,c\in\Fbb.$}
...
\ProblemB[]{
	({\normalsize\hypertarget{3F4e8}{4E 3.F.8}}) \TextB{Suppose $\Par{v_1,\dots,v_{n}}$ is a basis of $V$ and $\Par{\varphi_1,\dots,\varphi_{n}}$ is the dual basis of $V\apostrophe$.}
...
\vspace{2pt}\TextB{\tgnr ( Because $\dim V>n$ and $n-1>0,\,\,\,n\Sbra{\dim V-\Par{n-1}}>\dim V$. )}
