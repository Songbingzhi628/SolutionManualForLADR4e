...
\def\IndentB{{\large\Blind{\BulletPoint }}}
...
\newcommand{\ProblemBnosolus}[1]{
	\BulletPoint\,\hspace{1pt}#1\vspace{-16pt}\par
}
...
{\Large\vspace{6pt}Then $Tv=T\left(\varphi(v_1)v\right)=T(S_v v_1)=S_v(Tv_1)=\varphi(Tv_1)v=\lambda v.\hfill\square$}\par
\SepLine\par
...
{\Large\vspace{6pt}Getting $\left(\displaystyle\frac{1}{a_k}T_{1,1}+\dots+\frac{1}{a_k}T_{n,n}\right)v_j=v_j\Rightarrow${$\sum\limits_{r=1}^n \displaystyle\frac{1}{a_k}T_{r,r}=I.$}}\par\quad
...
\BulletPoint \,\hspace{1pt}\Tips \,\,\,Suppose $T\in\Lm(V,W)$ and $R=(Tv_1,\dots,Tv_n)$ is linely inde in $\range T$.\TextB{}\Blind{\Tips\,\,\,}
\large ( Let $\dim\range T=n$, if $\range T$ is finite, otherwise let $n\in\Nbp.$ )\TextB{}\Blind{\Tips\,\,\,}
...
Because $\forall\,v\in V,\,\exists\,a_i\in\Fbb,Sv=a_1 Sv_1+\dots+a_n Sv_n$\par\quad
\Blind{Because $\forall\,v\in V,\,\exists\,a_i\in\,$}$\Rightarrow S\left(v-(a_1 v_1+\dots+a_n v_n)\right)=0$\par\quad
\Blind{Because $\forall\,v\in V,\,\exists\,a_i\in\,$}$\Rightarrow v-(a_1 v_1+\dots+a_n v_n)\in\null S$\par\quad
\Blind{Because $\forall\,v\in V,\,\exists\,a_i\in\,$}$\Rightarrow v-(a_1 v_1+\dots+a_n v_n)\in\null T$\par\quad
\Blind{Because $\forall\,v\in V,\,\exists\,a_i\in\,$}$\Rightarrow T\left(v-(a_1 v_1+\dots+a_n v_n)\right)=0.$\par\quad
