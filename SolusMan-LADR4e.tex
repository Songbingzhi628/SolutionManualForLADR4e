...
( You can type it on \url{https://zh.numberempire.com/equationsolver.php} to check.)\par{\tiny\,\par}\quad
O{\small R.} Define $T\in\Lm(${\timesbf R}$^4)$ by $T(x_1,x_2,x_3,x_4)=(-x_2,x_1,-x_4,x_3).$\par\quad
Suppose $\lambda$ is an eigenvalue of $T$ with an eigenvector $(x,y,z,w).$\par\quad
Then $T(x,y,z,w)=(\lambda x,\lambda y,\lambda z,\lambda w)=(-y,x,-w,z)\Rightarrow\left\{\begin{array}{l}
-y=\lambda x\\
x=\lambda y\\
-w=\lambda z\\
z=\lambda w
