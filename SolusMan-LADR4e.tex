...
Suppose $V$ is finite-dim, $0\neq v\in V,T\in \Lm(V)$ and $p$ is the mini poly with degree $m.$ }\par\,\,
{\timessl\Large Prove that $\,\,\Spn(v,Tv,\dots,T^{m-1}v)$}\par\qquad\qquad\quad
{\timessl\Large $\,=\Spn(v, Tv, \dots , T^{\dim V-1} v)$}\par\qquad\qquad\quad
{\timessl\Large $\,=\Spn(v,Tv,\dots,T^{\dim V-1}v,\dots,T^n v)$ is invariant under $T$.
}\par
{\timesbf S\footnotesize{OLUTION:}}\,\,\,Write $p(z)=a_0 +a_1 z+\dots+z^m \,\,(\,m\leq \dim V\,).$\par\quad
Let $U=\Spn(v,Tv,\dots,T^{m-1}v).$\par
$\left.\begin{array}{l}\,\,$Because $T(T^{m-1})=T^m v=-a_0 v-a_1 Tv-\dots-a_{m-1}T^{m-1}v\in U.\\\quad\,\,\,\,$
And $T(T^j v)=T^{j+1}v\in U$ for each $j\in\{0,1,\dots,m-2\}$.
$\end{array}\right\}\Rightarrow U$ is invariant under $T.$
\par{\tiny\,\par}\quad
Hence for any $k\in\Nbfc,\,\,\,T^{m+k}v=T^k(T^m v)\in U.$\par\quad
$($ Using induction. (i) $k=0,T^{m+k}v=T^m v\in U;$\par\qquad\qquad\qquad\qquad\,
(ii) $k\geq 1,$ assume that $T^{m+k-1}v\in U,$\par\qquad\qquad\qquad\qquad\qquad\qquad\quad then $T^{m+k}v=T(T^{m+k-1}v)=c_0 Tv+\dots+c_{m-1}T^m v\in U.)$\par{\tiny\,\par}\quad
Thus $\Spn(v,Tv,\dots,T^{m-1}v)=\Spn(v,Tv,\dots,T^{m-1}v,\dots,T^{\dim V-1}v)=\Spn(v,Tv,\dots,T^{\dim V-1}v,\dots,T^n v)$\par
\rightline{is invariant under $T.\quad\square$\qquad }\par
{\tiny \_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_\,\_}{\tiny\,\par}
...
{\small $\bullet$} {\timesbf N{\small OTE} F{\small OR} [8.49]:} Suppose $V$ is a finite-dim complex vecsp, $T\in\Lm(V).$ By [4.14], the mini poly has the form\par\,\,
\centerline{\qquad\qquad\qquad\qquad$(z -\lambda_1 ) \cdots (z - \lambda_m)$, where $\lambda_1,\dots,\lambda_m$ is a list of all eigvals of $T$, possibly with repetitions.}\par
...
Suppose $V$ is finite-dim, $T\in \Lm(V)$ has mini poly $p$}\par\qquad\qquad\quad\,\,
{\timessl\Large defined by $p(z)=a_0 + a_1 z + \dots + a_m z^m,$ $a_0\neq 0.$ Find the mini poly of $T^{-1}$.}\par
...
Apply $T^{-m},$ getting $a_0(T^{-1})^m+a_1(T^{-1})^{m-1}+\dots+a_{m-1}T^{-1}+a_m I=(T^{-1})^m(0).$\par\quad
Define $q$ by $q(z)=z^m+a_1' z^{m-1}+\dots+a_{m-1}'T+a_m'$ for all $z\in\Fbfc,$ {\small where $\displaystyle a_j'=\frac{a_j}{a_0}.$}\par\quad
...
Then let $(T^{-1})^{k}=b_0 I+b_1 T^{-1}+\dots+b_{k-1}T^{k-1}.$ Apply $T^k$ to both sides,\par\qquad\qquad
 getting $I=b_0 T^k+b_1 T^{k-1}+\dots+b_{k-1}T,$ hence $T^{k}\in\Spn(I,T,\dots,T^{k-1}).$\par\quad
Thus $f$ defined by $\displaystyle f(z)=z^k+b'_1 z^{k-1}+\dots+b'_{k-1} z-\frac{1}{b_0}$ ( where $\displaystyle b_{k-1}=\frac{b_{k-1}}{b_0}$ ) is a polynomial multiple of $p$.\par\quad
...
{\timesbf S\footnotesize{OLUTION:}}\par\quad
Because the eigvals of $T$ are the zeros of the mini poly, and also of $q(z)=(z-3)^2(z-5)^2(z-8)^2$.\par\quad
又 $\dim V=4.$ And the degree of mini poly is less than or equal to $\dim V.$\par\quad
Thus the mini poly of $T$ is $p$ defined by $p(z)=(z-3)^{1+A} (z-5)^{1+B} (z-8)^{1+C},$\par\qquad\qquad\qquad\qquad\qquad\qquad\qquad\, where $0\leq A+B+C\leq 1,A,B,C\in\Nbfc.$\par\quad
...
{\timesbf S\footnotesize{OLUTION:}}\par\quad
Because the eigvals of $T$ are the zeros of the mini poly, and also of $q(z)=(z-5)^{\dim V-1}(z-6)^{\dim V-1}$.\par\quad
...
%{\small with the sets of eigvecs $U_1=\{(x,\dots,x)\in\Fbfc^n:x\in\Fbf\wedge\,x\neq 0\}$\par\qquad\qquad\qquad\qquad\quad
...
又 For all $e_k,T e_k=e_1+\dots+e_n;\quad T^2 e_k=n (e_1+\dots+e_n).$\par\quad
