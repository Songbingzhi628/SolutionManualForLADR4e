...
\BulletPoint \,\hspace{1pt}\NoteForSmall{[5.6]}\TextB{}
...
\ProblemB{
	...
	(b) \hypertarget{5A16}{}\Sbra{{\normalsize\OR \Onumber{16}\,}} \TextB{$\lambda\in\Cbb.$ Prove that $\lambda$ is an eigval of $T_{\Cbb}$ $\Longleftrightarrow$ $\overline \lambda$ is an eigval of $T_{\Cbb}.$}
}\par\quad
...
\ProblemBnoor{{5.B.4} \OR \hypertarget{5A4e8}{4E 5.A.8}}{
	\TextB{Suppose $P\in\Lm{V}$ and $P^2 = P$.}
	\TextB{Prove that if $\lambda$ is an eigval of $P$, then $\lambda = 0$ or $\lambda = 1$.}
}\Sbra{ See also at (3.B), where (5.B.4) was answered. }\par\quad
...
\ProblemB{
	\hypertarget{5A4e36}{}\TextB{Suppose $\lambda_1,\dots,\lambda_n$ are distinct positive numbers.}
	\TextB{Prove that $\BigPar{\cos\Par{\lambda_1 x},\dots,\cos\Par{\lambda_n x}}$ is linely inde in $\Rbb^{\Rbb}.$}
}\par\quad
...
\BulletPoint \,\hspace{1pt}\NoteForSmall{[8.49]}\TextB{}
